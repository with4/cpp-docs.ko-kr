...
#### [AUTOCLIK 및 AUTODRIV를 사용하여 원격 자동화 실](running-remote-automation-using-autoclik-and-autodriv.md)행
...
##### [MFC ActiveX 컨트롤: 다른 사용자 지정 속성 페이지 추](mfc-activex-controls-adding-another-custom-property-page.md)가
...
###### [1단계 및&2;단계 개체 생성](one-stage-and-two-stage-construction-of-objects.md)
