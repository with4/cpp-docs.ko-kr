...
helpviewer_keywords: 
  - "MFC ActiveX 컨트롤 배포"
  - "GetProcAddress 메서드, ActiveX 컨트롤 등록"
  - "GetSystemDirectory 메서드"
  - "GetWindowsDirectory 메서드"
  - "ActiveX 컨트롤 설치"
  - "LoadLibrary 메서드, ActiveX 컨트롤 등록"
  - "MFC ActiveX 컨트롤, ANSI 또는 유니코드 버전"
  - "MFC ActiveX 컨트롤, 배포"
  - "MFC ActiveX 컨트롤, 설치"
  - "MFC ActiveX 컨트롤, 등록"
  - "MFC40.DLL"
