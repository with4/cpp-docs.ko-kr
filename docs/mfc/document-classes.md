...
## Related Classes  
 ...
 Cooperates with a [CFile](../mfc/reference/cfile-class.md) object to implement persistent storage for objects through serialization \(see [CObject::Serialize](../Topic/CObject::Serialize.md)\).  
