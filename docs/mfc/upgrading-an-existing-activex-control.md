...
##  <a name="_core_packaging_code_for_downloading"></a> Packaging Code for Downloading  
 For more information on this subject, see the Knowledge Base article "Packaging MFC Controls for Use Over the Internet" \(Q167158\).  기술 자료 문서는 MSDN Library 미디어 또는 [http:\/\/support.microsoft.com\/default.aspx](http://support.microsoft.com/support) 에서 다운로드할 수 있습니다.  
...
### Creating CAB Files  
 ...
 For details on how to create a CAB file, see [Creating a CAB File](http://msdn.microsoft.com/ko-kr/cc52fd09-bdf6-4410-a693-149a308f36a3).  
...
-   Use of the Codebase parameter  
 ...
 To use a licensed control in an HTML page on a nonlicensed machine, you must generate a license package file \(LPK\).  The LPK file contains run\-time licenses for licensed controls in the HTML page.  This file is generated via LPK\_TOOL.EXE which comes with the ActiveX SDK.  For more information, see the MSDN Web site at [http:\/\/msdn.microsoft.com](http://msdn.microsoft.com).  
  
#### LPK 파일을 만들려면  
  
1.  Run LPK\_TOOL.EXE on a computer that is licensed to use the control.  
