...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "COleObjectFactory 클래스, 컨트롤 라이선스 획득"
  - "GetLicenseKey 메서드"
  - "ActiveX 컨트롤 라이센스 획득"
  - "MFC ActiveX 컨트롤, 라이센스"
  - "VerifyLicenseKey 메서드"
  - "VerifyUserLicense 메서드"
...
##  <a name="_core_overview_of_activex_control_licensing"></a> Overview of ActiveX Control Licensing  
 ...
 ![허가된 ActiveX 컨트롤이 개발 시 확인됨](../mfc/media/vc374d1.png "vc374D1")  
개발 도중 사용이 허가된 ActiveX 컨트롤 확인  
 ...
 ![허가된 ActiveX 컨트롤이 실행 시 확인됨](../mfc/media/vc374d2.png "vc374D2")  
