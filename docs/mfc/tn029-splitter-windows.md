...
## Shared Scroll Bars  
 ...
 For example, in a 1 row x 2 column window, you can specify WS\_VSCROLL when creating the `CSplitterWnd`.  Windows creates a special scroll bar control that is shared between the two panes.  
...
## CView Functionality  
 ...
 Checks whether ID\_NEXT\_PANE or ID\_PREV\_PANE is currently possible.  
