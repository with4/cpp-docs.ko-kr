---
title: "TN065: OLE 자동화 서버에 대한 이중 인터페이스 지원 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
```  
 ...
 After your methods and properties are defined, you need to add a reference to the interface statement in your coclass statement.  예를 들면 다음과 같습니다.  
...
```  
 ...
 To define an implementation class for your dual interface, add a `DUAL_INTERFACE_PART` block to your object class definition.  예를 들면 다음과 같습니다.  
...
```  
 ...
 Next, you need to fill in the implementation of the interface.  For the most part, you will be able to delegate to the existing MFC `IDispatch` implementation.  예를 들면 다음과 같습니다.  
...
```  
 ...
 For your object's methods and property accessor functions, you need to fill in the implementation.  Your method and property functions can generally delegate back to the methods generated using ClassWizard.  However, if you set up properties to access variables directly, you need to write the code to get\/put the value into the variable.  예를 들면 다음과 같습니다.  
...
```  
 ...
 Before passing a pointer back through the dual\-interface method, you might need to convert it from the MFC `IDispatch` pointer to your dual\-interface pointer.  예를 들면 다음과 같습니다.  
