...
|Property exchange functions|용도|  
|---------------------------------|--------|  
|**PX\_Blob\( \)**|Serializes a type Binary Large Object \(BLOB\) data property.|  
|**PX\_Bool\( \)**|Serializes a type Boolean property.|  
|**PX\_Color\( \)**|Serializes a type color property.|  
|**PX\_Currency\( \)**|Serializes a type **CY** \(currency\) property.|  
|**PX\_Double\( \)**|Serializes a type **double** property.|  
|**PX\_Font\( \)**|Serializes a Font type property.|  
|**PX\_Float\( \)**|Serializes a type **float** property.|  
|**PX\_IUnknown\( \)**|Serializes a property of type `LPUNKNOWN`.|  
|**PX\_Long\( \)**|Serializes a type **long** property.|  
|**PX\_Picture\( \)**|Serializes a type Picture property.|  
|**PX\_Short\( \)**|Serializes a type **short** property.|  
|**PX\_String\( \)**|Serializes a type `CString` property.|  
|**PX\_ULong\( \)**|Serializes a type **ULONG** property.|  
|**PX\_UShort\( \)**|Serializes a type **USHORT** property.|  
