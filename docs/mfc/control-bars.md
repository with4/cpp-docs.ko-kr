...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CControlBar 클래스, MFC 컨트롤 막대"
  - "CDialogBar 클래스, 컨트롤 막대"
  - "명령 모음, 형식"
  - "컨트롤 막대[C++]"
  - "컨트롤 막대[C++], 형식"
  - "CStatusBar 클래스, 컨트롤 막대"
  - "CToolBar 클래스, 컨트롤 막대"
  - "대화 상자 모음, 컨트롤 막대"
  - "MFC, 컨트롤 막대"
  - "상태 표시줄, 컨트롤 막대"
...
> [!NOTE]
>  If a button on the control bar doesn't have a **COMMAND** or **UPDATE\_COMMAND\_UI** handler, the framework automatically disables the button.  
