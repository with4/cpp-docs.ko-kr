...
## <a name="schema-numbers"></a>스키마 번호  
 ...
 사용할 수 있습니다 `VERSIONABLE_SCHEMA` 와 결합 (비트 **또는**)이이 예외가 throw 되지 변경 하지 않으려면 스키마 버전입니다. 사용 하 여 `VERSIONABLE_SCHEMA`, 사용자 코드 적절 한 조치를 취할 수 있습니다는 `Serialize` 함수 반환 값을 확인 하 여 [CArchive::GetObjectSchema](../mfc/reference/carchive-class.md#getobjectschema)합니다.  
