...
### <a name="remarks"></a>주의  
 ...
 이 메서드를 만듭니다는 [CMFCMaskedEdit](../../mfc/reference/cmfcmaskededit-class.md) 하나 이상 있으면 제어는 `lpszEditMask`, `lpszEditTemplate`, 또는 `lpszValidChars` 만듭니다 그렇지; 매개 변수가 지정 되는 [CEdit](../../mfc/reference/cedit-class.md) 제어 합니다.  
