...
### <a name="remarks"></a>설명  
 ...
 -1로 전달 하 여 표현 된 기본 스타일 `dwStyle`, 실제 **WS_SYSMENU&#124;**`WS_POPUP`**&#124;WS_CAPTION&#124;DS_MODALFRAME&#124;DS_CONTEXTHELP&#124;WS_ 표시**합니다. 기본 확장 창 스타일 0을 전달 하 여 표현 `dwExStyle`, 실제 **WS_EX_DLGMODALFRAME**합니다.  
