...
|[CMFCVisualManagerOffice2003::DrawPushButtonWinXP](#drawpushbuttonwinxp)|현재 Windows XP 테마를 사용 하 여 누름 단추를 그립니다. (재정의 [CMFCVisualManager::DrawPushButtonWinXP](../../mfc/reference/cmfcvisualmanager-class.md#drawpushbuttonwinxp).)|  
|[CMFCVisualManagerOffice2003::GetBaseThemeColor](#getbasethemecolor)|기본 테마 색을 가져옵니다.|  
|[CMFCVisualManagerOffice2003::GetHighlightMenuItemColor](#gethighlightmenuitemcolor)|강조 표시 된 메뉴 항목에 사용할 색을 가져옵니다.|  
...
|[CMFCVisualManagerOffice2003::GetSmartDockingBaseGuideColors](#getsmartdockingbaseguidecolors)|지정 된 기본 그룹 배경색 및 테두리 색을 설정합니다. (`CMFCVisualManagerOfficeXP::GetSmartDockingBaseGuideColors`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::GetSmartDockingHighlightToneColor](#getsmartdockinghighlighttonecolor)|톤 강조 색을 가져옵니다. (재정의 [CMFCVisualManager::GetSmartDockingHighlightToneColor](../../mfc/reference/cmfcvisualmanager-class.md#getsmartdockinghighlighttonecolor).)|  
|[CMFCVisualManagerOffice2003::GetTabFrameColors](#gettabframecolors)|드로잉 탭 창에 대 한 색 집합을 검색 해야 할 때 프레임 워크에서이 함수를 호출 합니다. (재정의 [CMFCVisualManager::GetTabFrameColors](../../mfc/reference/cmfcvisualmanager-class.md#gettabframecolors).)|  
|[CMFCVisualManagerOffice2003::GetToolBarCustomizeButtonMargin](#gettoolbarcustomizebuttonmargin)|도구 모음 사용자 지정 단추 여백을 가져옵니다. (`CMFCVisualManager::GetToolBarCustomizeButtonMargin`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::IsDockingTabHasBorder](#isdockingtabhasborder)|현재 비주얼 관리자 도킹 되 고 탭 창 둘레에 테두리를 그릴지 여부를 반환 합니다. (재정의 [CMFCVisualManager::IsDockingTabHasBorder](../../mfc/reference/cmfcvisualmanager-class.md#isdockingtabhasborder).)|  
|[CMFCVisualManagerOffice2003::IsHighlightOneNoteTabs](#ishighlightonenotetabs)|OneNote 탭을 강조 해야 하는지 여부를 나타냅니다. (`CMFCVisualManager::IsHighlightOneNoteTabs`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::IsStatusBarOfficeXPLook](#isstatusbarofficexplook)|Office XP 모양으로는 상태 표시줄이 있는지 여부를 나타냅니다.|  
|[CMFCVisualManagerOffice2003::IsToolbarRoundShape](#istoolbarroundshape)|지정 된 도구 모음 둥근 모양에 있는지 여부를 나타냅니다. (재정의 [CMFCVisualManager::IsToolbarRoundShape](../../mfc/reference/cmfcvisualmanager-class.md#istoolbarroundshape).)|  
|[CMFCVisualManagerOffice2003::IsUseGlobalTheme](#isuseglobaltheme)|전역 Windows XP 테마 사용 되는지 여부를 나타냅니다.|  
|[CMFCVisualManagerOffice2003::IsWindowsThemingSupported](#iswindowsthemingsupported)|Windows 테마 설정 지원 되는지 여부를 나타냅니다. (재정의 [CMFCVisualManager::IsWindowsThemingSupported](../../mfc/reference/cmfcvisualmanager-class.md#iswindowsthemingsupported).)|  
...
|[CMFCVisualManagerOffice2003::OnDrawCaptionBarBorder](#ondrawcaptionbarborder)|테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCCaptionBar 클래스](../../mfc/reference/cmfccaptionbar-class.md) 개체입니다. (재정의 [CMFCVisualManager::OnDrawCaptionBarBorder](../../mfc/reference/cmfcvisualmanager-class.md#ondrawcaptionbarborder).)|  
|[CMFCVisualManagerOffice2003::OnDrawCheckBoxEx](#ondrawcheckboxex)|Checkbox를 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (재정의 [CMFCVisualManager::OnDrawCheckBoxEx](../../mfc/reference/cmfcvisualmanager-class.md#ondrawcheckboxex).)|  
|[CMFCVisualManagerOffice2003::OnDrawComboBorder](#ondrawcomboborder)|주위에 테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCToolBarComboBoxButton 클래스](../../mfc/reference/cmfctoolbarcomboboxbutton-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawComboBorder`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawComboDropButton](#ondrawcombodropbutton)|드롭 단추를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCToolBarComboBoxButton 클래스](../../mfc/reference/cmfctoolbarcomboboxbutton-class.md)합니다. (`CMFCVisualManagerOfficeXP::OnDrawComboDropButton`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawExpandingBox](#ondrawexpandingbox)|확장 상자를 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (재정의 [CMFCVisualManager::OnDrawExpandingBox](../../mfc/reference/cmfcvisualmanager-class.md#ondrawexpandingbox).)|  
|[CMFCVisualManagerOffice2003::OnDrawHeaderCtrlBorder](#ondrawheaderctrlborder)|인스턴스 주위에 테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCHeaderCtrl 클래스](../../mfc/reference/cmfcheaderctrl-class.md)합니다. (재정의 [CMFCVisualManager::OnDrawHeaderCtrlBorder](../../mfc/reference/cmfcvisualmanager-class.md#ondrawheaderctrlborder).)|  
|[CMFCVisualManagerOffice2003::OnDrawMenuBorder](#ondrawmenuborder)|테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCPopupMenu 클래스](../../mfc/reference/cmfcpopupmenu-class.md)합니다. (`CMFCVisualManagerOfficeXP::OnDrawMenuBorder`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawPaneBorder](#ondrawpaneborder)|테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CPane 클래스](../../mfc/reference/cpane-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawPaneBorder`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawPaneCaption](#ondrawpanecaption)|에 대 한 캡션을 그릴 때 프레임 워크에서이 메서드를 호출는 [CDockablePane 클래스](../../mfc/reference/cdockablepane-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawPaneCaption`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawPopupWindowBorder](#ondrawpopupwindowborder)|팝업 창 테두리를 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnDrawPopupWindowBorder`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawPopupWindowButtonBorder](#ondrawpopupwindowbuttonborder)|팝업 창에 있는 단추의 테두리를 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnDrawPopupWindowButtonBorder`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawRibbonProgressBar](#ondrawribbonprogressbar)|그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCRibbonProgressBar 클래스](../../mfc/reference/cmfcribbonprogressbar-class.md)합니다. (재정의 [CMFCVisualManager::OnDrawRibbonProgressBar](../../mfc/reference/cmfcvisualmanager-class.md#ondrawribbonprogressbar).)|  
|[CMFCVisualManagerOffice2003::OnDrawRibbonQuickAccessToolBarSeparator](#ondrawribbonquickaccesstoolbarseparator)|리본 메뉴의 빠른 실행 도구 모음에서 구분 기호를 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnDrawRibbonQuickAccessToolBarSeparator`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawRibbonSliderChannel](#ondrawribbonsliderchannel)|채널을 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCRibbonSlider 클래스](../../mfc/reference/cmfcribbonslider-class.md)합니다. (재정의 [CMFCVisualManager::OnDrawRibbonSliderChannel](../../mfc/reference/cmfcvisualmanager-class.md#ondrawribbonsliderchannel).)|  
|[CMFCVisualManagerOffice2003::OnDrawRibbonSliderThumb](#ondrawribbonsliderthumb)|엄지 단추를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCRibbonSlider](../../mfc/reference/cmfcribbonslider-class.md) 개체입니다. (재정의 [CMFCVisualManager::OnDrawRibbonSliderThumb](../../mfc/reference/cmfcvisualmanager-class.md#ondrawribbonsliderthumb).)|  
|[CMFCVisualManagerOffice2003::OnDrawRibbonSliderZoomButton](#ondrawribbonsliderzoombutton)|에 대 한 확대/축소 단추를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCRibbonSlider](../../mfc/reference/cmfcribbonslider-class.md) 개체입니다. (재정의 [CMFCVisualManager::OnDrawRibbonSliderZoomButton](../../mfc/reference/cmfcvisualmanager-class.md#ondrawribbonsliderzoombutton).)|  
...
|[CMFCVisualManagerOffice2003::OnDrawShowAllMenuItems](#ondrawshowallmenuitems)|메뉴에 있는 모든 항목을 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (재정의 [CMFCVisualManager::OnDrawShowAllMenuItems](../../mfc/reference/cmfcvisualmanager-class.md#ondrawshowallmenuitems).)|  
|[CMFCVisualManagerOffice2003::OnDrawStatusBarPaneBorder](#ondrawstatusbarpaneborder)|테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCStatusBar 클래스](../../mfc/reference/cmfcstatusbar-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawStatusBarPaneBorder`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawStatusBarProgress](#ondrawstatusbarprogress)|진행률 표시기 그릴 때 프레임 워크에이 메서드 호출의 [CMFCStatusBar](../../mfc/reference/cmfcstatusbar-class.md) 개체입니다. (재정의 [CMFCVisualManager::OnDrawStatusBarProgress](../../mfc/reference/cmfcvisualmanager-class.md#ondrawstatusbarprogress).)|  
|[CMFCVisualManagerOffice2003::OnDrawStatusBarSizeBox](#ondrawstatusbarsizebox)|에 대 한 크기 상자를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCStatusBar](../../mfc/reference/cmfcstatusbar-class.md)합니다. (재정의 [CMFCVisualManager::OnDrawStatusBarSizeBox](../../mfc/reference/cmfcvisualmanager-class.md#ondrawstatusbarsizebox).)|  
|[CMFCVisualManagerOffice2003::OnDrawTab](#ondrawtab)|에 대 한 탭을 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCBaseTabCtrl 클래스](../../mfc/reference/cmfcbasetabctrl-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawTab`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawTabsButtonBorder](#ondrawtabsbuttonborder)|탭 단추의 테두리를 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnDrawTabsButtonBorder`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawTask](#ondrawtask)|그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPaneTask 클래스](../../mfc/reference/cmfctaskspanetask-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawTask`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawTasksGroupAreaBorder](#ondrawtasksgroupareaborder)|그룹 주위에 테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPane 클래스](../../mfc/reference/cmfctaskspane-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawTasksGroupAreaBorder`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawTasksGroupCaption](#ondrawtasksgroupcaption)|에 대 한 캡션을 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPaneTaskGroup 클래스](../../mfc/reference/cmfctaskspanetaskgroup-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawTasksGroupCaption`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnDrawTearOffCaption](#ondrawtearoffcaption)|에 대 한 캡션을 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCPopupMenu 클래스](../../mfc/reference/cmfcpopupmenu-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnDrawTearOffCaption`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::OnEraseTabsArea](#onerasetabsarea)|탭 창의 탭 영역을 지울 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnEraseTabsArea`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnEraseTabsButton](#onerasetabsbutton)|텍스트 및 탭 단추 아이콘을 지울 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnEraseTabsButton`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::OnFillBarBackground](#onfillbarbackground)|배경을 채울 때 프레임 워크에서이 메서드를 호출는 [CBasePane 클래스](../../mfc/reference/cbasepane-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnFillBarBackground`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::OnFillHighlightedArea](#onfillhighlightedarea)|도구 모음 단추의 강조 표시 된 영역을 채울 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnFillHighlightedArea`를 재정의합니다.)|  
...
|[CMFCVisualManagerOffice2003::OnFillOutlookPageButton](#onfilloutlookpagebutton)|프레임 워크 내부 Outlook 페이지 단추를 채울 때이 메서드를 호출 합니다. (재정의 [CMFCVisualManager::OnFillOutlookPageButton](../../mfc/reference/cmfcvisualmanager-class.md#onfilloutlookpagebutton).)|  
...
|[CMFCVisualManagerOffice2003::OnFillTab](#onfilltab)|탭 창의 배경을 채울 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnFillTab`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnFillTasksGroupInterior](#onfilltasksgroupinterior)|프레임 워크의 내부를 채웁니다 때이 메서드를 호출는 [CMFCTasksPaneTaskGroup 클래스](../../mfc/reference/cmfctaskspanetaskgroup-class.md) 개체입니다. (`CMFCVisualManagerOfficeXP::OnFillTasksGroupInterior`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnFillTasksPaneBackground](#onfilltaskspanebackground)|배경을 채울 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPane](../../mfc/reference/cmfctaskspane-class.md) 제어 합니다. (재정의 [CMFCVisualManager::OnFillTasksPaneBackground](../../mfc/reference/cmfcvisualmanager-class.md#onfilltaskspanebackground).)|  
|[CMFCVisualManagerOffice2003::OnHighlightQuickCustomizeMenuButton](#onhighlightquickcustomizemenubutton)|이 메서드는 강조 표시 된 그릴 때 빠른-사용자 지정 메뉴 단추는 프레임 워크 호출 합니다. (`CMFCVisualManagerOfficeXP::OnHighlightQuickCustomizeMenuButton`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnHighlightRarelyUsedMenuItems](#onhighlightrarelyusedmenuitems)|강조 표시 된 메뉴 명령 그릴 때 프레임 워크에서이 메서드를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnHighlightRarelyUsedMenuItems`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::OnUpdateSystemColors](#onupdatesystemcolors)|시스템 색이 변경 될 때 프레임 워크에서이 함수를 호출 합니다. (`CMFCVisualManagerOfficeXP::OnUpdateSystemColors`를 재정의합니다.)|  
|[CMFCVisualManagerOffice2003::SetDefaultWinXPColors](#setdefaultwinxpcolors)|비주얼 관리자 네이티브 Windows XP 테마 색을 사용할지 또는 색에서 가져온 지정 [GetSysColor](http://msdn.microsoft.com/library/windows/desktop/ms724371)합니다.|  
...
### <a name="return-value"></a>반환 값  
 반환 `TRUE` 테마 API 사용 되는 경우 또는 `FALSE` 그렇지 않은 경우.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsHighlighted*  
 콤보 상자 드롭다운 단추는 강조 표시 여부를 지정 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsHorz*  
 `TRUE` 단추가 가로 경우 또는 `FALSE` 세로 이면 합니다.  
  
 [in] *상태*  
 (일반, 누름 또는 강조 표시 된) 그릴 그대로 단추의 상태가입니다.  
  
 [in] *bIsCustomize*  
 `TRUE` 사용자 지정 다운 화살표 또는 왼쪽 화살표 이미지 단추 사각형에 로드 해야 하는 경우 또는 `FALSE` 그렇지 않은 경우.  
...
### <a name="return-value"></a>반환 값  
 강조 표시 된 메뉴 항목에 대해 사용 되는 색을 반환 합니다.  
...
### <a name="return-value"></a>반환 값  
 반환 된 [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) 강조 톤 색을 포함 하 합니다.  
...
### <a name="return-value"></a>반환 값  
 반환 된 [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) 비활성화 된 색을 포함 하 합니다.  
...
##  <a name="isdefaultwinxpcolorsenabled"></a>  CMFCVisualManagerOffice2003::IsDefaultWinXPColorsEnabled  
 비주얼 관리자의 기본 Windows XP 테마 색을 사용 하는지 여부를 나타냅니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE` 비주얼 관리자; 기본 색을 사용 하는 경우 그렇지 않으면 `FALSE`합니다.  
...
##  <a name="ishighlightonenotetabs"></a>  CMFCVisualManagerOffice2003::IsHighlightOneNoteTabs  
 OneNote 탭을 강조 해야 하는지 여부를 나타냅니다.  
...
##  <a name="isstatusbarofficexplook"></a>  CMFCVisualManagerOffice2003::IsStatusBarOfficeXPLook  
 Office XP 모양으로는 상태 표시줄이 있는지 여부를 나타냅니다.  
...
### <a name="remarks"></a>설명  
 반환 `TRUE` Office XP 모양 있는 상태 표시줄에 없는 경우 또는 `FALSE` 그렇지 않은 경우.  
  
##  <a name="istoolbarroundshape"></a>  CMFCVisualManagerOffice2003::IsToolbarRoundShape  
 지정 된 도구 모음이 라운드 인지를 나타냅니다.  
...
### <a name="return-value"></a>반환 값  
 반환 `TRUE` 도구 모음이 round, 또는 `FALSE` 메뉴 모음 이라고 하는 경우.  
  
### <a name="remarks"></a>설명  
  
##  <a name="isuseglobaltheme"></a>  CMFCVisualManagerOffice2003::IsUseGlobalTheme  
 응용 프로그램에서 Windows XP 테마를 사용 하는지 여부를 나타냅니다.  
...
##  <a name="iswindowsthemingsupported"></a>  CMFCVisualManagerOffice2003::IsWindowsThemingSupported  
 Windows 테마 설정 지원 되는지 여부를 나타냅니다.  
...
### <a name="return-value"></a>반환 값  
 반환 `TRUE` Windows 테마 설정 지원 되 면 또는 `FALSE` 그렇지 않은 경우.  
...
### <a name="remarks"></a>설명  
 이 메서드의 기본 구현 표준 위치 조정 막대를 표시합니다. 위치 조정 막대의 모양을 사용자 지정 하려면 사용자 지정에서 파생 된 클래스에서이 메서드를 재정의 하는 [CMFCVisualManagerOffice2003](../../mfc/reference/cmfcvisualmanageroffice2003-class.md) 클래스입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bFlatBorder*  
 `TRUE` 테두리를 2D 평평한 모양이 있어야 하는 경우 또는 `FALSE` 그렇지 않은 경우.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *nState*  
 확인란의 상태: 선택 하지 않는 경우 0, 1, 2 경우 선택 혼합 하는 경우.  
  
 [in] *bHighlighted*  
 `TRUE` 이 확인란을 강조 표시 하는 경우 또는 `FALSE` 그렇지 않은 경우.  
  
 [in] *bPressed*  
 `TRUE` checkbox를 누른 경우 또는 `FALSE` 그렇지 않은 경우.  
...
##  <a name="ondrawcombodropbutton"></a>  CMFCVisualManagerOffice2003::OnDrawComboDropButton  
 드롭 단추를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCToolBarComboBoxButton 클래스](../../mfc/reference/cmfctoolbarcomboboxbutton-class.md)합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pButton*  
 에 대 한 포인터는 `CMFCToolBarComboBoxButton` 개체입니다. 프레임 워크가 콤보 상자 단추의 드롭 단추를 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *pDC*  
 확장 상자를 그릴 인 디스플레이 컨텍스트에 대 한 포인터입니다.  
  
 [in] *rect*  
 확장 상자를 그릴 수의 경계 사각형입니다.  
  
 [in] *bIsOpened*  
 `TRUE` 그릴 상자를 연 경우 또는 `FALSE` 그렇지 않은 경우.  
  
 [in] *colorBox*  
 상자를 그릴 수의 바깥쪽 테두리의 색입니다.  
...
##  <a name="ondrawmenuborder"></a>  CMFCVisualManagerOffice2003::OnDrawMenuBorder  
 테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCPopupMenu 클래스](../../mfc/reference/cmfcpopupmenu-class.md)합니다.  
...
##  <a name="ondrawpanecaption"></a>  CMFCVisualManagerOffice2003::OnDrawPaneCaption  
 에 대 한 캡션을 그릴 때 프레임 워크에서이 메서드를 호출는 [CDockablePane 클래스](../../mfc/reference/cdockablepane-class.md) 개체입니다.  
...
##  <a name="ondrawpopupwindowborder"></a>  CMFCVisualManagerOffice2003::OnDrawPopupWindowBorder  
 팝업 창 테두리를 그릴 때 프레임 워크에서이 메서드를 호출 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pPopupWnd*  
 캡션이 되을 그릴 수 있도록 팝업 창에 대 한 포인터입니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *pDC*  
 리본 범주에 속하는 장치 컨텍스트에 대 한 포인터입니다.  
  
 [in] *pContextCaption*  
 캡션 표시줄에 대 한 포인터입니다. 비주얼 관리자 그립니다이 [CMFCRibbonContextCaption 클래스](../../mfc/reference/cmfcribboncontextcaption-class.md)합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsActive*  
 `TRUE` 탭이 활성 상태 이면 또는 `FALSE` 그렇지 않은 경우.  
...
##  <a name="ondrawribbonprogressbar"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonProgressBar  
 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCRibbonProgressBar 클래스](../../mfc/reference/cmfcribbonprogressbar-class.md)개체입니다.  
...
##  <a name="ondrawribbonquickaccesstoolbarseparator"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonQuickAccessToolBarSeparator  
 리본 메뉴의 빠른 실행 도구 모음에서 구분 기호를 그릴 때 프레임 워크에서이 메서드를 호출 합니다.  
...
### <a name="remarks"></a>설명  
 빠른 실행 도구 모음의 구분 기호 리본 메뉴의 모양을 사용자 지정 하는 파생된 클래스에서이 메서드를 재정의 합니다.  
...
##  <a name="ondrawribbonsliderthumb"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonSliderThumb  
 엄지 단추를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCRibbonSlider 클래스](../../mfc/reference/cmfcribbonslider-class.md) 개체  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsHighlighted*  
 엄지 단추의 강조 표시 되는지 여부를 나타내는 부울 매개 변수입니다.  
...
##  <a name="ondrawribbonsliderzoombutton"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonSliderZoomButton  
 에 대 한 확대/축소 단추를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCRibbonSlider 클래스](../../mfc/reference/cmfcribbonslider-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsZoomOut*  
 `TRUE` 프레임 워크와 왼쪽된 단추를 그려야 하는 경우는 " **-**" out, 확대/축소에 대 한 또는 `FALSE` 프레임 워크와 오른쪽 단추를 그려야 하는 경우는 " **+**"에서 확대/축소에 대 한 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *nBorderSize*  
 스크롤 단추 주위에 테두리의 크기입니다.  
  
 [in] *iImage*  
 스크롤 단추에 그릴 이미지의 식별자입니다.  
  
 [in] *bHilited*  
 `TRUE` 스크롤 단추 강조 표시 하는 경우 또는 `FALSE` 그렇지 않은 경우.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsHoriz*  
 `TRUE` 창에서 가로로 도킹 되는 경우 또는 `FALSE` 창이 도킹 되어 있는 세로로 하는 경우.  
...
##  <a name="ondrawshowallmenuitems"></a>  CMFCVisualManagerOffice2003::OnDrawShowAllMenuItems  
 메뉴에 있는 모든 항목을 그릴 때 프레임 워크에이 메서드 호출  
...
##  <a name="ondrawstatusbarpaneborder"></a>  CMFCVisualManagerOffice2003::OnDrawStatusBarPaneBorder  
 테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCStatusBar 클래스](../../mfc/reference/cmfcstatusbar-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pBar*  
 에 대 한 포인터는 [CMFCStatusBar 클래스](../../mfc/reference/cmfcstatusbar-class.md) 개체입니다. 프레임 워크는이 상태 표시줄 개체를 그립니다.  
...
##  <a name="ondrawstatusbarprogress"></a>  CMFCVisualManagerOffice2003::OnDrawStatusBarProgress  
 진행률 표시기 그릴 때 프레임 워크에이 메서드 호출의 [CMFCStatusBar 클래스](../../mfc/reference/cmfcstatusbar-class.md) 개체  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pStatusBar*  
 [CMFCStatusBar 클래스](../../mfc/reference/cmfcstatusbar-class.md) 진행률 표시줄을 포함 하는 개체입니다.  
...
### <a name="remarks"></a>설명  
 상태 표시줄에 진행률 표시줄의 모양을 사용자 지정 하는 파생된 비주얼 관리자에서이 메서드를 재정의 합니다.  
  
##  <a name="ondrawstatusbarsizebox"></a>  CMFCVisualManagerOffice2003::OnDrawStatusBarSizeBox  
 에 대 한 크기 상자를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCStatusBar 클래스](../../mfc/reference/cmfcstatusbar-class.md)합니다.  
...
### <a name="remarks"></a>설명  
 상태 표시줄에 크기 상자의 모양을 사용자 지정 하는 파생된 비주얼 관리자에서이 메서드를 재정의 합니다.  
  
##  <a name="ondrawtab"></a>  CMFCVisualManagerOffice2003::OnDrawTab  
 에 대 한 탭을 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCBaseTabCtrl 클래스](../../mfc/reference/cmfcbasetabctrl-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsActive*  
 탭이 활성화 여부를 지정 하는 부울 매개 변수입니다.  
  
 [in] *pTabWnd*  
 에 대 한 포인터는 [CMFCBaseTabCtrl 클래스](../../mfc/reference/cmfcbasetabctrl-class.md) 개체입니다. 프레임 워크는이 탭 컨트롤을 그립니다.  
  
### <a name="remarks"></a>설명  
 A `CMFCBaseTabCtrl` 개체 WM_PAINT 메시지를 처리 하는 경우이 메서드를 호출 합니다. 탭의 모양 사용자 지정 파생된 클래스에서이 메서드를 재정의 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *rect*  
 탭 단추 경계를 지정 하는 사각형입니다.  
  
 [in] *pButton*  
 에 대 한 포인터는 [CMFCButton 클래스](../../mfc/reference/cmfcbutton-class.md) 프레임 워크 테두리를 그립니다.  
...
##  <a name="ondrawtask"></a>  CMFCVisualManagerOffice2003::OnDrawTask  
 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPaneTask 클래스](../../mfc/reference/cmfctaskspanetask-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pTask*  
 에 대 한 포인터는 [CMFCTasksPaneTask 클래스](../../mfc/reference/cmfctaskspanetask-class.md) 개체입니다. 프레임 워크는이 작업을 그립니다.  
...
### <a name="remarks"></a>설명  
 아이콘 및 텍스트를 둘 다로 작업 표시줄에서 프레임 워크에 작업이 표시 됩니다. `pIcons` 매개 변수에 포함 하 여 해당 작업에 대 한 아이콘 `pTask`합니다. 작업 표시줄에 있는 작업의 모양을 사용자 지정 하는 파생된 클래스에서이 메서드를 재정의 합니다.  
  
##  <a name="ondrawtasksgroupareaborder"></a>  CMFCVisualManagerOffice2003::OnDrawTasksGroupAreaBorder  
 그룹 주위에 테두리를 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPane 클래스](../../mfc/reference/cmfctaskspane-class.md) 개체입니다.  
...
##  <a name="ondrawtasksgroupcaption"></a>  CMFCVisualManagerOffice2003::OnDrawTasksGroupCaption  
 에 대 한 캡션을 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPaneTaskGroup 클래스](../../mfc/reference/cmfctaskspanetaskgroup-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pGroup*  
 에 대 한 포인터는 [CMFCTasksPaneTaskGroup 클래스](../../mfc/reference/cmfctaskspanetaskgroup-class.md) 개체입니다. 프레임 워크에는이 그룹에 대 한 캡션을 그립니다.  
...
##  <a name="ondrawtearoffcaption"></a>  CMFCVisualManagerOffice2003::OnDrawTearOffCaption  
 에 대 한 캡션을 그릴 때 프레임 워크에서이 메서드를 호출는 [CMFCPopupMenu 클래스](../../mfc/reference/cmfcpopupmenu-class.md) 개체입니다.  
...
### <a name="remarks"></a>설명  
 프레임 워크에서이 함수가 호출 될 때는 [CMFCPopupMenu 클래스](../../mfc/reference/cmfcpopupmenu-class.md) 개체에서 WM_PAINT 메시지를 처리 하 고 분리 캡션을 그립니다 해야 합니다.  
...
### <a name="remarks"></a>설명  
 프레임 워크에서이 함수가 호출 될 때는 [CMFCBaseTabCtrl 클래스](../../mfc/reference/cmfcbasetabctrl-class.md) 개체에서 WM_PAINT 메시지를 처리 하 고 탭 영역을 지웁니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pButton*  
 탭 단추에 대 한 포인터입니다. 프레임 워크는 텍스트와이 단추에 대 한 아이콘을 지웁니다.  
  
 [in] *pWndTab*  
 탭 단추를 포함 하는 탭 컨트롤에 대 한 포인터입니다.  
  
### <a name="remarks"></a>설명  
 프레임 워크를 텍스트 및 단추에 대 한 아이콘 지웁니다 때는 [CMFCBaseTabCtrl 클래스](../../mfc/reference/cmfcbasetabctrl-class.md) WM_ERASEBKGND 메시지를 처리 하는 개체  
  
 탭 단추 모양 사용자 지정 하는 파생된 비주얼 관리자에서이 메서드를 재정의 합니다.  
  
##  <a name="onerasetabsframe"></a>  CMFCVisualManagerOffice2003::OnEraseTabsFrame  
 프레임 워크에서 프레임을 지울 때이 메서드를 호출는 [CMFCBaseTabCtrl 클래스](../../mfc/reference/cmfcbasetabctrl-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pTabWnd*  
 탭 창에 대 한 포인터입니다. 프레임 워크는 프레임이 지웁니다 [CMFCBaseTabCtrl 클래스](../../mfc/reference/cmfcbasetabctrl-class.md)합니다.  
  
### <a name="return-value"></a>반환 값  
 `TRUE` 메서드가 성공 하면 또는 `FALSE` 그렇지 않은 경우.  
  
### <a name="remarks"></a>설명  
 이 메서드는 가리키는 영역을 채우는 *rect* 활성 탭의 배경색으로 합니다. 될 때 호출 됩니다는 `CMFCBaseTabCtrl` 개체에서 WM_PAINT 메시지를 처리 하 고 탭 프레임을 지웁니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pButton*  
 에 대 한 포인터는 [CMFCAutoHideButton 클래스](../../mfc/reference/cmfcautohidebutton-class.md) 개체입니다. 프레임 워크에는이 자동 숨기기 단추의 배경을 채웁니다.  
...
##  <a name="onfillbarbackground"></a>  CMFCVisualManagerOffice2003::OnFillBarBackground  
 배경을 채울 때 프레임 워크에서이 메서드를 호출는 [CBasePane 클래스](../../mfc/reference/cbasepane-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pBar*  
 에 대 한 포인터는 [CBasePane 클래스](../../mfc/reference/cbasepane-class.md) 개체입니다. 프레임 워크를이 창의 배경을 채웁니다.  
...
### <a name="remarks"></a>설명  
 이 메서드의 기본 구현 전역 변수에서 3d 배경색으로 막대의 배경을 채울 `afxGlobalData`합니다.  
  
 창의 배경을 사용자 지정할 수 파생된 비주얼 관리자에서이 메서드를 재정의 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pButton*  
 프레임 워크 백그라운드를 작성 하는 단추에 대 한 포인터입니다.  
  
 [in] *rect*  
 도구 모음 단추 경계를 지정 하는 사각형입니다.  
  
 [in] *상태*  
 도구 모음 단추의 상태 (도구 모음 단추의 가능한 상태는 `ButtonsIsRegular`, `ButtonsIsPressed`, 또는 `ButtonsIsHighlighted`).  
...
### <a name="parameters"></a>매개 변수  
 [in] *pCtrl*  
 에 대 한 포인터는 [CMFCHeaderCtrl 클래스](../../mfc/reference/cmfcheaderctrl-class.md) 개체입니다. 프레임 워크에는이 헤더 컨트롤의 배경을 채웁니다.  
...
##  <a name="onfillhighlightedarea"></a>  CMFCVisualManagerOffice2003::OnFillHighlightedArea  
 도구 모음 단추의 강조 표시 된 영역을 채울 때 프레임 워크에서이 메서드를 호출 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *rect*  
 강조 표시 된 영역을 채우는의 경계 사각형입니다.  
  
 [in] *pBrush*  
 강조 표시 된 영역을 채우는 상자에서 사용 하는 브러시입니다.  
  
 [in] *pButton*  
 에 대 한 포인터는 [CMFCToolBarButton 클래스](../../mfc/reference/cmfctoolbarbutton-class.md) 개체 강조 표시 된 영역을 채우는입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [out] *clrText*  
 에 대 한 참조는 `COLORREF` 텍스트 색을 캡션 표시줄에이 메서드를 작성 하는 개체입니다.  
  
### <a name="remarks"></a>설명  
 이 메서드의 기본 구현 캡션 표시줄을 현재 스킨에 따라 그림자 색으로 채웁니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [out] *clrText*  
 에 대 한 참조는 `COLORREF` 경우이 메서드는 outlook 페이지 단추 텍스트 색을 저장 하는 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pbrFill*  
 프레임 워크 탭 창에 맞게 사용 하는 브러시에 대 한 포인터입니다.  
  
 [in] *iTab*  
 프레임 워크를 배경을 채울 탭의 0부터 시작 하는 탭 인덱스입니다.  
  
 [in] *bIsActive*  
 `TRUE` 탭이 활성화 하는 경우 또는 `FALSE` 그렇지 않은 경우.  
...
##  <a name="onfilltasksgroupinterior"></a>  CMFCVisualManagerOffice2003::OnFillTasksGroupInterior  
 프레임 워크의 내부를 채웁니다 때이 메서드를 호출는 [CMFCTasksPaneTaskGroup 클래스](../../mfc/reference/cmfctaskspanetaskgroup-class.md) 개체입니다.  
...
##  <a name="onfilltaskspanebackground"></a>  CMFCVisualManagerOffice2003::OnFillTasksPaneBackground  
 배경을 채울 때 프레임 워크에서이 메서드를 호출는 [CMFCTasksPane 클래스](../../mfc/reference/cmfctaskspane-class.md) 제어 합니다.  
...
### <a name="remarks"></a>설명  
 모양을 사용자 지정 하는 파생된 비주얼 관리자에서이 메서드를 재정의 한 [CMFCTasksPane 클래스](../../mfc/reference/cmfctaskspane-class.md) 개체입니다.  
  
##  <a name="onhighlightquickcustomizemenubutton"></a>  CMFCVisualManagerOffice2003::OnHighlightQuickCustomizeMenuButton  
 이 메서드는 강조 표시 된 그릴 때 빠른-사용자 지정 메뉴 단추는 프레임 워크 호출 합니다.  
...
### <a name="remarks"></a>설명  
 프레임 워크 WM_SYSCOLORCHANGE 메시지 처리의 일부분으로이 메서드를 호출 합니다. 사용자 지정 코드를 실행 하 여 응용 프로그램에서 색을 변경 하려는 경우에 파생된 비주얼 관리자에서이 메서드를 재정의 합니다.  
  
##  <a name="setdefaultwinxpcolors"></a>  CMFCVisualManagerOffice2003::SetDefaultWinXPColors  
 비주얼 관리자 네이티브 Windows XP 테마 색을 사용할지 또는 색에서 가져온 지정 [GetSysColor](http://msdn.microsoft.com/library/windows/desktop/ms724371)합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 비주얼 관리자가 네이티브 Windows XP 색을 사용할지 여부를 지정 합니다.  
  
### <a name="remarks"></a>설명  
 경우 *bDefaultWinXPColors* 은 `TRUE`를 비주얼 관리자 blue, 황록색, silver 등의 네이티브 Windows XP 색을 사용 합니다. 비주얼 관리자에서 가져온 색을 사용 합니다, `GetSysColor`합니다. 비주얼 관리자와 같은 시각적 요소를 사용 `COLOR_3DFACE`, `COLOR_3DSHADOW`, `COLOR_3DHIGHLIGHT`, `COLOR_3DDKSHADOW`, 및 `COLOR_3DLIGHT`합니다.  
  
 기본적으로는 `CMFCVisualManagerOffice2003` 개체가 네이티브 Windows XP 테마 색을 사용 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `TRUE` Windows XP 전역 테마 해야 하는 경우 (기본값), 사용 또는 `FALSE` 그렇지 않은 경우.  
...
### <a name="parameters"></a>매개 변수  
 [in] *bUseGlobalTheme*  
 `TRUE` 비주얼 관리자; 전역 테마를 사용 하려는 경우 `FALSE` 그렇지 않은 경우.  
  
### <a name="remarks"></a>설명  
 경우는 `CMFCVisualManagerOffice2003` 전역 테마를 사용 하는 개체를 사용 하 여 GUI 요소를 그립니다는 [CMFCVisualManagerWindows 클래스](../../mfc/reference/cmfcvisualmanagerwindows-class.md)합니다.  
  
 경우는 `CMFCVisualManagerOffice2003` 개체 전역 테마를 사용 하지 않는, 사용 하 여 GUI 요소를 그립니다는 [CMFCVisualManagerOfficeXP 클래스](../../mfc/reference/cmfcvisualmanagerofficexp-class.md)합니다.  
