...
### <a name="return-value"></a>반환 값  
 텍스트 색을 *pButton* 하 여 지정 된 상태 할당 했을 때 *상태*합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [out] *clrText*  
 에 대 한 참조는 [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) 매개 변수입니다. 예약 된 값 이며 현재 사용 되지 않습니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pBar*  
 에 대 한 포인터는 `CMFCCaptionBar` 개체입니다. 프레임 워크는 캡션 표시줄에이 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *nImageID*  
 단추에 사용할 아이콘에 대 한 이미지 인덱스입니다. 경우 *nImageID* -1 이면이 방법 사용 하 여 이미지 인덱스에 기록 *pButton*합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsDisabled*  
 리본 메뉴 단추를 사용할 수 있는지 여부를 나타내는 부울 매개 변수입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *rect*  
 사각형의 경계를 지정 하는 `CMFCToolBarEditBoxButton` 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *pCtrl*  
 에 대 한 포인터는 `CMFCHeaderCtrl` 개체입니다. 프레임 워크는이 헤더 컨트롤의 테두리를 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *pCtrl*  
 헤더 컨트롤에 대 한 포인터입니다. 비주얼 관리자의이 정렬 화살표를 그립니다 [CMFCHeaderCtrl 클래스](../../mfc/reference/cmfcheaderctrl-class.md) 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *pDC*  
 장치 컨텍스트에 대 한 포인터는 `CMFCPopupMenu` 개체입니다.  
  
 [in] *pMenu*  
 에 대 한 포인터는 `CMFCPopupMenu` 개체입니다. 프레임 워크는이 팝업 메뉴 주위에 테두리를 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pTab*  
 인스턴스에 대 한 포인터는 `CMFCRibbonTab` 클래스입니다. 프레임 워크는이 탭을 그립니다.  
  
 [in] *bIsActive*  
 탭이 활성화 여부를 나타내는 부울 매개 변수입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pLabel*  
 에 대 한 포인터는 [CMFCRibbonLabel](../../mfc/reference/cmfcribbonlabel-class.md) 개체입니다. 프레임 워크에는이 리본 메뉴 레이블을 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pPanel*  
 에 대 한 포인터는 `CMFCRibbonMainPanel`합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pPanel*  
 에 대 한 포인터는 `CMFCRibbonPanel` 개체입니다. 프레임 워크는이 리본 패널을 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pProgress*  
 에 대 한 포인터는 `CMFCRibbonProgressBar` 개체입니다. 프레임 워크는이 진행률 표시줄을 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pSlider*  
 CMFCRibbonSlider 개체에 대 한 포인터입니다. 프레임 워크는이 리본 슬라이더에 대 한 채널을 그립니다.  
 ...
 *pWndRibbonBar*  
 에 대 한 포인터는 [CMFCRibbonBar](../../mfc/reference/cmfcribbonbar-class.md) 개체입니다. 프레임 워크는이 리본 표시줄에 대 한 프레임을 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pSplitterWnd*  
 분할 창에 대 한 포인터입니다. 프레임 워크는이 창에 대 한 테두리를 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pSplitterWnd*  
 분할 창에 대 한 포인터입니다. 프레임 워크는이 분할자 창에 대 한 상자를 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pBar*  
 에 대 한 포인터는 `CMFCStatusBar` 개체입니다. 프레임 워크는이 상태 표시줄 개체를 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pTabWnd*  
 탭 컨트롤에 대 한 포인터입니다. 프레임 워크 그립니다는 **닫기** 이 탭 컨트롤에 대 한 단추입니다.  
...
### <a name="remarks"></a>설명  
 모양을 사용자 지정 하는 파생된 비주얼 관리자에서이 메서드를 재정의 **닫기** 활성 탭의 단추를 *pTabWnd*합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pTabWnd*  
 그리고 탭을 포함 하는 탭된 컨트롤에 대 한 포인터입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pButton*  
 에 대 한 포인터는 [CMFCButton](../../mfc/reference/cmfcbutton-class.md) 개체입니다. 이 프레임 워크에 테두리를 그리는 `CMFCButton` 인스턴스.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pGroup*  
 에 대 한 포인터는 `CMFCTasksPaneTaskGroup` 개체입니다. 프레임 워크에는이 그룹에 대 한 캡션을 그립니다.  
...
### <a name="remarks"></a>설명  
 프레임 워크를 텍스트 및 단추에 대 한 아이콘 지웁니다 때는 [CMFCBaseTabCtrl](../../mfc/reference/cmfcbasetabctrl-class.md) WM_ERASEBKGND 메시지를 처리 하는 개체입니다.  
...
### <a name="return-value"></a>반환 값  
 로 지정 된 리본 메뉴 단추에 대 한 텍스트의 색 *pButton* 리본 단추 텍스트를 지 원하는 경우. 리본 단추에 대 한 텍스트 유효 하지 않을 경우-1의 값입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *pEdit*  
 에 대 한 포인터는 `CMFCRibbonRichEditCtrl` 개체입니다. 프레임 워크는이 편집 컨트롤의 내부를 채웁니다.  
  
 [in] *rect*  
 편집 컨트롤의 경계를 지정 하는 사각형입니다.  
...
### <a name="remarks"></a>설명  
 프레임 워크 WM_SYSCOLORCHANGE 메시지 처리의 일부분으로이 메서드를 호출 합니다. 기본 구현은 아무 작업도 수행하지 않습니다. 사용자 지정 코드를 실행 하 여 응용 프로그램에서 색을 변경 하려는 경우에 파생된 비주얼 관리자에서이 메서드를 재정의 합니다.  
...
##  <a name="setshadowhighlightedimage"></a>  CMFCVisualManager::SetShadowHighlightedImage  
 나타내는 플래그를 설정 여부는 [CMFCVisualManager](../../mfc/reference/cmfcvisualmanager-class.md) 강조 표시 된 이미지에 대 한 그림자를 표시 합니다.  
