...
### <a name="parameters"></a>매개 변수  
 `dwMask`  
 식별 된 하나 이상의 파일 특성을 지정 된 [WIN32_FIND_DATA](http://msdn.microsoft.com/library/windows/desktop/aa365740) 검색된 된 파일에 대 한 구조입니다. 비트 OR를 사용 하 여 여러 특성을 검색 하려면 (&#124;) 연산자. 다음 특성의 조합이 되어도:  
