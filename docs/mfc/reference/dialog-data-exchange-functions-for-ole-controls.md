...
##  <a name="ddx_ocboolro"></a>DDX_OCBoolRO  
 `DDX_OCBoolRO` 함수의 전송을 관리 **BOOL** 대화 상자에는 OLE 컨트롤의 읽기 전용 속성 간의 데이터 보기 또는 컨트롤 뷰 개체의 형태로 및 **BOOL** 대화 상자, 폼 보기 또는 뷰 개체를 컨트롤의 데이터 멤버입니다.  
...
##  <a name="ddx_ocfloatro"></a>DDX_OCFloatRO  
 `DDX_OCFloatRO` 함수의 전송을 관리 **float** (또는 **double**) 대화 상자에는 OLE 컨트롤의 읽기 전용 속성 간의 데이터 보기 또는 컨트롤 뷰 개체의 형태로 및 **float** (또는 **이중**) 대화 상자, 폼 보기 또는 뷰 개체를 컨트롤의 데이터 멤버입니다.  
...
##  <a name="ddx_ocint"></a>DDX_OCInt  
 `DDX_OCInt` 함수의 전송을 관리 `int` (또는 **긴**) 대화 상자에는 OLE 컨트롤의 속성 간에 데이터 보기 또는 컨트롤 뷰 개체의 형태로 및 `int` (또는 **긴**) 대화 상자, 폼 보기 또는 뷰 개체를 컨트롤의 데이터 멤버입니다.  
...
##  <a name="ddx_ocintro"></a>DDX_OCIntRO  
 `DDX_OCIntRO` 함수 콘텐츠 전송을 관리 하며 `int` (또는 **긴**) 대화 상자에는 OLE 컨트롤의 읽기 전용 속성 간의 데이터 보기 또는 컨트롤 뷰 개체의 형태로 및 `int` (또는 **긴**) 대화 상자, 폼 보기 또는 뷰 개체를 컨트롤의 데이터 멤버입니다.  
