...
##  <a name="cdumpcontext_in_mfc_"></a>afxDump (MFC의 CDumpContext)  
...
|`+ 181 bytes`|함수 프로토타입의 주소에서 바이트에서 오프셋 (이 경우 `void AfxDumpStack(unsigned long)`)에서 반환 주소로 (이 경우 `00427D55`) 합니다.|  
