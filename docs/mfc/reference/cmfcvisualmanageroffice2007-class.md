---
title: "CMFCVisualManagerOffice2007 클래스 | Microsoft 문서"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|`CMFCVisualManagerOffice2007::GetStyle`|현재 색 구성표를 반환 합니다.는 `CMFCVisualManagerOffice2007` GUI는 Microsoft Office 2007 GUI를 모방 합니다.|  
...
|`CMFCVisualManagerOffice2007::SetStyle`|설정의 색 구성표는 `CMFCVisualManagerOffice2007` GUI입니다.|  
