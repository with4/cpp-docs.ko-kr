...
## <a name="remarks"></a>설명  
 ...
 사용 하 여는 [m_fr](#m_fr) 호출 하기 전에 대화 상자를 초기화 하는 구조 **만들기**합니다. `m_fr` 형식의 구조는 [FINDREPLACE](http://msdn.microsoft.com/library/windows/desktop/ms646835)합니다. 이 구조에 대 한 자세한 내용은 Windows SDK를 참조 하십시오.  
