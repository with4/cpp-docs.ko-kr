...
|[CCommandLineInfo::m_bRunEmbedded](#m_brunembedded)|명령줄 나타냅니다 **포함/** 옵션을 찾을 수 있습니다.|  
...
|*응용 프로그램* **/Automation**|OLE 자동화 서버 시작 합니다.|  
|*응용 프로그램* **/ 포함**|포함된 된 OLE 항목 편집을 시작 합니다.|  
|*응용 프로그램* **등록 /**<br /><br /> *응용 프로그램* **/Regserver**|모든 등록 작업을 수행 하는 응용 프로그램을 알립니다.|  
|*응용 프로그램* **/ 등록 해제**<br /><br /> *응용 프로그램* **/Unregserver**|모든 등록 취소 작업을 수행 하는 응용 프로그램을 알립니다.|  
...
### <a name="remarks"></a>주의  
 ...
 이러한 값에 대 한 간략 한 설명에 대 한 다음 목록을 참조 합니다.  
...
### <a name="remarks"></a>주의  
 ...
 이 함수의 기본 구현은 다음과 같은 플래그를 인식: **/p**, **/pt**, **/dde**, **/Automation**, 및 **포함/**는 다음 표에 표시 된 것 처럼:  
