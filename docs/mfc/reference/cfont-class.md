...
### <a name="parameters"></a>매개 변수  
 ...
 `nWeight`  
 (1, 000 당 잉크가 픽셀)의 글꼴 두께 지정합니다. 참조는 `lfWeight` 의 멤버는 `LOGFONT` 구조에 대 한 자세한 내용은 Windows sdk입니다. 설명된 값은 근사값입니다. 실제 모양 서체에 따라 달라 집니다. 일부 글꼴만 있는 `FW_NORMAL`, `FW_REGULAR`, 및 `FW_BOLD` 가중치입니다. 경우 `FW_DONTCARE` 지정, 기본 가중치 사용 됩니다.  
