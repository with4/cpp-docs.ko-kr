---
title: "응용 프로그램 설정, MFC ActiveX 컨트롤 마법사 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
manager: "ghogen"
---
# 응용 프로그램 설정, MFC ActiveX 컨트롤 마법사
...
-   *projnamePropPage*.cpp 파일은 [SetHelpInfo](../Topic/COlePropertyPage::SetHelpInfo.md) 함수를 생성자에 포함합니다.  
