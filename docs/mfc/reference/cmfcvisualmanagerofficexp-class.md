---
title: CMFCVisualManagerOfficeXP 클래스 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
## <a name="example"></a>예제  
 다음 예제에서는 사용 하는 방법을 `CMFCVisualManagerOfficeXP`합니다. 이 코드 조각은의 일부인는 [바탕 화면 경고 데모 샘플](../../visual-cpp-samples.md)합니다.  
