...
|[CMFCRibbonBar::IsPrintPreviewEnabled](#isprintpreviewenabled)|결정 여부는 **인쇄 미리 보기** 탭을 사용 하도록 합니다.|  
...
### <a name="remarks"></a>설명  
 이 방법은 리본 범주 및 인쇄 미리 보기를 제공 하는 데 필요한 컨트롤을 만듭니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`창을 만든; 경우 그렇지 않으면 `FALSE`합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`이미지; 그린 하는 경우 그렇지 않으면 `FALSE`합니다.  
  
### <a name="remarks"></a>설명  
  
##  <a name="dwmcompositionchanged"></a>CMFCRibbonBar::DWMCompositionChanged  
 바탕 화면 창 관리자 (DWM) 컴퍼지션을 사용 하거나 사용 하지 않도록 설정 하는 경우에 리본 표시줄의 표시를 조정 합니다.  
...
##  <a name="enablekeytips"></a>CMFCRibbonBar::EnableKeyTips  
 리본 표시줄은 keytip 기능을 해제 하거나 사용 합니다.  
...
### <a name="remarks"></a>설명  
 이 기능을 사용 하도록 설정 하면 사용자가 alt 키 또는 F10 단추를 누를 때 키 팁 표시 됩니다. 사용자가 ALT 키를 누르면 200 밀리초의 지연이 키 팁 표시 됩니다. ALT 키를 포함 하는 다른 조합 ALT 키 누름된 간섭 하지 않도록의 바로 가기에 대 한이 지연 수 있습니다.  
...
##  <a name="enabletooltips"></a>CMFCRibbonBar::EnableToolTips  
 도구 설명 및 리본 표시줄의 선택적 도구 설명 설명을 사용할지 설정 합니다.  
...
### <a name="return-value"></a>반환 값  
 가 지정 된 데이터 및 표시;에 있는 경우 리본 요소에 대 한 포인터 그렇지 않으면 `NULL`합니다.  
  
### <a name="remarks"></a>설명  
 리본 요소에는 리본 메뉴 단추 또는 리본 범주 또는 리본 슬라이더와 같은 리본 메뉴에 추가할 수 있는 모든 컨트롤입니다.  
...
### <a name="return-value"></a>반환 값  
 지정한 명령 ID와 검색 값이 있으면 리본 요소에 대 한 포인터 그렇지 않으면 `NULL`합니다.  
  
### <a name="remarks"></a>설명  
 리본 요소에는 리본 메뉴 단추 또는 리본 범주 또는 리본 슬라이더와 같은 리본 메뉴에 추가할 수 있는 모든 리본 컨트롤입니다.  
  
 일반적으로 있을 수 있습니다 둘 이상의 가진 리본 요소를 동일한 명령 id입니다. 사용 하 여, 지정 된 명령 ID를 사용 하는 모든 리본 요소에 대 한 포인터를 가져오는 경우는 [CMFCRibbonBar::GetElementsByID](#getelementsbyid) 메서드.  
...
##  <a name="forcerecalclayout"></a>CMFCRibbonBar::ForceRecalcLayout  
 레이아웃 다시 그리기 횟수, 부모 창 및 리본 표시줄에서 모든 항목을 조정 전체 창.  
...
### <a name="return-value"></a>반환 값  
 활성화 된 리본 범주;에 대 한 포인터 또는 `NULL` 범주가 없는 실행 중인 경우.  
  
### <a name="remarks"></a>설명  
 범주는 포커스가 있을 경우 활성화 됩니다. 기본적으로 활성 범주에는 리본 표시줄의 왼쪽에서 첫 번째 범주가입니다.  
  
 기본 범주의 활성 범주 될 수 없습니다 및 사용자가 응용 프로그램 단추를 누를 때 표시 됩니다.  
...
### <a name="return-value"></a>반환 값  
 응용 프로그램 단추;에 대 한 포인터 또는 `NULL` 단추가 설정 되어 있지 않으면입니다.  
...
### <a name="return-value"></a>반환 값  
 현재 드롭다운; 리본 요소 또는 `NULL` 리본 요소가 현재 드롭다운 하는 경우.  
  
### <a name="remarks"></a>설명  
  
##  <a name="getelementsbyid"></a>CMFCRibbonBar::GetElementsByID  
 특정 명령 ID가 지정 되며 모든 리본 요소에 대 한 포인터의 배열을 검색합니다  
...
### <a name="remarks"></a>설명  
 빠른 실행 도구 모음에 일부 리본 요소를 복사 될 수 있으므로 여러 리본 요소에서 동일한 명령 ID를 있을 수 있습니다.  
  
##  <a name="gethideflags"></a>CMFCRibbonBar::GetHideFlags  
 리본 표시줄에 표시 되는 여부를 나타내는 플래그를 검색 합니다.  
...
### <a name="return-value"></a>반환 값  
 리본 표시줄에 표시 되는 여부를 나타내는 플래그입니다.  
  
### <a name="remarks"></a>설명  
 다음 표에서 반환 값에 대 한 플래그의 가능한 조합을 나열합니다.  
  
 `AFX_RIBBONBAR_HIDE_ELEMENTS`  
 리본 표시줄 세로로 최소화 하 고 범주 탭, 기본 단추 및 빠른 실행 도구 모음 표시 됩니다.  
  
 `AFX_RIBBONBAR_HIDE_ALL`  
 리본 표시줄의 너비 최소 너비 보다 작으면와 완전히 숨겨집니다.  
  
##  <a name="getitemidslist"></a>CMFCRibbonBar::GetItemIDsList  
 리본 표시줄에서 리본 요소의 지정 된 컬렉션에 대 한 명령 Id를 검색합니다.  
...
##  <a name="getkeyboardnavigationlevel"></a>CMFCRibbonBar::GetKeyboardNavigationLevel  
 사용자가 리본 표시줄에 포함 된 키 팁을 누를 때 현재 탐색 수준을 검색 합니다.  
...
### <a name="return-value"></a>반환 값  
 사용자와 현재 탐색 수준 리본 표시줄에 포함 된 키 팁을 누릅니다. 다음 표에서 가능한 반환 값을 보여 줍니다.  
...
### <a name="return-value"></a>반환 값  
 리본 표시줄의; 현재 키보드 탐색 개체 그렇지 않으면 `NULL` 개체가 현재 키 팁을 표시 하는 경우.  
  
### <a name="remarks"></a>설명  
 현재 키 팁에 표시 되는 개체는 현재 키보드 탐색 개체가입니다.  
...
### <a name="return-value"></a>반환 값  
 리본 표시줄;에 있는 부모 키보드 탐색 개체 그렇지 않으면 `NULL`합니다.  
  
### <a name="remarks"></a>설명  
 리본 표시줄에 keytip를 누를 때 현재 키보드 탐색 개체의 부모 키보드 탐색 개체가 됩니다.  
...
##  <a name="getqatcommandslocation"></a>CMFCRibbonBar::GetQATCommandsLocation  
 빠른 실행 도구 모음 명령에 대 한 표시 사각형을 검색합니다.  
...
### <a name="remarks"></a>설명  
 표시 사각형 commands 섹션에서는 사용자 지정 단추를 사용 하는 포함 되지 않습니다.  
  
##  <a name="getqatdroppeddown"></a>CMFCRibbonBar::GetQATDroppedDown  
 해당 팝업에 드롭다운 메뉴에 있는 빠른 실행 도구 모음에서 리본 요소에 대 한 포인터를 검색 합니다.  
...
### <a name="return-value"></a>반환 값  
 해당 팝업에 드롭다운 메뉴에 있는 빠른 실행 도구 모음에서 리본 요소에 대 한 포인터입니다.  
  
### <a name="remarks"></a>설명  
  
##  <a name="getquickaccesscommands"></a>CMFCRibbonBar::GetQuickAccessCommands  
 빠른 실행 도구 모음에서 리본 요소에 대 한 명령 Id의 목록을 검색합니다.  
...
### <a name="remarks"></a>설명  
 리본 표시줄의 너비가 충분 하지 않으면 범주 탭 너비에서 감소 됩니다.  
...
### <a name="remarks"></a>설명  
 컨텍스트 범주 활성 상태 이면 활성 범주 범주 목록에서 첫 번째 표시 범주를 다시 설정 됩니다.  
  
##  <a name="hidekeytips"></a>CMFCRibbonBar::HideKeyTips  
 리본 표시줄의 모든 키 팁을 숨깁니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`키 팁이 기능을 사용 하는 경우 그렇지 않으면 `FALSE`합니다.  
...
### <a name="remarks"></a>설명  
 기본적으로이 메서드는 항상 반환 `TRUE`합니다. 리본 표시줄 기본 리본 표시줄 인지 여부를 나타내는이 메서드를 재정의 합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`경우는 **인쇄 미리 보기** 기능이 활성화 되지 않았으면 `FALSE`합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`빠른 실행 도구 모음 명령 단추; 포함 된 경우 그렇지 않으면 `FALSE`합니다.  
...
##  <a name="isreplaceframecaption"></a>CMFCRibbonBar::IsReplaceFrameCaption  
 리본 표시줄 대체 주 프레임 창의 캡션을 아래 하는지 여부를 나타냅니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`리본 표시줄이 주 프레임 창의 캡션을 대체 하는 경우 `FALSE` 리본 표시줄이 주 프레임 창의 캡션을 사용 중인 경우.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`도구 설명이 설명을 사용 하면 `FALSE` 설명이 도구 설명 사용 하지 않도록 설정 됩니다.  
  
### <a name="remarks"></a>설명  
 도구 설명 설명은 추가 설명이 도구 설명 텍스트와 함께 표시 됩니다.  
  
##  <a name="istooltipenabled"></a>CMFCRibbonBar::IsToolTipEnabled  
 리본 표시줄에 대 한 도구 설명을 사용 하도록 설정 된 여부를 나타냅니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`Windows Aero; 색 구성표의 경우 그렇지 않으면 `FALSE`합니다.  
  
### <a name="remarks"></a>설명  
  
##  <a name="onclickbutton"></a>CMFCRibbonBar::OnClickButton  
 이 메서드는 기존 응용 프로그램과 함께 이전 버전과 호환성을 위해서만 하며 새로운 개발에 사용할 수 없습니다.  
...
### <a name="remarks"></a>설명  
 이 메서드는 새 레이아웃 방향에 대 한 리본 표시줄에 있는 모든 컨트롤의 레이아웃을 조정합니다.  
...
##  <a name="onsyskeydown"></a>CMFCRibbonBar::OnSysKeyDown  
 F10 키 또는 ALT 키를 누르고 클릭 하 고 다음 다른 키를 누를 때 프레임 워크에서 호출 합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`키 입력 이벤트 처리 되었으면 그렇지 않으면 `FALSE`합니다.  
...
##  <a name="pretranslatemessage"></a>CMFCRibbonBar::PreTranslateMessage  
 리본 표시줄 지정 된 메시지를 처리 하는 경우를 결정 합니다.  
...
### <a name="remarks"></a>설명  
 이 메서드는 메모리에서 및 범주 목록에서 모든 리본 범주를 삭제합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`지정된 된 리본 범주를 삭제 했으면; 그렇지 않으면 `FALSE`합니다.  
  
### <a name="remarks"></a>설명  
 지정된 된 리본 범주 및 범주 목록 메모리에서 삭제 됩니다.  
  
##  <a name="setactivecategory"></a>CMFCRibbonBar::SetActiveCategory  
 활성 범주와 지정된 된 리본 범주를 설정합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`지정된 된 범주 활성 범주;으로 설정 된 경우 그렇지 않으면 `FALSE`합니다.  
...
##  <a name="setelementkeys"></a>CMFCRibbonBar::SetElementKeys  
 지정한 명령 ID가 지정 되며 모든 리본 요소에 대 한 키 팁을 설정 합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`하나 이상의 리본 요소의 키 팁을 설정한 경우 그렇지 않으면 `FALSE`합니다.  
  
### <a name="remarks"></a>설명  
 팝업 메뉴를 열고 분할 단추를 사용 하 여 리본 요소에 대 한 선택적 메뉴 keytip을 합니다.  
  
##  <a name="setkeyboardnavigationlevel"></a>CMFCRibbonBar::SetKeyboardNavigationLevel  
 설정 사용자와 키보드 탐색 수준 리본 표시줄에 포함 된 키 팁을 누릅니다.  
...
### <a name="remarks"></a>설명  
 리본 표시줄의 키보드 탐색에는 사용자가 alt 키 또는 F10 키를 누를 때 시작 됩니다. 사용자가 리본 표시줄에는 keytip을 눌러 다음 탐색 수준을 선택 합니다. 사용자는 esc 키를 눌러 이전 탐색 수준으로 반환할 수 있습니다.  
  
##  <a name="setmaximizemode"></a>CMFCRibbonBar::SetMaximizeMode  
 리본 표시줄 때 다중 문서 MDI (인터페이스) 자식 창의 창 크기에 들어가거나 최대화 된 상태로 조정 합니다.  
...
### <a name="remarks"></a>설명  
 리본 표시줄 MDI 자식 창이 최대화 되었을 때 탭 행의 MDI 자식 창에 대 한 시스템 단추를 표시 합니다.  
...
##  <a name="setquickaccesstoolbarontop"></a>CMFCRibbonBar::SetQuickAccessToolbarOnTop  
 리본 표시줄 보다 높거나 낮은 빠른 실행 도구 모음을 배치합니다.  
...
### <a name="remarks"></a>설명  
 변경 하려면 해당 너비를 하면 매개 변수를 0으로 설정 합니다.  
...
##  <a name="showkeytips"></a>CMFCRibbonBar::ShowKeyTips  
 리본 표시줄에서 리본 요소에 대 한 키 팁을 표시합니다.  
...
##  <a name="translatechar"></a>CMFCRibbonBar::TranslateChar  
 리본 표시줄에서 지정 된 키 입력 문자 코드 처리 여부를 결정 합니다.  
...
### <a name="remarks"></a>설명  
 키 팁 기능에는 사용자가 키보드를 사용 하 여 리본 표시줄을 탐색할 수 있습니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`리본 메뉴에 Windows 7; 확인 하는 경우 그렇지 않으면 `FALSE`합니다.  
...
### <a name="return-value"></a>반환 값  
 `TRUE`로드가 성공 하면 그렇지 않으면 `FALSE`합니다.  
...
##  <a name="setwindows7look"></a>CMFCRibbonBar::SetWindows7Look  
 리본 메뉴에 대 한 Windows 7 모양 (작은 사각형 응용 프로그램 단추)를 사용 하지 않도록 설정 하거나 사용 합니다.  
