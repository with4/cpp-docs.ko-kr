...
helpviewer_keywords: 
  ...
  - "대화 상자[C++], Windows common dialogs"
  - "dialog classes [C++], common"
  - "MFC 대화 상자, Windows common dialogs"
...
Windows 공용 대화 상자 기능을 캡슐화 하는 클래스에 대 한 기본 클래스입니다.  
...
|Name|설명|  
|----------|--------|  
|[CCommonDialog::CCommonDialog](../Topic/CCommonDialog::CCommonDialog.md)|`CCommonDialog` 개체를 생성합니다.|  
  
## 설명  
 다음 클래스의 Windows 공용 대화 상자 기능을 캡슐화 합니다.  
