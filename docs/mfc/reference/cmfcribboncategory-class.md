...
### <a name="parameters"></a>매개 변수  
 [in] *pParenrRibbonBar*  
 리본 범주에 있는 부모 리본 표시줄에 대 한 포인터입니다.  
  
 [in] *lpszName*  
 리본 범주의 이름입니다.  
  
 [in] *uiSmallImagesResID*  
 이미지 목록의 리본 범주의 리본 요소에 의해 사용 되는 작은 이미지에 대 한 리소스 ID입니다.  
  
 [in] *uiLargeImagesResID*  
 이미지 목록의 리본 범주의 리본 요소에 의해 사용 되는 큰 이미지에 대 한 리소스 ID입니다.  
  
 [in] *sizeSmallImage*  
 기본 리본 범주의 리본 요소에 대 한 작은 이미지의 크기입니다.  
  
 [in] *sizeLargeImage*  
 기본 리본 범주의 리본 요소에 대 한 큰 이미지의 크기입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bVisibleOnly*  
 검색에 대 한 빠른 액세스 리본 요소를 포함 하려면 TRUE 검색에 대 한 빠른 액세스 리본 요소를 제외 하려면 FALSE입니다.  
...
### <a name="parameters"></a>매개 변수  
 [out에서] *arElements*  
 에 대 한 참조를 [CArray](../../mfc/reference/carray-class.md) 리본 요소입니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *bIsLargeImage*  
 큰 이미지 목록의 이미지 개수에 대해 TRUE 작은 이미지 목록의 이미지 개수를 FALSE로 설정 합니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *bIsLargeImage*  
 큰 이미지의 크기에 대해 TRUE 작은 이미지의 크기에 대 한 FALSE입니다.  
...
### <a name="parameters"></a>매개 변수  
 [out] *lstItems*  
 리본 범주에 있는 리본 요소에 대 한 명령 Id의 목록입니다.  
  
 [in] *bHiddenOnly*  
 리본 범주의; 리본 패널에 표시 되는 리본 요소를 제외. 리본 범주에서 모든 리본 요소를 포함 하려면 FALSE입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 리본 패널 캡션이;를 테스트. 리본 패널 캡션이 제외 하려면 FALSE입니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *bAccelerator*  
 그렇지 않은 경우 액셀러레이터 또는 FALSE에서 시작 하는 경우 TRUE 명령입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 [in] *bIsLargeImage*  
 이미지의 크기가 큰; 경우 TRUE 이미지의 크기가 작은 경우에 FALSE입니다.  
  
 [in] *nImageIndex*  
 리본 범주에 포함 된 이미지 배열에 있는 이미지의 0부터 시작 인덱스입니다.  
  
 [in] *bCenter*  
 가운데에 이미지의 표시 사각형을; TRUE False 이면 표시 사각형의 왼쪽 위 모퉁이에서 이미지를 그립니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *bScrollLeft*  
 TRUE는 왼쪽으로 스크롤 False 이면 오른쪽으로 스크롤합니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *pCmdUI*  
 에 대 한 포인터를 `CMFCRibbonCmdUI` 사용자 인터페이스 요소가 사용 하도록 설정 하 고 사용할 수 없게 하는 지정 하는 개체입니다.  
  
 [in] *pTarget*  
 제어를 사용 하도록 설정 또는 사용자 인터페이스 요소를 사용 하지 않도록 설정 하는 창에 대 한 포인터입니다.  
...
### <a name="parameters"></a>매개 변수  
 [in] *nIndex*  
 제거할 패널의 인덱스 번호입니다. 호출 하 여 가져올는 [CMFCRibbonCategory::GetPanelIndex](#getpanelindex) 메서드.  
  
 [in] *b 삭제*  
 메모리에서 패널 개체를 삭제 하려면 TRUE 삭제 하지 않고 패널 개체를 제거 하려면 FALSE입니다.  
