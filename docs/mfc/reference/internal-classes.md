...
|`CFrameImpl Class`|`CFrameImpl` 다음 프레임 창 클래스에 대 한 도구 모음 사용자 지정을 처리 하는 클래스: [CFrameWndEx 클래스](../../mfc/reference/cframewndex-class.md), [CMDIFrameWndEx 클래스](../../mfc/reference/cmdiframewndex-class.md), 및 [COleIPFrameWndEx클래스](../../mfc/reference/coleipframewndex-class.md).|  
|`CFullScreenImpl Class`|SDI 및 MDI 응용 프로그램에 공통 구현 전체 화면 기능|  
|`CMDIClientAreaWnd Class`|`CMDIClientAreaWnd` 클래스는 MDI 탭과 MDI 탭 그룹의 구현을 단순화 하는 도우미 클래스입니다.|  
|`CMemDC Class`|메모리 장치 컨텍스트에 대 한 도우미 클래스입니다. 메모리 디바이스 컨텍스트 스크린 그림을 지원합니다.|  
|`CMenuHash Class`|상태를 읽는 `CMFCToolBar` 보관에서 개체 또는 상태 보관 파일에 씁니다.|  
|`CMenuImages Class`|닫기 단추와 같은 미리 정의 된 이미지를 표시, 단추, 라디오 단추 및 화살표를 최대화 하는 기능을 제공 합니다.|  
|`CMFCCaptionButtonEx Class`|시스템 캡션 단추의 비클라이언트 영역을 보유합니다.|  
|`CMFCCaptionMenuButton Class`|캡션 영역의 작업 창 또는 도구 모음에 있는 메뉴 단추를 나타냅니다.|  
|`CMFCColorPropertySheet Class`|사용 하는 [CMFCColorDialog 클래스](../../mfc/reference/cmfccolordialog-class.md) 에 구성 된 대화 상자를 제공 합니다.|  
|`CMFCControlBarImpl Class`|구현 세부 정보 등의 컨트롤 막대 기반 클래스를 제공 `CMFCReBar` 및 `CMFCToolBar`합니다.|  
...
|`CMFCCustomizeButton Class`|메뉴 명령 또는 사용자 지정 대화 상자를 시작 하는 도구 모음 단추가 지원 합니다.|  
|`CMFCCustomizeMenuButton Class`|사용자 지정 메뉴에서 한 번의 단추를 나타냅니다.|  
|`CMFCDropDownListBox Class`|리본 콤보 상자 드롭다운 목록 상자 기능을 제공 합니다.|  
|`CMFCMousePropertyPage Class`|사용자가 마우스 동작을 사용자 지정할 수 있도록 속성 페이지.|  
...
|`CMFCOutlookBarScrollButton Class`|스크롤 기능을 제공 된 `CMFCOutlookBarTabCtrl` 클래스입니다.|  
|`CMFCOutlookBarToolBar Class`|Outlook 2003 비주얼 스타일이 적용 된 도구 모음을 구현 합니다.|  
|`CMFCPropertySheetCategoryInfo Class`|트리 컨트롤의 노드를 나타냅니다.|  
|`CMFCPropertySheetTabCtrl Class`|확장 된 `CMFCTabCtrl` 속성 시트 기능을 제공 하는 클래스입니다.|  
|`CMFCProperySheetListBox Class`|확장 된 `CListBox` 속성 시트 기능을 제공 하는 클래스입니다.|  
|`CMFCReBarState Class`||  
|`CMFCRibbonCaptionButton Class`|시스템 캡션 단추를 구현합니다.|  
|`CMFCRibbonCmdUI Class`|업데이트 응용 프로그램이 유휴 상태일 때 필요에 따라 개체 모음 리본입니다.|  
|`CMFCRibbonCommandsListBox Class`||  
|`CMFCRibbonDefaultPanelButton Class`||  
|`CMFCRibbonGalleryIcon Class`|항목을 나타내며는 `CMFCRibbonGallery` 개체입니다.|  
|`CMFCRibbonKeyboardCustomizeDialog Class`|리본 메뉴 모음을 포함 하는 응용 프로그램에 대 한 키보드 사용자 지정 대화 상자를 구현 합니다.|  
|`CMFCRibbonKeyTip Class`|리본 표시줄에 대 한 키 팁을 표시 하는 팝업 창을 구현 합니다.|  
|`CMFCRibbonPanelMenu Class`||  
|`CMFCRibbonPanelMenuBar Class`|리본 표시줄에 팝업 메뉴 표시줄을 나타냅니다.|  
|`CMFCRibbonQuickAccessToolBar Class`|리본 요소에 대 한 빠른 실행 도구 모음을 구현합니다.|  
|`CMFCRibbonRichEditCtrl Class`|리본 표시줄에 있는 편집 컨트롤을 구현 합니다.|  
|`CMFCRibbonTab Class`|리본 표시줄에 있는 탭을 나타냅니다.|  
|`CMFCShadowRenderer Class`||  
|`CMFCShowAllButton Class`|확장 하 여 숨겨진된 명령을 표시 하는 팝업 메뉴의 맨 아래에 있는 단추를 나타냅니다.|  
|`CMFCStatusBarPaneInfo Class`|내용 및 모양을 설명는 `CMFCStatusBar` 창.|  
|`CMFCTabButton Class`|탭 컨트롤에 탭 단추 기능을 제공합니다.|  
|`CMFCTabInfo Class`|탭 컨트롤에 대 한 정보를 제공합니다.|  
|`CMFCTasksPaneFrameWnd Class`|작업 창 사용자 지정 캡션 단추를 관리합니다.|  
|`CMFCTasksPanePropertyPage Class`|간의 관계를 관리 하는 `CMFCTasksPane` 개체와 이름입니다.|  
|`CMFCTasksPaneToolBar Class`|위쪽에 있는 탐색 도구 모음을 구현 하는 `CMFCTasksPane` 개체입니다.|  
|`CMFCToolBarButtonsListButton Class`|사용자 지정 하는 동안 사용자가 선택할 수 있는 이미지의 목록을 표시는 **단추 모양을** 대화 상자.|  
...
|`CMFCToolBarDropTarget Class`|위한 놓기 대상 구현 `CMFCToolBar` 개체입니다.|  
|`CMFCToolBarEditCtrl Class`|편집 컨트롤 기능을 제공 `CMFCToolBarEditBoxButton` 개체입니다.|  
|`CMFCToolBarMenuButtonsButton Class`|메뉴 표시줄의 오른쪽에 있는 시스템 캡션 단추를 나타냅니다.|  
...
|`CMFCToolBarsListCheckBox Class`|도구 모음 목록에 표시 됩니다는 **도구 모음** 의 페이지는 **사용자 지정** 대화 상자.|  
|`CMFCToolBarsListPropertyPage Class`|목록에서 도구 모음으로 표시 하는 속성 페이지를 나타냅니다는 **사용자 지정** 대화 상자.|  
|`CMFCToolBarsMenuPropertyPage Class`|메뉴 사용자 지정 옵션을 포함 하는 속성 페이지를 나타냅니다는 **사용자 지정** 대화 상자.|  
|`CMFCToolBarsOptionsPropertyPage Class`|나타냅니다는 **옵션** 페이지에 **사용자 지정** 대화 상자.|  
|`CMFCToolBarSpinEditBoxButton Class`|편집 상자에 있는 스핀 단추를 나타냅니다.|  
|`CMFCToolBarsToolsPropertyPage Class`|사용자가 사용자 도구를 사용자 지정할 수 있게 하는 속성 페이지를 나타냅니다.|  
|`CMFCToolBarSystemMenuButton Class`|프레임 워크는 MDI 자식 창을 최대화 하는 사용자 때 주 메뉴 모음에 추가 하는 시스템 캡션 단추를 구현 합니다.|  
|`CMFCVisualManagerBitmapCache Class`|관리 `CMFCControlRenderer` 비트맵에 대 한 작업의 성능을 향상 시킬 개체입니다.|  
|`CMultiDocTemplateEx Class`|확장 된 `CMultiDocTemplate` 메뉴 리소스 ID에 대 한 액세스를 제공 하기 위해 클래스|  
|`COleCntrFrameWndEx Class`||  
|`COleDocIPFrameWndEx Class`|OLE 지원을 합니다.|  
...
|`CRecentPaneContainerInfo Class`|도킹 창의 이전 상태를 보유합니다.|  
|`CRibbonCategoryScroll Class`|리본 표시줄의 영역에 맞지 않는 모든 요소 하지 않는 경우 표시 되는 스크롤 단추를 구현 합니다.|  
|`CSmartDockingGroupGuide Class`|스마트 도킹 그룹의 중앙 요소를 나타냅니다.|  
|`CSmartDockingGroupGuidesManager Class`|스마트 도킹 그룹 안내선을 관리합니다.|  
|`CSmartDockingGroupGuidesWnd Class`|프레임 워크 사용 지침 스마트 도킹의 중앙 그룹을 표시 하는 계층화 된, 사각형이 아닌 창을 구현 합니다.|  
|`CSmartDockingHighlighterWnd Class`|도킹 되는 도킹 가능한 창 개체에서 수행 하는 영역을 자세히 다루는 반투명 창을 구현 합니다.|  
|`CSmartDockingManager Class`|스마트 도킹 기능을 제공 `CDockingManager` 개체입니다.|  
|`CSmartDockingStandaloneGuide Class`|스마트 도킹 가이드를 구현합니다.|  
|`CSmartDockingStandaloneGuideWnd Class`|스마트 도킹 지침을 표시 하는 프레임 워크를 사용 하는 계층화 된, 사각형이 아닌 창을 구현 합니다.|  
|`CTagManager Class`|`CTagManager` XML 태그가 지정 된 형식으로 저장 된 값을 읽는 데 사용 합니다.|  
|`CVSListBoxBase Class`|기본 기능을 제공 된 `CVSListBox` 클래스입니다.|  
|`CVSListBoxEditCtrl Class`|대화 상자를 여는 작은 단추가 표시 하 여 표준 목록 상자 편집 컨트롤을 확장 합니다.|  
|`CVSToolsListBox Class`|추가, 삭제 및 목록 상자에서 항목을 이동 하기 위한 추가 단추를 제공 하 여 표준 목록 상자 컨트롤을 확장 합니다.|  
