...
This article explains how to make type\-safe collections for your own data types.  다음 내용을 다룹니다.  
...
1.  Declare a variable of the collection class type.  예를 들면 다음과 같습니다.  
  
     [!code-cpp[NVC_MFCCollections#7](../mfc/codesnippet/CPP/how-to-make-a-type-safe-collection_1.cpp)]  
  
2.  Call the member functions of the collection object.  예를 들면 다음과 같습니다.  
  
     [!code-cpp[NVC_MFCCollections#8](../mfc/codesnippet/CPP/how-to-make-a-type-safe-collection_2.cpp)]  
  
3.  If necessary, implement the [helper functions](../mfc/reference/collection-class-helpers.md) and [SerializeElements](../Topic/SerializeElements.md).  For information on implementing these functions, see [Implementing Helper Functions](#_core_implementing_helper_functions).  
