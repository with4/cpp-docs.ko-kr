...
-   **\/D\_WINDLL** signifies the compilation is for a DLL  
  
-   **\/D\_USRDLL** specifies you are building a regular DLL  
...
-   **\/D\_AFXDLL** specifies that you are building a regular DLL that dynamically links to MFC  
...
## WinMain \-\> DllMain  
 The MFC library defines the standard Win32 `DllMain` entry point that initializes your [CWinApp](../mfc/reference/cwinapp-class.md) derived object as in a typical MFC application.  Place all DLL\-specific initialization in the [InitInstance](../Topic/CWinApp::InitInstance.md) method as in a typical MFC application.  
