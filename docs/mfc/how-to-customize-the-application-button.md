...
When you click the Application button, a menu of commands is displayed.  Typically, the menu contains file\-related commands such as **Open**, **Save**, **Print**, and **Exit**.  
 ...
 ![MFC 리본 응용 프로그램 단추](../mfc/media/application_button.png "Application\_Button")  
...
|Property|정의|  
|--------------|--------|  
|**단추**|Contains the collection of up to three buttons that appear in the bottom\-right corner of the Application menu.|  
...
|**키**|Specifies the string that is displayed when key\-tip navigation is enabled.  Key\-tip navigation is enabled when you press ALT.|  
...
|**기능**|Enables or disables the Recent List panel.  The Recent List panel appears on the Application menu.|  
|**너비**|Specifies the width in pixels of the Recent List panel.|  
