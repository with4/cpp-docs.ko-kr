---
title: "ActiveX 컨트롤 컨테이너: ActiveX 컨트롤에서 보낸 이벤트 처리 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "ActiveX 컨트롤 컨테이너[C++], 이벤트 싱크"
  - "ActiveX 컨트롤[C++], 이벤트"
  - "BEGIN_EVENTSINK_MAP 매크로"
  - "END_EVENTSINK_MAP 매크로, using"
  - "이벤트 처리기[C++], ActiveX 컨트롤"
  - "이벤트 처리[C++], ActiveX 컨트롤"
  - "이벤트[C++], ActiveX 컨트롤"
  - "ON_EVENT 매크로"
