---
title: "TN016: MFC에서 C++ 다중 상속 사용 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
## CRuntimeClass  
 ...
 An alternative is to use the `dynamic_cast` operator.  Casting an object with MI to one of its base classes will force the compiler to use the functions in the supplied base class.  자세한 내용은 [dynamic\_cast 연산자](../cpp/dynamic-cast-operator.md)을 참조하십시오.  
