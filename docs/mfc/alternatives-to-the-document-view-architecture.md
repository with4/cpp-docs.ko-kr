...
-   MFC 응용 프로그램 마법사에서 제공 하는, 응용 프로그램에 대 한 메뉴만 포함 되어 **새로** 및 **종료** 에 있는 명령을 **파일** 메뉴. (의 **새로** 문서/뷰 없이 SDI 응용 프로그램이 아닌 지원, 명령은 MDI 응용 프로그램에만 지원 됩니다.) 생성된 메뉴 리소스는 MRU(가장 최근에 사용됨) 목록을 지원하지 않습니다.  
