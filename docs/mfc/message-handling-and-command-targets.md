...
-   개체를 개체의 도구 모음은 일반적으로 표시 하 고 같은 컨테이너 명령 중 일부에 대 한 개체의 도구 모음 단추가 되어 활성화 될 때 **인쇄**, **인쇄 미리 보기**,  **저장**, **새로**, **확대/축소**, 등입니다. (개체를 제거 하는 표준 권장 되는 내부 활성화에서 또는 도구 모음에서 이러한 단추 적어도 비활성화 합니다. 이 디자인에서는 해당 명령을 활성화 하 고 적절 한 처리기를 아직 라우팅할 수 있습니다.) 현재 컨테이너에 이러한 명령을 디스패치 개체에 대 한 장치가 있습니다.  
