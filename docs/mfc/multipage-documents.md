...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CPrintInfo 구조체, 다중 페이지 문서"
  - "문서 페이지와 프린터 페이지 비교"
  - "문서, 페이지 매김"
  - "문서, 인쇄"
  - "DoPreparePrinting 메서드 및 페이지 매김"
  - "다중 페이지 문서"
  - "OnBeginPrinting 메서드"
  - "OnDraw 메서드, 인쇄"
  - "OnEndPrinting 메서드"
  - "OnPrepareDC 메서드"
  - "OnPreparePrinting 메서드"
  - "OnPrint 메서드"
  - "재정의, 인쇄를 위한 뷰 클래스 함수"
  - "페이지, 인쇄"
  - "페이지 매김"
...
|[OnEndPrinting](../Topic/CView::OnEndPrinting.md)|To deallocate GDI resources|  
 ...
 ![루프 프로세스 인쇄](../mfc/media/vc37c71.png "vc37C71")  
인쇄 루프  
  
##  <a name="_core_pagination"></a> 페이지 매기기  
