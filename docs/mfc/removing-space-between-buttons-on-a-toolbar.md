...
다음 절차에서는 도구 모음에 있는 단추 사이의 공백을 제거하는 방법을 보여 줍니다.  
  
### 도구 모음에서 단추 사이의 공백을 제거하려면  
  
1.  공백의 한 쪽에 있는 단추가 다음 단추와 반쯤 겹쳐질 때까지 공백의 다른 쪽에 있는 단추로 끌어 옵니다.  
  
     끌어 오는 단추 쪽에 공백이 없고 다음 단추와 반 이상 겹쳐지도록 끌어 오면 도구 모음 편집기에서 끌어 오는 단추의 반대 쪽에도 공백을 삽입합니다.  
