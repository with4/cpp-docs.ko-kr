---
title: "CLS 규격 경고 CLS01203 | Microsoft Docs"
ms.custom: ""
ms.date: "10/29/2016"
...
---
# CLS 규격 경고 CLS01203
형식과 멤버의 표시 유형 및 접근성은 해당 멤버가 표시되고 액세스 가능한 경우 모든 멤버의 시그니처에 있는 해당 형식이 표시되고 액세스 가능해야 합니다. 예를 들어 해당 어셈블리 외부에 표시되는 공용 필드는 어셈블리 내부에서만 표시되는 형식일 수 없습니다.  
  
 형식과 멤버의 표시 유형 및 접근성은 해당 멤버가 표시되고 액세스 가능한 경우 모든 멤버의 시그니처에 있는 해당 형식이 표시되고 액세스 가능해야 합니다. 예를 들어 해당 어셈블리 외부에 표시되는 공용 필드는 어셈블리 내부에서만 표시되는 형식일 수 없습니다.  
  
 CLS 규격 검사에 대한 자세한 내용은 [CLS 규격 어셈블리](http://msdn.microsoft.com/ko-kr/3320b57e-ea55-4697-a17d-f509a36a3c93)를 참조하세요.  
  
 다음 샘플에서는 CLS01203을 생성합니다.  
