---
title: "MSBuild 오류 MSB3142 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
---
# MSBuild 오류 MSB3142
**MSB3142: '\<file\>'을\(를\) '\<folder\>'\(으\)로 복사하는 동안 오류가 발생했습니다. '\<error\>'**  
  
 이 오류는 setup.bin을 빌드 출력 디렉터리로 복사할 때 발생합니다.  이 오류가 발생하는 원인은 다음과 같습니다.  
  
-   출력 디렉터리에 복사하는 데 필요한 권한이 없습니다.  
