...
정품 및 디버그 UCRT DLL은 별도의 위치에 있습니다. 정품 DLL은 재배포 가능하고 Windows Kits\\10\\Redist\\ucrt\\DLLs\\_architecture_ 아래 Program Files 또는 Program Files (x86) 디렉터리에서 찾을 수 있습니다\. 디버그 UCRT 라이브러리는 재배포 가능하지 않고 Windows Kits\\10\\bin\\_architecture_\\ucrt 폴더 아래 Program Files 또는 Program Files (x86) 디렉터리에서 찾을 수 있습니다.   
