...
ms.locfileid: "33094158"
---
# <a name="blobentrylengthstatus"></a>BLOB_ENTRY_LENGTH_STATUS
함께 사용할 `BEGIN_COLUMN_MAP` 및 `END_COLUMN_MAP` binary large object 바인딩할 ([BLOB](https://msdn.microsoft.com/en-us/library/ms711511.aspx)). 비슷한 [BLOB_ENTRY](../../data/oledb/blob-entry.md)제외 하 고이 매크로 길이 및 BLOB 열의 상태에도 가져옵니다.  
