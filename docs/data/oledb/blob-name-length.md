...
ms.locfileid: "33092062"
---
# <a name="blobnamelength"></a>BLOB_NAME_LENGTH
함께 사용할 `BEGIN_COLUMN_MAP` 및 `END_COLUMN_MAP` binary large object 바인딩할 ([BLOB](https://msdn.microsoft.com/en-us/library/ms711511.aspx)). 비슷한 [BLOB_NAME](../../data/oledb/blob-name.md)제외 하 고이 매크로 BLOB 데이터 열의 바이트 길이 가져옵니다.  
