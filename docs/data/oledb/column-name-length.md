...
Represents a binding on the rowset to the specific column in the rowset.  Similar to [COLUMN\_NAME](../../data/oledb/column-name.md), except that this macro also takes column length.  
