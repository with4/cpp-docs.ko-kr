...
ms.locfileid: "33101629"
---
# <a name="ctranslations-ctranslationinfo"></a>CTranslations, CTranslationInfo
Typedef 클래스 호출 **CTranslations** 해당 매개 변수 클래스를 구현 하려면 **CTranslationInfo**합니다.  
...
## <a name="remarks"></a>설명  
 ...
 다음 표에는 클래스 데이터 멤버 및 해당 OLE DB 열이 나열됩니다. 참조 [번역 행 집합](https://msdn.microsoft.com/en-us/library/ms725365.aspx) 에 *OLE DB Programmer's Reference* 스키마 및 열에 대 한 자세한 내용은 합니다.  
