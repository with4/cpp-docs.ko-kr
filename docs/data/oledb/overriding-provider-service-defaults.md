...
ms.locfileid: "39337020"
---
# <a name="overriding-provider-service-defaults"></a>공급자 서비스 기본값 재정의
OLEDB_SERVICES에 대 한 공급자의 레지스트리 값에 대 한 기본 값으로 반환 됩니다 합니다 [DBPROP_INIT_OLEDBSERVICES](https://msdn.microsoft.com/library/ms716898.aspx) 데이터 원본 개체의 초기화 속성입니다.  
...
## <a name="see-also"></a>참고 항목  
 [리소스 풀링](https://msdn.microsoft.com/library/ms713655.aspx)   
 [리소스 풀링을 소비자를 사용 하는 방법](https://msdn.microsoft.com/library/ms715907.aspx)   
 [공급자를 사용 방법을 효과적으로 리소스 풀링](https://msdn.microsoft.com/library/ms714906.aspx)   
