...
[DynamicConsumer](https://github.com/Microsoft/VCSamples/tree/master/VC2008Samples/ATL/OLEDB/Consumer/DynamicConsumer) 샘플에서는 동적 접근자 클래스 열 정보를 얻고 동적 접근자를 만들기를 사용 하는 방법을 보여 줍니다.
