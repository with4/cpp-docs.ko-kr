...
2.  에 대 한 포인터를 가져올는 [CComboBox](../mfc/reference/ccombobox-class.md) 콤보 상자 컨트롤에 대 한 개체입니다.  
  
3.  콤보 상자에서 이전 콘텐츠를 비웁니다.  
  
4.  레코드 집합에서 모든 레코드를 탐색 호출 [ccombobox:: Addstring](../mfc/reference/ccombobox-class.md#addstring) 콤보 상자에 추가할 현재 레코드에서 각 문자열에 대 한 합니다.  
