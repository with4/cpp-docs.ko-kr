---
title: "const_mem_fun1_t 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
## 예제  
 The constructor of `const_mem_fun1_t` is not usually used directly; the helper function `mem_fun` is used to adapt member functions.  See [mem\_fun](../Topic/mem_fun%20Function.md) for an example of how to use member function adaptors.  
