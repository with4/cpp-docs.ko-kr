...
### <a name="remarks"></a>설명  
 문자열의 첫 번째 요소에는 0부터 시작 하 고 다음 요소는 양의 정수 연속적으로 인덱싱됩니다 있도록 길이의 문자열  *n*  에  *n* th 요소 수에 의해 인덱싱된 *n-* 1입니다.  
...
### <a name="remarks"></a>설명  
 문자열의 첫 번째 요소에는 인덱스가 0 및 다음과 같은 요소는 양의 정수 연속적으로 인덱싱됩니다 있도록 길이의 문자열  *n*  에  *n*  th 요소는 숫자로 인덱싱할  *n*  -1입니다.  
