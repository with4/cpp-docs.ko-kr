...
## 설명  
 와이불 분포에 따라 분포된 경우 템플릿 클래스는 사용자 지정 정수 형식 또는 아무 것도 제공되지 않았다면 `double` 형식의 값을 생성하는 분포를 설명합니다.  다음 테이블은 개별 멤버에 대한 문서와 연결되어 있습니다.  
...
|`weibull_distribution::operator()`|`weibull_distribution::b`|[weibull\_distribution::param\_type](../Topic/weibull_distribution::param_type.md)|  
 ...
 와이불 분포에 대한 자세한 내용은 Wolfram MathWorld 문서 [와이불 분포](http://go.microsoft.com/fwlink/?LinkId=401115)를 참조하세요.  
