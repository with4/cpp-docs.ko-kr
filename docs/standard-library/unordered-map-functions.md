...
### <a name="remarks"></a>설명  
 템플릿 함수는 `left.`[unordered_map::swap](../standard-library/unordered-map-class.md#unordered_map__swap)`(right)`을 실행합니다.  
...
### <a name="remarks"></a>설명  
 템플릿 함수는 `left.`[unordered_multimap::swap](../standard-library/unordered-multimap-class.md#unordered_multimap__swap)`(right)`을 실행합니다.  
