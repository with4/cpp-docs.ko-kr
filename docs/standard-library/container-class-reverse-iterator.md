---
title: 컨테이너 Class::reverse_iterator | Microsoft 문서
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
제어되는 시퀀스의 역방향 반복기로 사용될 수 있는 개체를 설명합니다.
...
여기서는 지정되지 않은 형식 **T7**의 동의어(일반적으로 `reverse_iterator` **\<**[iterator](../standard-library/container-class-iterator.md)**>**)로 설명됩니다.
