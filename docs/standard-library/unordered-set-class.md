...
템플릿 클래스는 `const Key` 형식으로 된 다양한 길이의 요소 시퀀스를 제어하는 개체를 설명합니다. 시퀀스는 해시 함수로 약하게 정렬됩니다. 즉, 시퀀스를 버킷이라고 하는 하위 시퀀스의 정렬된 집합으로 분할합니다. 비교 함수는 각 버킷 내에서 요소 쌍이 동일하게 정렬되었는지 여부를 확인합니다. 각 요소는 정렬 키와 값으로 사용됩니다. 시퀀스는 최소한 모든 버킷이 대략 동일한 크기일 경우 시퀀스의 요소 수와 상관없이 작업 수를 사용하여 임의 요소를 조회, 삽입, 제거하는 방식으로 나타냅니다(일정 시간). 모든 요소가 하나의 버킷에 있는 최악의 경우에는 작업 수가 시퀀스의 요소 수에 비례합니다(선형 시간). 또한, 요소를 삽입할 경우 어떤 반복기도 무효화되지 않으며, 요소를 제거할 경우 제거된 요소를 가리키고 있는 반복기만 무효화됩니다.  
...
|-|-|  
|형식 정의|설명|  
|[unordered_set::allocator_type](#unordered_set__allocator_type)|저장소 관리를 위한 할당자의 형식입니다.|  
|[unordered_set::const_iterator](#unordered_set__const_iterator)|제어되는 시퀀스에 대한 상수 반복기의 형식입니다.|  
|[unordered_set::const_local_iterator](#unordered_set__const_local_iterator)|제어되는 시퀀스에 대한 상수 버킷 반복기의 형식입니다.|  
|[unordered_set::const_pointer](#unordered_set__const_pointer)|요소에 대한 상수 포인터의 형식입니다.|  
|[unordered_set::const_reference](#unordered_set__const_reference)|요소에 대한 상수 참조의 형식입니다.|  
|[unordered_set::difference_type](#unordered_set__difference_type)|두 요소 사이의 부호가 있는 거리의 형식입니다.|  
|[unordered_set::hasher](#unordered_set__hasher)|해시 함수의 형식입니다.|  
|[unordered_set::iterator](#unordered_set__iterator)|제어되는 시퀀스에 대한 반복기의 형식입니다.|  
|[unordered_set::key_equal](#unordered_set__key_equal)|비교 함수의 형식입니다.|  
|[unordered_set::key_type](#unordered_set__key_type)|정렬 키의 형식입니다.|  
|[unordered_set::local_iterator](#unordered_set__local_iterator)|제어되는 시퀀스에 대한 버킷 반복기의 형식입니다.|  
|[unordered_set::pointer](#unordered_set__pointer)|요소에 대한 포인터의 형식입니다.|  
|[unordered_set::reference](#unordered_set__reference)|요소에 대한 참조의 형식입니다.|  
|[unordered_set::size_type](#unordered_set__size_type)|두 요소 사이의 부호가 없는 거리의 형식입니다.|  
|[unordered_set::value_type](#unordered_set__value_type)|요소의 형식입니다.|  
  
|||  
|-|-|  
|멤버 함수|설명|  
|[unordered_set::begin](#unordered_set__begin)|제어되는 시퀀스의 시작을 지정합니다.|  
|[unordered_set::bucket](#unordered_set__bucket)|키 값에 대한 버킷 개수를 가져옵니다.|  
|[unordered_set::bucket_count](#unordered_set__bucket_count)|버킷 개수를 가져옵니다.|  
|[unordered_set::bucket_size](#unordered_set__bucket_size)|버킷의 크기를 가져옵니다.|  
|[unordered_set::cbegin](#unordered_set__cbegin)|제어되는 시퀀스의 시작을 지정합니다.|  
|[unordered_set::cend](#unordered_set__cend)|제어되는 시퀀스의 끝을 지정합니다.|  
|[unordered_set::clear](#unordered_set__clear)|모든 요소를 제거합니다.|  
|[unordered_set::count](#unordered_set__count)|지정한 키와 일치하는 요소의 수를 찾습니다.|  
|[unordered_set::emplace](#unordered_set__emplace)|생성된 요소를 추가합니다.|  
|[unordered_set::emplace_hint](#unordered_set__emplace_hint)|힌트와 함께 생성된 요소를 추가합니다.|  
|[unordered_set::empty](#unordered_set__empty)|요소가 있는지 여부를 테스트합니다.|  
|[unordered_set::end](#unordered_set__end)|제어되는 시퀀스의 끝을 지정합니다.|  
|[unordered_set::equal_range](#unordered_set__equal_range)|지정된 키와 일치하는 범위를 찾습니다.|  
|[unordered_set::erase](#unordered_set__erase)|지정된 위치에 있는 요소를 제거합니다.|  
|[unordered_set::find](#unordered_set__find)|지정된 키와 일치하는 요소를 찾습니다.|  
|[unordered_set::get_allocator](#unordered_set__get_allocator)|저장된 할당자 개체를 가져옵니다.|  
|[unordered_set::hash_function](#unordered_set__hash_function)|저장된 해시 함수 개체를 가져옵니다.|  
|[unordered_set::insert](#unordered_set__insert)|요소를 추가합니다.|  
|[unordered_set::key_eq](#unordered_set__key_eq)|저장된 비교 함수 개체를 가져옵니다.|  
|[unordered_set::load_factor](#unordered_set__load_factor)|버킷당 평균 요소 수를 계산합니다.|  
|[unordered_set::max_bucket_count](#unordered_set__max_bucket_count)|최대 버킷 개수를 가져옵니다.|  
|[unordered_set::max_load_factor](#unordered_set__max_load_factor)|버킷당 최대 요소 수를 가져오거나 설정합니다.|  
|[unordered_set::max_size](#unordered_set__max_size)|제어되는 시퀀스의 최대 크기를 가져옵니다.|  
|[unordered_set::rehash](#unordered_set__rehash)|해시 테이블을 다시 빌드합니다.|  
|[unordered_set::size](#unordered_set__size)|요소 수를 계산합니다.|  
|[unordered_set::swap](#unordered_set__swap)|두 컨테이너의 내용을 바꿉니다.|  
|[unordered_set::unordered_set](#unordered_set__unordered_set)|컨테이너 개체를 만듭니다.|  
  
|||  
|-|-|  
|연산자|설명|  
|[unordered_set::operator=](#unordered_set__operator_eq)|해시 테이블을 복사합니다.|  
  
## <a name="remarks"></a>설명  
 개체는 저장된 두 개체, [unordered_set::key_equal](#unordered_set__key_equal) 형식의 비교 함수 개체, [unordered_set::hasher](#unordered_set__hasher) 형식의 해시 함수 개체를 호출하여 제어하는 시퀀스를 정렬합니다. 첫 번째 저장된 개체는 구성원 함수 [unordered_set::key_eq](#unordered_set__key_eq)`()`를 호출하여 액세스하며, 두 번째 저장된 개체는 구성원 함수 [unordered_set::hash_function](#unordered_set__hash_function)`()`을 호출하여 액세스합니다. 특히 `Key` 형식의 모든 값 `X` 및 `Y`의 경우 두 인수의 순서가 같아야 `key_eq()(X, Y)` 호출에서 true를 반환합니다. `hash_function()(keyval)` 호출은 `size_t` 형식의 값 분포를 생성합니다. 템플릿 클래스 [unordered_multiset 클래스](../standard-library/unordered-multiset-class.md)와 달리, 템플릿 클래스 `unordered_set`의 개체를 사용하는 경우에는 제어된 시퀀스의 두 요소에 대해 `key_eq()(X, Y)`가 항상 false입니다. (키는 고유합니다.)  
  
 개체는 또한 최대 로드 비율(버킷당 최대 평균 요소 수를 원하는 대로 지정)를 저장합니다. 요소를 삽입할 때 [unordered_set::load_factor](#unordered_set__load_factor)`()`에서 최대 로드 비율이 초과될 경우 컨테이너는 버킷 수를 증가시키고 필요에 따라 해시 테이블을 다시 빌드합니다.  
 ...
 개체는 [unordered_set::allocator_type](#unordered_set__allocator_type) 형식의 저장된 할당자 개체를 통해 제어하는 시퀀스에 대한 저장소를 할당하고 해제합니다. 그러한 할당자 개체에는 템플릿 클래스 `allocator`의 개체와 같은 외부 인터페이스가 있어야 합니다. 컨테이너 개체를 할당하는 경우 저장된 할당자 개체는 복사되지 않습니다.  
...
### <a name="remarks"></a>설명  
 이 형식은 템플릿 매개 변수 `Alloc`와 동일한 의미입니다.  
...
### <a name="remarks"></a>설명  
 처음 두 개의 멤버 함수는 시퀀스의 첫 번째 요소(또는 빈 시퀀스의 끝 바로 다음)를 가리키는 정방향 반복기를 반환합니다. 마지막 두 개의 구성원 함수는 버킷 `nbucket`의 첫 번째 요소(또는 빈 버킷의 끝 바로 다음)를 가리키는 정방향 반복기를 반환합니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 현재 키 값 `keyval`에 해당하는 버킷 번호를 반환합니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 버킷 번호 `nbucket`의 크기를 반환합니다.  
...
### <a name="remarks"></a>설명  
 ...
 `begin()` 구성원 함수 대신 이 구성원 함수를 사용하여 반환 값이 `const_iterator`임을 보장할 수 있습니다. 일반적으로 다음 예제와 같이 [auto](../cpp/auto-cpp.md) 형식 추론 키워드와 함께 사용합니다. 이 예제에서는 `Container`가 `begin()` 및 `cbegin()`을 지원하는 수정 가능(비`const`) 컨테이너라고 가정합니다.  
...
### <a name="remarks"></a>설명  
 ...
 `end()` 구성원 함수 대신 이 구성원 함수를 사용하여 반환 값이 `const_iterator`임을 보장할 수 있습니다. 일반적으로 다음 예제와 같이 [auto](../cpp/auto-cpp.md) 형식 추론 키워드와 함께 사용합니다. 이 예제에서는 `Container`가 `end()` 및 `cend()`를 지원하는 수정 가능(비`const`) 컨테이너라고 가정합니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 [unordered_set::erase](#unordered_set__erase)`(` [unordered_set::begin](#unordered_set__begin)`(),` [unordered_set::end](#unordered_set__end)`())`를 호출합니다.  
...
### <a name="remarks"></a>설명  
 이 형식은 제어되는 시퀀스의 상수 정방향 반복기로 사용될 수 있는 개체를 설명합니다. 여기서는 구현에서 정의된 형식 `T1`과 동일한 의미로 설명됩니다.  
...
### <a name="remarks"></a>설명  
 형식은 버킷의 상수 정방향 반복기로 사용될 수 있는 개체를 설명합니다. 여기서는 구현에서 정의된 형식 `T5`와 동일한 의미로 설명됩니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 [unordered_set::equal_range](#unordered_set__equal_range)`(keyval)`로 구분된 범위의 요소 수를 반환합니다.  
...
### <a name="remarks"></a>설명  
 부호 있는 정수 형식은 제어되는 시퀀스에서 두 요소의 주소 간 차이점을 나타낼 수 있는 개체를 설명합니다. 여기서는 구현에서 정의된 형식 `T3`과 동일한 의미로 설명됩니다.  
...
### <a name="remarks"></a>설명  
 ...
 코드 예제를 보려면 [set::emplace](../standard-library/set-class.md#set__emplace)를 참조하세요.  
...
### <a name="remarks"></a>설명  
 처음 두 멤버 함수는 시퀀스 끝의 바로 다음을 가리키는 정방향 반복기를 반환합니다. 마지막 두 구성원 함수는 `nbucket` 버킷 끝의 바로 다음을 가리키는 정방향 반복기를 반환합니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 `keyval`을 사용하여 동일하게 정렬된 제어되는 시퀀스의 요소만 `[X.first, X.second)`로 구분되도록 반복기 `X` 쌍을 반환합니다. 이러한 요소가 없는 경우 두 반복기는 모두 `end()`입니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 [unordered_set::equal_range](#unordered_set__equal_range)`(keyval).first`를 반환합니다.  
...
### <a name="remarks"></a>설명  
 이 형식은 템플릿 매개 변수 `Hash`와 동일한 의미입니다.  
...
|`ValTy`|unordered_set가 [value_type](../standard-library/map-class.md#map__value_type)의 요소를 생성하는 데 사용할 수 있는 인수 형식을 지정하고 `Val`을 인수로 완벽하게 전달하는 템플릿 매개 변수입니다.|  
|`First`|복사할 첫 번째 요소의 위치입니다.|  
|`Last`|복사할 마지막 요소 바로 다음 위치입니다.|  
|`InputIterator`|[value_type](../standard-library/map-class.md#map__value_type) 개체를 생성하는 데 사용할 수 있는 형식의 인수를 가리키는 [입력 반복기](../standard-library/input-iterator-tag-struct.md)의 요구 사항을 충족하는 템플릿 함수 인수입니다.|  
|`IList`|요소를 복사할 원본 [initializer_list](../standard-library/initializer-list.md)입니다.|  
  
### <a name="return-value"></a>반환 값  
 단일 요소 구성원 함수 (1) 및 (2)는 `bool` 구성 요소가 삽입된 경우 true이고 unordered_set에 배열 시 키에 동일한 값이 있는 요소가 이미 포함되어 있는 경우 flase인 [쌍](../standard-library/pair-structure.md)을 반환합니다. 반환 값 쌍의 반복기 구성 요소는 `bool` 구성 요소가 true인 경우에는 새로 삽입된 요소를 가리키고 `bool` 구성 요소가 false인 경우에는 기존 요소를 가리킵니다.  
...
### <a name="remarks"></a>설명  
 ...
 컨테이너의 [value_type](../standard-library/map-class.md#map__value_type)은 컨테이너에 속한 형식 정의이고 set의 경우 `unordered_set<V>::value_type`은 `const V`입니다.  
  
 범위 구성원 함수 (5)는 `[First, Last)` 범위에서 반복기가 주소를 지정하는 각 요소에 해당하는 unordered_set에 요소 값의 시퀀스를 입력하므로 `Last`는 삽입되지 않습니다. 컨테이너 구성원 함수 `end()`는 컨테이너의 마지막 요소 바로 뒤에 있는 위치를 참조합니다. 예를 들어 `s.insert(v.begin(), v.end());` 문이 `v`의 모든 요소를 `s`에 삽입하려고 합니다. 범위에 고유 값이 있는 요소만 삽입됩니다. 중복 값은 무시됩니다. 어떤 요소가 거부되는지 관찰하려면 `insert`의 단일 요소 버전을 사용합니다.  
  
 이니셜라이저 목록 구성원 함수 (6)은 [initializer_list](../standard-library/initializer-list.md)를 사용하여 요소를 unordered_set에 복사합니다.  
  
 생성된 요소를 제 위치에 삽입하려면, 즉 복사 또는 이동 작업을 수행하지 않으려면 [set::emplace](../standard-library/set-class.md#set__emplace) 및 [set::emplace_hint](../standard-library/set-class.md#set__emplace_hint)를 참조하세요.  
  
 코드 예제를 보려면 [set::insert](../standard-library/set-class.md#set__insert)를 참조하세요.  
...
### <a name="example"></a>예제  
  **반복기**를 선언하고 사용하는 방법에 대한 예제는 [begin](../standard-library/set-class.md#set__begin)의 예제를 참조하세요.  
...
### <a name="remarks"></a>설명  
 이 형식은 템플릿 매개 변수 `Pred`와 동일한 의미입니다.  
...
### <a name="remarks"></a>설명  
 이 형식은 템플릿 매개 변수 `Key`와 동일한 의미입니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 `(float)`[unordered_set::size](#unordered_set__size)`() / (float)`[unordered_set::bucket_count](#unordered_set__bucket_count)`()`(버킷당 평균 요소 수)를 반환합니다.  
...
### <a name="remarks"></a>설명  
 형식은 버킷의 정방향 반복기로 사용될 수 있는 개체를 설명합니다. 여기서는 구현에서 정의된 형식 `T4`와 동일한 의미로 설명됩니다.  
...
### <a name="remarks"></a>설명  
 첫 번째 멤버 함수는 저장된 최대 로드 비율을 반환합니다. 두 번째 구성원 함수는 저장된 최대 로드 비율을 `factor`로 바꿉니다.  
...
|-|-|  
|매개 변수|설명|  
|` right`|`unordered_set`에 복사되는 [unordered_set](../standard-library/unordered-set-class.md)입니다.|  
...
### <a name="remarks"></a>설명  
 구성원 함수는 필요에 따라 버킷 수를 `nbuckets` 이상으로 변경하고 해시 테이블을 다시 빌드합니다.  
...
### <a name="remarks"></a>설명  
 부호 없는 정수 형식은 제어되는 시퀀스의 길이를 나타낼 수 있는 개체를 설명합니다. 여기서는 구현에서 정의된 형식 `T2`와 동일한 의미로 설명됩니다.  
...
### <a name="remarks"></a>설명  
 구성원 함수는 `*this` 및 `right` 간에 제어되는 시퀀스를 바꿉니다. [unordered_set::get_allocator](#unordered_set__get_allocator)`() == right.get_allocator()`인 경우 일정 시간에 이 작업을 수행하고 `Tr` 형식의 저장된 특성 개체를 복사한 결과로만 예외를 throw하며 두 개의 제어되는 시퀀스에서 요소를 지정하는 참조, 포인터 또는 반복기를 무효화하지 않습니다. 그렇지 않으면 두 개의 제어되는 시퀀스에 있는 요소 수에 비례하여 많은 요소 할당 및 생성자 호출을 수행합니다.  
