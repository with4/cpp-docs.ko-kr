...
`right` 지도 교환할 요소가 hash_map `left`합니다.

`left` 지도 교환할 요소가 hash_map `right`합니다.
...
`right` 지도 교환할 요소가 hash_multimap `left`합니다.

`left` 지도 교환할 요소가 hash_multimap `right`합니다.
