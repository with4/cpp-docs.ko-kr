---
title: "입력 스트림 멤버 함수 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
##  <a name="vclrftheopenfunctionforinputstreamsanchor11"></a> The open Function for Input Streams  
 ...
 You generally specify an [ios\_base::openmode](../Topic/ios_base::openmode.md) flag when you open the file associated with an input stream \(the default mode is **ios::in**\).  For a list of the **open\_mode** flags, see [The open Function](#vclrftheopenfunctionforinputstreamsanchor11).  The flags can be combined with the bitwise OR \( &#124; \) operator.  
