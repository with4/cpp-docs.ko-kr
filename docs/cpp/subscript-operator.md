...
```  
 ...
 첨자 연산자는 가환적입니다. 따라서 *배열*[*인덱스*] 및 *배열*[*배열*] 첨자 오랫동안 동등한 것으로 보장 됩니다 연산자 오버 로드 되지 않았는지 (참조 [오버 로드 된 연산자](../cpp/operator-overloading.md)). 첫 번째 형태가 가장 일반적인 코딩 방법이지만, 둘 다 작동합니다.  
