...
helpviewer_keywords: 
  ...
  - "short 데이터 형식"
  - "short int 데이터"
  - "부호 있는 형식[C++], 데이터 형식 범위"
  - "long long 키워드[C++]"
  - "long double 키워드[C++]"
  - "Double 데이터 형식, 데이터 형식 범위"
  - "signed short int"
  - "unsigned short"
  - "크기 조정 정수 형식"
  - "signed int"
...
|char|1|없음|–128~127(기본값)<br /><br /> [/J](../build/reference/j-default-char-type-is-unsigned.md)를 사용하여 컴파일된 경우 0~255|  
...
|enum|varies|없음|이 문서의 뒷부분에서 [설명](#bkmkRemarks) 참조|  
