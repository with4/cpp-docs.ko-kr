...
## <a name="getting-started"></a>시작  
 ...
 사용 하는 방법을 보여 줍니다 합니다 [IXMLHTTPRequest2](http://msdn.microsoft.com/bbc11c4a-aecf-4d6d-8275-3e852e309908) 하 고 [IXMLHTTPRequest2Callback](http://msdn.microsoft.com/aa4b3f4c-6e28-458b-be25-6cce8865fc71) UWP 앱에서 웹 서비스에 HTTP GET 및 POST 요청을 보내는 작업 함께 인터페이스.  
