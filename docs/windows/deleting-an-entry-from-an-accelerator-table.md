---
title: 액셀러레이터 키 테이블에서 항목을 삭제 해도 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  삭제하려는 항목을 선택합니다. (키를 누른 채는 **CTRL** 또는 **SHIFT** 키를 클릭 하는 동안 여러 항목을 선택 합니다.)  
  
3.  마우스 오른쪽 단추로 클릭 하 고 선택 **삭제** 바로 가기 메뉴에서 (또는 선택 **삭제** 에서 **편집** 메뉴).  
