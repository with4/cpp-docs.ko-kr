...
### 대화 상자 가운데에 컨트롤을 맞추려면  
  
1.  다시 배치할 하나 또는 여러 개의 컨트롤을 선택합니다.  
  
2.  **서식** 메뉴에서 **대화 상자 가운데 맞춤**을 선택하고 다음 배치 방법 중 하나를 선택합니다.  
  
    -   **세로**: 세로 방향으로 대화 상자의 가운데에 컨트롤을 맞춥니다.  
  
    -   **가로**: 가로 방향으로 대화 상자의 가운데에 컨트롤을 맞춥니다.  
