...
## 설명  
 **Displaybind** C\+\+ 특성을 동일한 기능을가지고 있는  [displaybind](http://msdn.microsoft.com/library/windows/desktop/aa366804) MIDL 속성입니다.  
  
## 예제  
 예제를 보려면  [바인딩할 수 있는](../windows/bindable.md) 예를 사용 하는 방법에 대 한  **displaybind**.  
