...
-   [새 도구 모음 및 단추 만들기](../mfc/creating-new-toolbars.md)  
  
-   [비트맵을 도구 모음 리소스로 변환](../mfc/converting-bitmaps-to-toolbars.md)  
  
-   [도구 모음 단추 만들기, 이동 및 편집](../mfc/creating-moving-and-editing-toolbar-buttons.md)  
  
-   [도구 설명 만들기](../mfc/creating-a-tool-tip-for-a-toolbar-button.md)  
...
도구 모음 편집기  
 ...
 도구 모음 편집기 기능은 이미지 편집기 기능과 유사합니다. 메뉴 항목, 그래픽 도구 및 비트맵 그리드는 이미지 편집기의 항목과 같습니다. 이미지 메뉴에는 도구 모음 편집기와 이미지 편집기 사이에서 전환할 수 있는 메뉴 명령이 있습니다. 그래픽 도구 모음, 색 색상표 또는 이미지 메뉴 사용에 대한 자세한 내용은 [이미지 편집기](../mfc/image-editor-for-icons.md)를 참조하세요.  
