---
title: "여러 컨트롤 추가 | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  누른 채는 **CTRL** 키에 있는 컨트롤을 선택 합니다는 [도구 상자 창](/visualstudio/ide/reference/toolbox)합니다.  
  
2.  릴리스는 **CTRL** 키를 특정 컨트롤을 추가 하려면 원하는 횟수 만큼 대화 상자를 클릭 합니다.  
  
3.  키를 눌러 **ESC** 에 컨트롤 추가 중지 합니다.  
