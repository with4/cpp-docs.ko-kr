...
ms.locfileid: "39464339"
---
# <a name="array-attributes"></a>배열 특성
배열에는 다음 특성을 적용 하거나 `SAFEARRAY`s입니다.  
...
|[string](../windows/string-cpp.md)|나타내는 1 차원 **char**를 **wchar_t**합니다 **바이트** (또는 이와 동등한) 배열 또는 이러한 배열에 대 한 포인터를 문자열로 간주 해야 합니다.|  
