...
대화 상자 편집기를 사용 하 여 있습니다 수 추가, 크기 조정, 편집 및 대화 상자에서 컨트롤을 삭제 합니다. 해당 ID와 같은 컨트롤의 속성을 편집할 수도 있습니다 여부나 디렉터리 이름이 처음에 표시 되 런타임 시.  
 ...
 대화 상자 편집기의 바로 가기 메뉴를 사용 하면 신속 하 게 대화 상자에 등록 된 ActiveX 컨트롤을 추가 하 고 빠른 액세스를 위해 도구 상자에 ActiveX 컨트롤을 추가할 수 있습니다 (자세한 내용은 참조 [사용자 지정 도구 상자 대화 상자](http://msdn.microsoft.com/en-us/bd07835f-18a8-433e-bccc-7141f65263bb)).  
  
-   [대화 상자에 컨트롤 추가](adding-a-control-to-a-dialog-box.md)  
  
-   [추가할 때 컨트롤 크기 조정](sizing-a-control-while-you-add-it.md)  
...
## <a name="see-also"></a>참고 항목  
 ...
 [대화 상자 컨트롤에 대 한 이벤트 처리기를 추가합니다.](adding-event-handlers-for-dialog-box-controls.md)   
