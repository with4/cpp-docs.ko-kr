---
title: "범주별 키 WRL API | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
다음 표에서 기본 [!INCLUDE[cppwrl](../windows/includes/cppwrl_md.md)] 클래스, 구조체, 함수 및 매크로입니다. 도우미 네임 스페이스 및 클래스의 구문 생략 됩니다. 이 목록은 네임 스페이스에 의해 정렬 API 설명서를 확장할 수 있습니다.  
...
|[Module:: methodreleasenotifier 클래스](../windows/module-methodreleasenotifier-class.md)|현재 모듈의 마지막 개체가 해제될 때 이벤트 처리기를 호출합니다. 이벤트 처리기는 개체와 해당 포인터를-a-메서드 멤버에 의해 지정 됩니다.|  
...
|[Implements 구조체](../windows/implements-structure.md)|구현 `QueryInterface` 및 `GetIid` 지정된 된 인터페이스에 있습니다.|  
...
|제목|설명|  
|-----------|-----------------|  
|[ActivateInstance 함수](../windows/activateinstance-function.md)|등록 하 고 지정 된 클래스 ID에 정의 된 지정 된 형식의 인스턴스를 검색 합니다.|  
