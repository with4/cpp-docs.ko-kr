...
## <a name="see-also"></a>참고 항목  
 ...
 [사용자 인터페이스 개체와 관련 된 메시지 형식](../mfc/reference/message-types-associated-with-user-interface-objects.md)   
 [메시지 처리기 편집](../mfc/reference/editing-a-message-handler.md)   
 [리플 렉 트 된 메시지의 메시지 처리기 정의](../mfc/reference/defining-a-message-handler-for-a-reflected-message.md)   
