...
### 다른 디스플레이 장치용 이미지를 추가하려면  
  
1.  **이미지** 메뉴에서 **새 장치 이미지**를 클릭하거나 **이미지 편집기** 창을 마우스 오른쪽 단추로 클릭하고 바로 가기 메뉴에서 **새 장치 이미지**를 선택합니다.  
  
2.  추가할 이미지 형식을 선택합니다.  **사용자 지정**을 클릭하면 기본 목록에서 사용할 수 없는 크기의 아이콘을 만들 수도 있습니다.  
