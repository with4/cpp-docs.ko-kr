...
다음 기호들도 MFC 지원 파일의 일부이지만 표준 Windows 응용 프로그램 함수 및 동작을 지원합니다.  이 기호들은 주로 메뉴에서 사용됩니다.  메뉴 편집기로 메뉴 작업을 할 때 속성 창에 이 기호들이 일반 메뉴 명령과 연결되어 나타납니다.  예를 들어, 응용 프로그램의 파일 메뉴에 종료 명령이 있으면 이 명령은 [속성 창](../Topic/Properties%20Window.md)에서 기호 ID\_APP\_EXIT와 연결됩니다.  
...
|ID\_FILE\_SAVE|ID\_FILE\_SAVE|ID\_FILE\_SAVE\_COPY\_AS|  
