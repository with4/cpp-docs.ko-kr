...
1.  크기를 조정할 이미지 부분을 선택합니다.  자세한 내용은 [이미지 영역 선택](../mfc/selecting-an-area-of-an-image-image-editor-for-icons.md)을 참조하십시오.  
  
2.  선택 영역이 원하는 크기가 될 때까지 크기 조정 핸들 중 하나를 끕니다.  
