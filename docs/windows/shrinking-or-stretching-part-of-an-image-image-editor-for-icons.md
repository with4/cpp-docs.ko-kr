---
title: "(아이콘에 대 한 이미지 편집기) 이미지 일부 줄이기 또는 늘이기 | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  크기를 조정 하려면 이미지의 부분을 선택 합니다. 자세한 내용은 참조 [이미지 영역 선택](../windows/selecting-an-area-of-an-image-image-editor-for-icons.md)합니다.  
