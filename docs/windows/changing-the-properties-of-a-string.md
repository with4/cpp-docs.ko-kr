...
2.  선택 검색할 문자열을 편집 하 고 두 번 클릭 하 고 **ID**, **값**, 또는 **캡션** 열. 이제 다음을 수행할 수 있습니다.  
  
    -   선택 된 **ID** 에서 **ID 드롭 다운** 나열 하거나 직접 ID를 입력 합니다.  
  
    -   에 다른 숫자를 입력의 **값** 열입니다.  
  
    -   입력 하 여에서 편집할은 **캡션** 열입니다.  
  
        > [!NOTE]
        >  에 문자열 속성을 편집할 수도 있습니다는 [속성 창](/visualstudio/ide/reference/properties-window)합니다.  
