...
ms.locfileid: "39645154"
---
# <a name="using-the-256-color-palette-image-editor-for-icons"></a>256 색상표 사용(아이콘에 대한 이미지 편집기)
256 색상표에서 선택 하 여 그리려면, 색 색상표에서 색을 선택 해야 합니다 [색 창](../windows/colors-window-image-editor-for-icons.md)합니다.  
...
2.  에 표시 된 256 색에서 색을 선택 합니다 **색** 색상표에는 **색** 창입니다.  
     ...
     선택한 색의 색상표에서 현재 색 표시 됩니다는 **색** 창입니다.  
