...
이 클래스를 사용 하 여 문자열 변환 매크로에서 `CA2TEX` 및 `CT2AEX`, 및 typedef  **CA2A**.  
...
|Name|설명|  
|----------|--------|  
|[CA2AEX::CA2AEX](../Topic/CA2AEX::CA2AEX.md)|생성자입니다.|  
|[CA2AEX::~CA2AEX](../Topic/CA2AEX::~CA2AEX.md)|소멸자|  
  
### Public 연산자  
  
|Name|설명|  
|----------|--------|  
|[CA2AEX::operator LPSTR](../Topic/CA2AEX::operator%20LPSTR.md)|변환 연산자입니다.|  
  
### 공용 데이터 멤버  
  
|Name|설명|  
|----------|--------|  
|[CA2AEX::m\_psz](../Topic/CA2AEX::m_psz.md)|소스 문자열을 저장 하는 데이터 멤버입니다.|  
|[CA2AEX::m\_szBuffer](../Topic/CA2AEX::m_szBuffer.md)|변환 된 문자열을 저장 하는 데 사용 되는 정적 버퍼입니다.|  
  
## 설명  
 추가 기능이 필요 하지 않으면 사용 `CA2TEX`, `CT2AEX`, 또는  **CA2A** 코드에서 직접.  
