...
이 클래스는 문자열 변환 매크로에서 사용 됩니다 `CA2TEX`, `CA2CTEX`, `CT2WEX`, 및 `CT2CWEX`, 및 typedef **CA2W**합니다.  
...
## <a name="remarks"></a>주의  
 추가 기능은 필요 하지 않으면 사용 `CA2TEX`, `CA2CTEX`, `CT2WEX`, `CT2CWEX`, 또는 **CA2W** 코드에 있습니다.  
