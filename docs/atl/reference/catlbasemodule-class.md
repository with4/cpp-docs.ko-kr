---
title: "CAtlBaseModule 클래스 | Microsoft 문서"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[CAtlBaseModule::SetResourceInstance](#setresourceinstance)|리소스 인스턴스를 설정 된 `CAtlBaseModule` 개체입니다.|  
  
### <a name="public-data-members"></a>공용 데이터 멤버  
  
|이름|설명|  
|----------|-----------------|  
|[CAtlBaseModule::m_bInitFailed](#m_binitfailed)|모듈을 초기화 하지 못한 경우를 지정 하는 변수입니다.|  
  
## <a name="remarks"></a>주의  
 인스턴스 `CAtlBaseModule` 명명 된 _AtlBaseModule 모듈 인스턴스에 대 한 핸들, 리소스 (기본적으로 동일)을 포함 하는 모듈 및 기본 리소스를 제공 하는 모듈에 대 한 핸들의 배열에 대 한 핸들이 포함 된 모든 ATL 프로젝트에 있습니다. `CAtlBaseModule`수 여러 스레드에서 안전 하 게 액세스할 수 있습니다.  
