---
title: "ATL COM + 1.0 성분을 추가 | Microsoft 문서"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="adding-an-atl-com-10-component"></a>ATL COM + 1.0 성분을 추가
...
2.  바로 가기 메뉴를 클릭 하 여 **추가**를 클릭 하 고 **클래스 추가**합니다.  
  
3.  에 [클래스 추가](../../ide/add-class-dialog-box.md) 대화 상자의 템플릿 창에서 클릭 **ATL COM + 1.0 구성 요소**, 클릭 하 고 **열려** 표시 하는 [ATL COM + 1.0 구성 요소 마법사](../../atl/reference/atl-com-plus-1-0-component-wizard.md)합니다.  
