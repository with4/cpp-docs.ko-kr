...
이 클래스는 문자열 변환 매크로에서 사용 됩니다 `CT2AEX`, `CW2TEX`, `CW2CTEX`, 및 `CT2CAEX`, 및 typedef **CW2A**합니다.  
...
## <a name="remarks"></a>주의  
 추가 기능은 필요 하지 않으면 사용 `CT2AEX`, `CW2TEX`, `CW2CTEX`, `CT2CAEX`, 또는 **CW2A** 코드에 있습니다.  
 ...
 기본적으로 ATL 변환 클래스와 매크로 변환에 대 한 현재 스레드의 ANSI 코드 페이지 사용. 특정 변환에 대 한 해당 동작을 재정의 하려는 경우 클래스의 생성자에 대 한 두 번째 매개 변수로 코드 페이지를 지정 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `nCodePage`  
 코드 페이지 변환을 수행 하는 데 사용 합니다. 코드 페이지 매개 변수 설명에 대 한 참조는 [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)] 함수 [MultiByteToWideChar](http://msdn.microsoft.com/library/windows/desktop/dd319072) 대 한 자세한 내용은 합니다.  
...
##  <a name="a-nameoperatorlpstra--cw2aexoperator-lpstr"></a><a name="operator_lpstr"></a>LPSTR CW2AEX::operator  
 변환 연산자입니다.  
