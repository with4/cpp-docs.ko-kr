...
|이름|설명|  
|--------|--------|  
|[CW2AEX::CW2AEX](../Topic/CW2AEX::CW2AEX.md)|생성자입니다.|  
|[CW2AEX::~CW2AEX](../Topic/CW2AEX::~CW2AEX.md)|소멸자|  
  
### Public 연산자  
  
|이름|설명|  
|--------|--------|  
|[CW2AEX::operator LPSTR](../Topic/CW2AEX::operator%20LPSTR.md)|변환 연산자입니다.|  
  
### 공용 데이터 멤버  
  
|이름|설명|  
|--------|--------|  
|[CW2AEX::m\_psz](../Topic/CW2AEX::m_psz.md)|소스 문자열을 저장 하는 데이터 멤버입니다.|  
|[CW2AEX::m\_szBuffer](../Topic/CW2AEX::m_szBuffer.md)|변환 된 문자열을 저장 하는 데 사용 되는 정적 버퍼입니다.|  
