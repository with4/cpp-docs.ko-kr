...
|[CWindow::Attach](#attach)|다이어그램에 연결 된 `CWindow` 개체입니다.|  
|[CWindow::BeginPaint](#beginpaint)|창 그리기에 대 한 준비합니다.|  
|[CWindow::BringWindowToTop](#bringwindowtotop)|Z 순서 맨 창을 보냅니다.|  
...
|[CWindow::ClientToScreen](#clienttoscreen)|클라이언트 좌표를 화면 좌표로 변환합니다.|  
...
|[CWindow::CreateSolidCaret](#createsolidcaret)|시스템 캐럿에 대 한 사각형을 solid 만듭니다.|  
|[CWindow::DeferWindowPos](#deferwindowpos)|지정된 된 창에 대 한 지정된 된 다중 창 위치 구조를 업데이트합니다.|  
|[CWindow::DestroyWindow](#destroywindow)|와 관련 된 창을 제거는 `CWindow` 개체입니다.|  
|[CWindow::Detach](#detach)|창을 분리는 `CWindow` 개체입니다.|  
|[CWindow::DlgDirList](#dlgdirlist)|지정 된 경로 또는 파일 이름에 일치 하는 모든 파일의 이름으로 목록 상자를 채웁니다.|  
...
|[CWindow::DragAcceptFiles](#dragacceptfiles)|파일을 끌어 창 수락할지 여부를 등록 합니다.|  
...
|[CWindow::GetDlgCtrlID](#getdlgctrlid)|창의 식별자 (자식 창에만 해당)에 대 한 검색합니다.|  
...
|[CWindow::GetFont](#getfont)|창의 현재 글꼴을 검색합니다.|  
...
|[CWindow::GetNextDlgGroupItem](#getnextdlggroupitem)|컨트롤 그룹 내에서 이전 또는 다음 컨트롤을 검색합니다.|  
...
|[CWindow::GetWindowLong](#getwindowlong)|별도 창 메모리에 지정된 된 오프셋에서 32 비트 값을 검색합니다.|  
|[CWindow::GetWindowLongPtr](#getwindowlongptr)|별도 창 메모리에 지정된 된 오프셋에 있는 값을 포함 하 여 지정 된 창에 대 한 정보를 검색 합니다.|  
...
|[CWindow::GetWindowThreadID](#getwindowthreadid)|지정 된 창을 만든 스레드 식별자를 검색 합니다.|  
...
|[CWindow::HiliteMenuItem](#hilitemenuitem)|강조 표시 하거나 최상위 메뉴 항목에서 강조 표시를 제거 합니다.|  
|[CWindow::Invalidate](#invalidate)|전체 클라이언트 영역을 무효화합니다.|  
|[CWindow::InvalidateRect](#invalidaterect)|지정된 된 사각형 내에서 클라이언트 영역을 무효화합니다.|  
|[CWindow::InvalidateRgn](#invalidatergn)|지정된 된 영역 내에서 클라이언트 영역을 무효화합니다.|  
|[CWindow::IsChild](#ischild)|지정된 된 창의 자식 창 인지 확인 합니다.|  
|[CWindow::IsDialogMessage](#isdialogmessage)|지정된 된 대화 상자는 메시지는 보내집니다 있는지 여부를 결정 합니다.|  
|[CWindow::IsDlgButtonChecked](#isdlgbuttonchecked)|단추의 선택 상태를 결정합니다.|  
|[CWindow::IsIconic](#isiconic)|창이 최소화 되 고 있는지 여부를 결정 합니다.|  
|[CWindow::IsParentDialog](#isparentdialog)|컨트롤의 부모 창 대화 상자 창 인지 여부를 확인 합니다.|  
|[CWindow::IsWindow](#iswindow)|지정된 된 창 핸들에는 기존 창을 식별 있는지 여부를 결정 합니다.|  
|[CWindow::IsWindowEnabled](#iswindowenabled)|입력에 사용 하는 창을 사용할 수 있는지 여부를 결정 합니다.|  
|[CWindow::IsWindowUnicode](#iswindowunicode)|지정된 된 창에 네이티브 유니코드 창 인지 확인 합니다.|  
...
|[CWindow::LockWindowUpdate](#lockwindowupdate)|선택 하거나 창에서 그리기를 사용 하도록 설정 합니다.|  
|[CWindow::MapWindowPoints](#mapwindowpoints)|점의 집합 창의 좌표 공간에서 다른 창의 좌표 공간으로 변환합니다.|  
...
|[CWindow::NextDlgCtrl](#nextdlgctrl)|대화 상자에서 다음 컨트롤로 키보드 포커스를 설정 합니다.|  
...
|[CWindow::PrevDlgCtrl](#prevdlgctrl)|대화 상자에서 이전 컨트롤로 키보드 포커스를 설정 합니다.|  
|[CWindow::Print](#print)|창이 지정된 된 장치 컨텍스트에에서 그려질 수 요청 수입니다.|  
|[CWindow::PrintClient](#printclient)|요청 창의 클라이언트 영역에 지정된 된 장치 컨텍스트에 그릴 수 있습니다.|  
|[CWindow::RedrawWindow](#redrawwindow)|지정 된 사각형 또는 클라이언트 영역에는 영역을 업데이트 합니다.|  
...
|[CWindow::ScrollWindowEx](#scrollwindowex)|추가 기능으로 지정 된 클라이언트 영역을 스크롤합니다.|  
|[CWindow::SendDlgItemMessage](#senddlgitemmessage)|컨트롤에 메시지를 보냅니다.|  
|[CWindow::SendMessage](#sendmessage)|창에 메시지를 보내고 창 프로시저에서 메시지를 처리할 때 까지는 반환 하지 않습니다.|  
|[CWindow::SendMessageToDescendants](#sendmessagetodescendants)|지정 된 하위 창에 메시지를 보냅니다.|  
|[CWindow::SendNotifyMessage](#sendnotifymessage)|창에 메시지를 보냅니다. 창을 호출 스레드에 의해 만들어진 경우 `SendNotifyMessage` 창 프로시저에서 메시지를 처리할 때 까지는 반환 하지 않습니다. 그렇지 않은 경우 그 즉시 반환 됩니다.|  
...
|[CWindow::SetDlgItemInt](#setdlgitemint)|컨트롤의 텍스트는 정수 값의 문자열 표현으로 변경합니다.|  
...
|[CWindow::SetWindowWord](#setwindowword)|별도 창 메모리에 지정된 된 오프셋에는 16 비트 값을 설정합니다.|  
|[CWindow::ShowCaret](#showcaret)|시스템 캐럿에 표시 됩니다.|  
|[CWindow::ShowOwnedPopups](#showownedpopups)|표시 하거나 창에서 소유 하 고 팝업 창을 숨깁니다.|  
|[CWindow::ShowScrollBar](#showscrollbar)|표시 하거나 스크롤 막대를 숨깁니다.|  
|[CWindow::ShowWindow](#showwindow)|창의 표시 상태를 설정합니다.|  
|[CWindow::ShowWindowAsync](#showwindowasync)|다른 스레드에서 만든 창 상태 표시를 설정 합니다.|  
|[CWindow::UpdateWindow](#updatewindow)|클라이언트 영역을 업데이트합니다.|  
|[CWindow::ValidateRect](#validaterect)|지정된 된 사각형 내에서 클라이언트 영역의 유효성을 검사 합니다.|  
|[CWindow::ValidateRgn](#validatergn)|지정된 된 영역 내에서 클라이언트 영역의 유효성을 검사 합니다.|  
...
## <a name="remarks"></a>설명  
 `CWindow` ATL에서 창 조작 하기 위한 기본 기능을 제공 합니다. 대부분의 `CWindow` Win32 API 함수 중 하나는 메서드 단순히 래핑합니다. 예를 들어 프로토타입이 비교 `CWindow::ShowWindow` 및 `ShowWindow`:  
  
|CWindow 메서드|Win32 함수|  
|--------------------|--------------------|  
|**BOOL ShowWindow (int** `nCmdShow` **);**|**BOOL ShowWindow (HWND** `hWnd` **, int** `nCmdShow` **);**|  
  
 `CWindow::ShowWindow` Win32 함수를 호출 `ShowWindow` 전달 하 여 `CWindow::m_hWnd` 첫 번째 매개 변수로 합니다. 모든 `CWindow` 직접 Win32 함수를 래핑하는 메서드는 전달 된 `m_hWnd` 멤버 이므로, 대부분의 `CWindow` 설명서 있습니다 Windows SDK를 참조 합니다.  
...
-   만들거나 하위 클래스에서 파생 된 다음 클래스 중 하나를 사용 하 여 `CWindow`:  
 ...
 [CWindowImpl](../../atl/reference/cwindowimpl-class.md) 용도로 새 창 또는 하위 클래스는 기존 창을 만들 수 있습니다.  
  
 [CContainedWindow](../../atl/reference/ccontainedwindowt-class.md) 다른 개체에 포함 된 창을 구현 합니다. 기존 창 용도로 새 창 또는 하위 클래스를 만들 수 있습니다.  
  
 [CDialogImpl](../../atl/reference/cdialogimpl-class.md) 모달 또는 모덜리스 대화 상자를 만들 수 있습니다.  
  
 기간에 대 한 자세한 내용은 참조 [Windows](http://msdn.microsoft.com/library/windows/desktop/ms632595) 및 Windows SDK의 후속 항목입니다. ATL에서 창 사용 하는 방법에 대 한 자세한 내용은 문서 참조 [ATL 창 클래스](../../atl/atl-window-classes.md)합니다.  
...
### <a name="remarks"></a>설명  
 참조 [ArrangeIconicWindows](http://msdn.microsoft.com/library/windows/desktop/ms632671) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [BeginPaint](http://msdn.microsoft.com/library/windows/desktop/dd183362) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [BringWindowToTop](http://msdn.microsoft.com/library/windows/desktop/ms632673) in the Windows SDK입니다.  
 ...
 **True 이면** 창이 성공적으로 가운데에 맞출지, 그렇지 않으면 **FALSE**합니다.  
...
### <a name="remarks"></a>설명  
 참조 [ChangeClipboardChain](http://msdn.microsoft.com/library/windows/desktop/ms649034) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [CheckDlgButton](http://msdn.microsoft.com/library/windows/desktop/bb761875) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [CheckRadioButton](http://msdn.microsoft.com/library/windows/desktop/bb761877) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [ChildWindowFromPoint](http://msdn.microsoft.com/library/windows/desktop/ms632676) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [ChildWindowFromPointEx](http://msdn.microsoft.com/library/windows/desktop/ms632677) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [ClientToScreen](http://msdn.microsoft.com/library/windows/desktop/dd183434) in the Windows SDK입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `rect`  
 [in] 형식의 변수 [_U_RECT](../../atl/reference/u-rect-class.md) 창의 위치를 지정 합니다. 기본값은 **NULL**합니다. 이 매개 변수가 **NULL**, 값 `CWindow::rcDefault` 사용 됩니다.  
  
 `szWindowName`  
 [in] 창 이름을 지정합니다. 기본값은 **NULL**합니다.  
  
 `dwStyle`  
 [in] 창 스타일입니다. 기본값은 0, 의미 없는 스타일 지정 됩니다. 가능한 값 목록은 참조 [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) Windows sdk에서입니다.  
  
 `dwExStyle`  
 [in] 확장된 창 스타일입니다. 기본값은 0, 의미 없는 확장된 스타일 지정 됩니다. 가능한 값 목록은 참조 하십시오. [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) Windows sdk에서입니다.  
...
### <a name="return-value"></a>반환 값  
 성공 하면 새로 만든된 창에 대 한 핸들에 지정 된 [m_hWnd](#m_hwnd)합니다. 그렇지 않으면 **NULL**합니다.  
  
### <a name="remarks"></a>설명  
 `CWindow::rcDefault` 로 정의 `__declspec(selectany) RECT CWindow::rcDefault = {CW_USEDEFAULT, CW_USEDEFAULT, 0, 0};`합니다.  
  
 참조 [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) 자세한 내용은 Windows sdk입니다.  
...
### <a name="remarks"></a>설명  
 참조 [CreateCaret](http://msdn.microsoft.com/library/windows/desktop/ms648399) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 초기화는 [m_hWnd](#m_hwnd) 멤버를 `hWnd`, 기본적으로 **NULL**합니다.  
  
> [!NOTE]
> `CWindow::CWindow` 창을 만들지 않습니다. 클래스 [CWindowImpl](../../atl/reference/cwindowimpl-class.md), [CContainedWindow](../../atl/reference/ccontainedwindowt-class.md), 및 [CDialogImpl](../../atl/reference/cdialogimpl-class.md) (에서 파생 되는 모두 `CWindow`) 되는 창 또는 대화 상자를 만드는 메서드를 제공 합니다. 그런 다음에 할당 `CWindow::m_hWnd`합니다. 사용할 수도 있습니다는 [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) Win32 함수입니다.  
  
##  <a name="deferwindowpos"></a>  CWindow::DeferWindowPos  
 지정된 된 창에 대 한 지정된 된 다중 창 위치 구조를 업데이트합니다.  
...
### <a name="remarks"></a>설명  
 참조 [DeferWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms632681) in the Windows SDK입니다.  
  
##  <a name="destroywindow"></a>  CWindow::DestroyWindow  
 와 관련 된 창을 제거는 `CWindow` 개체 및 집합 [m_hWnd](#m_hwnd) 를 **NULL**합니다.  
...
### <a name="remarks"></a>설명  
 참조 [DestroyWindow](http://msdn.microsoft.com/library/windows/desktop/ms632682) in the Windows SDK입니다.  
  
 삭제 되지 않습니다는 `CWindow` 개체 자체입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#5](../../atl/codesnippet/cpp/cwindow-class_5.cpp)]  
  
##  <a name="detach"></a>  CWindow::Detach  
 분리 [m_hWnd](#m_hwnd) 에서 `CWindow` 개체 및 집합 `m_hWnd` 를 **NULL**합니다.  
...
### <a name="remarks"></a>설명  
 참조 [DlgDirList](http://msdn.microsoft.com/library/windows/desktop/bb761366) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [DlgDirListComboBox](http://msdn.microsoft.com/library/windows/desktop/bb775935) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [DlgDirSelectEx](http://msdn.microsoft.com/library/windows/desktop/bb761368) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [DlgDirSelectComboBoxEx](http://msdn.microsoft.com/library/windows/desktop/bb775937) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [DragAcceptFiles](http://msdn.microsoft.com/library/windows/desktop/bb776406) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [DrawMenuBar](http://msdn.microsoft.com/library/windows/desktop/ms647633) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [EnableScrollBar](http://msdn.microsoft.com/library/windows/desktop/bb787579) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [EnableWindow](http://msdn.microsoft.com/library/windows/desktop/ms646291) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [EndPaint](http://msdn.microsoft.com/library/windows/desktop/dd162598) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [FlashWindow](http://msdn.microsoft.com/library/windows/desktop/ms679346) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetClientRect](http://msdn.microsoft.com/library/windows/desktop/ms633503) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetDC](http://msdn.microsoft.com/library/windows/desktop/dd144871) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetDCEx](http://msdn.microsoft.com/library/windows/desktop/dd144873) in the Windows SDK입니다.  
  
##  <a name="getdescendantwindow"></a>  CWindow::GetDescendantWindow  
 지정 된 id에서 지정한 하위 창을 찾습니다.  
...
### <a name="remarks"></a>설명  
 `GetDescendantWindow` 자식 창, 직접 자식인 창 뿐만 아니라 전체 형식 트리를 검색 합니다.  
  
##  <a name="getdlgcontrol"></a>  CWindow::GetDlgControl  
 합성 컨트롤 또는 컨트롤 호스팅 대화 상자에서 호스트 된 ActiveX 컨트롤의 인터페이스에 대 한 포인터를 가져오려면이 함수를 호출 합니다.  
...
### <a name="parameters"></a>매개 변수  
 `nID`  
 [in] 검색 하는 컨트롤의 리소스 ID입니다.  
  
 `iid`  
 [in] 컨트롤에서 원하는 인터페이스의 ID입니다.  
  
 *ppCtrl*  
 [out] 인터페이스 포인터입니다.  
  
### <a name="return-value"></a>반환 값  
 반환 `S_OK` 성공 또는 유효한 모든 오류에 `HRESULT`합니다. 예를 들어, 함수 반환 **E_FAIL** 변수로 지정 된 컨트롤 `nID` 찾을 수 없습니다 반환 **E_NOINTERFACE** 컨트롤을 찾을 수 있지만 인터페이스를 지원 하지 않는 경우 에 지정 된 `iid`합니다.  
  
### <a name="remarks"></a>설명  
 이 포인터를 사용 하 여 인터페이스에서 메서드를 호출할 수 있습니다.  
  
##  <a name="getdlgctrlid"></a>  CWindow::GetDlgCtrlID  
 창의 식별자 (자식 창에만 해당)에 대 한 검색합니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetDlgCtrlID](http://msdn.microsoft.com/library/windows/desktop/ms645478) in the Windows SDK입니다.  
...
### <a name="return-value"></a>반환 값  
 반환 `S_OK` 변수로 지정 된 창 `iid` 컨트롤 컨테이너 이며 요청된 된 인터페이스를 검색할 수 없습니다. 반환 **E_FAIL** 컨트롤 컨테이너 아닙니다 또는 요청 된 인터페이스를 검색할 수 없습니다. 지정한 ID 가진 창을 찾을 수 없습니다, 하는 경우 반환 값은 HRESULT_FROM_WIN32(ERROR_CONTROL_ID_NOT_FOUND) 같음.  
...
### <a name="remarks"></a>설명  
 참조 [GetDlgItem](http://msdn.microsoft.com/library/windows/desktop/ms645481) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetDlgItemInt](http://msdn.microsoft.com/library/windows/desktop/ms645485) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetDlgItemText](http://msdn.microsoft.com/library/windows/desktop/ms645489) in the Windows SDK입니다.  
  
### <a name="remarks"></a>설명  
 이 메서드의 두 번째 버전을 사용 하면 컨트롤의 텍스트를 복사할 수 있습니다는 `BSTR`합니다. 이 버전 반환 **TRUE** 성공적으로 복사한 고, 그러지 않으면 텍스트가 있으면 **FALSE**합니다.  
...
##  <a name="getfont"></a>  CWindow::GetFont  
 창의 현재 글꼴을 전송 하 여 검색 한 [WM_GETFONT](http://msdn.microsoft.com/library/windows/desktop/ms632624) 창에 메시지입니다.  
...
### <a name="return-value"></a>반환 값  
 가상 키 코드 및 해당 창과 연결 된 바로 가기 키에 대 한 한정자입니다. 목록이 가능한 한정자에 대 한 참조 [WM_GETHOTKEY](http://msdn.microsoft.com/library/windows/desktop/ms646278) Windows sdk에서입니다. 표준 가상 키 코드의 목록, Winuser.h을 참조 하세요.  
...
### <a name="remarks"></a>설명  
 `GetIcon` 보냅니다는 [WM_GETICON](http://msdn.microsoft.com/library/windows/desktop/ms632625) 창에 메시지입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetLastActivePopup](http://msdn.microsoft.com/library/windows/desktop/ms633507) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetMenu](http://msdn.microsoft.com/library/windows/desktop/ms647640) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetNextDlgGroupItem](http://msdn.microsoft.com/library/windows/desktop/ms645492) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetNextDlgTabItem](http://msdn.microsoft.com/library/windows/desktop/ms645495) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetParent](http://msdn.microsoft.com/library/windows/desktop/ms633510) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetScrollInfo](http://msdn.microsoft.com/library/windows/desktop/bb787583) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetScrollPos](http://msdn.microsoft.com/library/windows/desktop/bb787585) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetScrollRange](http://msdn.microsoft.com/library/windows/desktop/bb787587) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetSystemMenu](http://msdn.microsoft.com/library/windows/desktop/ms647985) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetTopWindow](http://msdn.microsoft.com/library/windows/desktop/ms633514) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetUpdateRect](http://msdn.microsoft.com/library/windows/desktop/dd144943) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetUpdateRgn](http://msdn.microsoft.com/library/windows/desktop/dd144944) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 `GetWindow` in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowContextHelpId](http://msdn.microsoft.com/library/windows/desktop/bb776429) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowDC](http://msdn.microsoft.com/library/windows/desktop/dd144947) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#14](../../atl/codesnippet/cpp/cwindow-class_14.cpp)]  
  
##  <a name="getwindowlong"></a>  CWindow::GetWindowLong  
 별도 창 메모리에 지정된 된 오프셋에서 32 비트 값을 검색합니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowLong](http://msdn.microsoft.com/library/windows/desktop/ms633584) in the Windows SDK입니다.  
  
> [!NOTE]
>  32 비트 및 64 비트 버전의 Windows와 호환 되는 코드를 작성 하려면 사용 하 여 [CWindow::GetWindowLongPtr](#getwindowlongptr)합니다.  
  
##  <a name="getwindowlongptr"></a>  CWindow::GetWindowLongPtr  
 별도 창 메모리에 지정된 된 오프셋에 있는 값을 포함 하 여 지정 된 창에 대 한 정보를 검색 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowLongPtr](http://msdn.microsoft.com/library/windows/desktop/ms633585) in the Windows SDK입니다.  
  
### <a name="remarks"></a>설명  
 이 함수를 대체 한 포인터 또는 핸들을 검색 하는 경우는 `CWindow::GetWindowLong` 메서드.  
  
> [!NOTE]
>  포인터와 핸들은 32 비트 Windows와 64 비트 windows 64 비트 32 비트입니다.  
  
 32 비트 및 64 비트 버전의 Windows와 호환 되는 코드를 작성 하려면 사용 하 여 `CWindow::GetWindowLongPtr`합니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowPlacement](http://msdn.microsoft.com/library/windows/desktop/ms633518) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowThreadProcessID](http://msdn.microsoft.com/library/windows/desktop/ms633522) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowRect](http://msdn.microsoft.com/library/windows/desktop/ms633519) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowRgn](http://msdn.microsoft.com/library/windows/desktop/dd144950) in the Windows SDK입니다.  
...
### <a name="return-value"></a>반환 값  
 텍스트는 성공적으로 복사 하는 경우 반환 값은 **TRUE**, 그렇지 않으면 반환 값은 **FALSE**합니다.  
  
### <a name="remarks"></a>설명  
 참조 [GetWindowText](http://msdn.microsoft.com/library/windows/desktop/ms633520) in the Windows SDK입니다.  
  
 이 메서드의 두 번째 버전을 사용 하면 텍스트에 저장할 수 있습니다는 `BSTR`; 세 번째 버전을 사용 하면에 결과 저장할 수 있습니다는 [CString](../../atl-mfc-shared/reference/cstringt-class.md), 이후 `CSimpleString` 의 기본 클래스의 `CString`합니다.  
...
### <a name="remarks"></a>설명  
 참조 [GetWindowTextLength](http://msdn.microsoft.com/library/windows/desktop/ms633521) in the Windows SDK입니다.  
  
##  <a name="getwindowthreadid"></a>  CWindow::GetWindowThreadID  
 지정 된 창을 만든 스레드 식별자를 검색 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [WM_NEXTDLGCTL](http://msdn.microsoft.com/library/windows/desktop/ms645432) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [HideCaret](http://msdn.microsoft.com/library/windows/desktop/ms648403) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#17](../../atl/codesnippet/cpp/cwindow-class_17.cpp)]  
  
##  <a name="hilitemenuitem"></a>  CWindow::HiliteMenuItem  
 강조 표시 하거나 최상위 메뉴 항목에서 강조 표시를 제거 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [HiliteMenuItem](http://msdn.microsoft.com/library/windows/desktop/ms647986) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [InvalidateRect](http://msdn.microsoft.com/library/windows/desktop/dd145002) in the Windows SDK입니다.  
...
##  <a name="invalidaterect"></a>  CWindow::InvalidateRect  
 지정된 된 사각형 내에서 클라이언트 영역을 무효화합니다.  
...
### <a name="remarks"></a>설명  
 참조 [InvalidateRgn](http://msdn.microsoft.com/library/windows/desktop/dd145003) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsChild](http://msdn.microsoft.com/library/windows/desktop/ms633524) in the Windows SDK입니다.  
  
##  <a name="isdialogmessage"></a>  CWindow::IsDialogMessage  
 지정된 된 대화 상자는 메시지는 보내집니다 있는지 여부를 결정 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [이전과](http://msdn.microsoft.com/library/windows/desktop/ms645498) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsDlgButtonChecked](http://msdn.microsoft.com/library/windows/desktop/bb761879) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsIconic](http://msdn.microsoft.com/library/windows/desktop/ms633527) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#19](../../atl/codesnippet/cpp/cwindow-class_19.cpp)]  
  
##  <a name="isparentdialog"></a>  CWindow::IsParentDialog  
 컨트롤의 부모 창 대화 상자 창 인지 여부를 확인 합니다.  
...
### <a name="return-value"></a>반환 값  
 TRUE를 반환 하는 경우 부모 창 대화 상자에서 false를 반환 하지 않으면 합니다.  
  
##  <a name="iswindow"></a>  CWindow::IsWindow  
 지정된 된 창 핸들에는 기존 창을 식별 있는지 여부를 결정 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsWindow](http://msdn.microsoft.com/library/windows/desktop/ms633528) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#20](../../atl/codesnippet/cpp/cwindow-class_20.cpp)]  
  
##  <a name="iswindowenabled"></a>  CWindow::IsWindowEnabled  
 입력에 사용 하는 창을 사용할 수 있는지 여부를 결정 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsWindowEnabled](http://msdn.microsoft.com/library/windows/desktop/ms646303) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsWindowVisible](http://msdn.microsoft.com/library/windows/desktop/ms633530) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#22](../../atl/codesnippet/cpp/cwindow-class_22.cpp)]  
  
##  <a name="iswindowunicode"></a>  CWindow::IsWindowUnicode  
 지정된 된 창에 네이티브 유니코드 창 인지 확인 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsWindowUnicode](http://msdn.microsoft.com/library/windows/desktop/ms633529) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [IsZoomed](http://msdn.microsoft.com/library/windows/desktop/ms633531) in the Windows SDK입니다.  
  
##  <a name="killtimer"></a>  CWindow::KillTimer  
 만든 타이머 이벤트 소멸 `CWindow::SetTimer`합니다.  
...
### <a name="remarks"></a>설명  
 참조 [KillTimer](http://msdn.microsoft.com/library/windows/desktop/ms644903) in the Windows SDK입니다.  
  
##  <a name="lockwindowupdate"></a>  CWindow::LockWindowUpdate  
 선택 하거나 호출 하 여 창의 그리기는 [LockWindowUpdate](http://msdn.microsoft.com/library/windows/desktop/dd145034) Win32 함수입니다.  
...
### <a name="return-value"></a>반환 값  
 **True 이면** 창이 잠긴 않으면 고, 그렇지 않으면 **FALSE**합니다.  
  
### <a name="remarks"></a>설명  
 경우 `bLock` 은 **TRUE**,이 메서드는 전달 [m_hWnd](#m_hwnd) Win32 함수; 그렇지 않으면 전달 **NULL**합니다.  
...
##  <a name="mapwindowpoints"></a>  CWindow::MapWindowPoints  
 점의 집합 창의 좌표 공간에서 다른 창의 좌표 공간으로 변환합니다.  
...
### <a name="remarks"></a>설명  
 참조 [MapWindowPoints](http://msdn.microsoft.com/library/windows/desktop/dd145046) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [MessageBox](http://msdn.microsoft.com/library/windows/desktop/ms645505) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#24](../../atl/codesnippet/cpp/cwindow-class_24.cpp)]  
  
##  <a name="modifystyle"></a>  CWindow::ModifyStyle  
 창 스타일의 수정 된 `CWindow` 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `nFlags`  
 [in] 창 위치 지정 하는 플래그입니다. 목록이 가능한 값에 대 한 참조는 [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) Windows SDK에는 함수입니다.  
  
### <a name="return-value"></a>반환 값  
 **True 이면** 창 스타일 되 고, 그러지 않으면 수정 된 경우 **FALSE**합니다.  
  
### <a name="remarks"></a>설명  
 비트 OR를 사용 하 여 추가 또는 제거 하기 위해 스타일을 결합할 수 있습니다 ( &#124; ) 연산자. 참조는 [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) 사용 가능한 창 스타일에 대 한 Windows SDKfor 정보에는 함수입니다.  
...
### <a name="return-value"></a>반환 값  
 **True 이면** 확장된 창 스타일 되 고, 그러지 않으면 수정 된 경우 **FALSE**합니다.  
  
### <a name="remarks"></a>설명  
 비트 OR를 사용 하 여 추가 또는 제거 하기 위해 스타일을 결합할 수 있습니다 ( &#124; ) 연산자. 참조는 [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) 함수에서 사용할 수 있는 확장 스타일에 대 한 Windows SDKfor 정보입니다.  
...
### <a name="remarks"></a>설명  
 최상위 창 개체는 x와 y 매개 변수는 화면의 왼쪽 위 모퉁이 기준으로 합니다. 자식 창 개체에 대 한 부모 창의 클라이언트 영역의 왼쪽 위 모퉁이 기준으로 서로입니다.  
...
##  <a name="nextdlgctrl"></a>  CWindow::NextDlgCtrl  
 대화 상자에서 다음 컨트롤로 키보드 포커스를 설정 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [OpenClipboard](http://msdn.microsoft.com/library/windows/desktop/ms649048) in the Windows SDK입니다.  
...
##  <a name="operator_eq"></a>  CWindow::operator =  
 할당 된 `HWND` 에 `CWindow` 설정 하 여 개체는 [m_hWnd](#m_hwnd) 멤버를 `hWnd`합니다.  
...
### <a name="remarks"></a>설명  
 참조 [PostMessage](http://msdn.microsoft.com/library/windows/desktop/ms644944) in the Windows SDK입니다.  
...
##  <a name="prevdlgctrl"></a>  CWindow::PrevDlgCtrl  
 대화 상자에서 이전 컨트롤로 키보드 포커스를 설정 합니다.  
...
##  <a name="print"></a>  CWindow::Print  
 보냅니다는 [WM_PRINT](http://msdn.microsoft.com/library/windows/desktop/dd145216) 창에 메시지를 지정된 된 디바이스 컨텍스트에서 자체 그리기 것을 요청 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `dwFlags`  
 [in] 드로잉 옵션을 지정합니다. 다음과 같은 플래그 중 하나 이상을 조합할 수 있습니다.  
...
##  <a name="printclient"></a>  CWindow::PrintClient  
 보냅니다는 [WM_PRINTCLIENT](http://msdn.microsoft.com/library/windows/desktop/dd145217) 창에 메시지를 지정된 된 디바이스 컨텍스트에서의 클라이언트 영역을 그리는 것을 요청 합니다.  
...
##  <a name="redrawwindow"></a>  CWindow::RedrawWindow  
 지정 된 사각형 또는 클라이언트 영역에는 영역을 업데이트 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [RedrawWindow](http://msdn.microsoft.com/library/windows/desktop/dd162911) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [ReleaseDC](http://msdn.microsoft.com/library/windows/desktop/dd162920) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#9](../../atl/codesnippet/cpp/cwindow-class_9.cpp)]  
  
##  <a name="resizeclient"></a>  CWindow::ResizeClient  
 지정 된 클라이언트 영역 크기를 창의 크기를 조정 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `bRedraw`  
 변경 내용을 다시 그릴 것인지를 나타내는 플래그입니다. 기본값은 **FALSE**, 창을 나타내는 변경 그려지지 않습니다.  
...
### <a name="remarks"></a>설명  
 참조 [ScreenToClient](http://msdn.microsoft.com/library/windows/desktop/dd162952) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [ScrollWindow](http://msdn.microsoft.com/library/windows/desktop/bb787591) in the Windows SDK입니다.  
  
##  <a name="scrollwindowex"></a>  CWindow::ScrollWindowEx  
 추가 기능으로 지정 된 클라이언트 영역을 스크롤합니다.  
...
### <a name="remarks"></a>설명  
 참조 [ScrollWindowEx](http://msdn.microsoft.com/library/windows/desktop/bb787593) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SendDlgItemMessage](http://msdn.microsoft.com/library/windows/desktop/ms645515) in the Windows SDK입니다.  
  
##  <a name="sendmessage"></a>  CWindow::SendMessage  
 창에 메시지를 보내고 창 프로시저에서 메시지를 처리할 때 까지는 반환 하지 않습니다.  
...
### <a name="remarks"></a>설명  
 참조 [SendMessage](http://msdn.microsoft.com/library/windows/desktop/ms644950) in the Windows SDK입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `bDeep`  
 [in] 경우 **TRUE** (기본값) 모든 하위 창에 메시지를 보낼 수는 않으며 직계 자식 창에만 그렇지 않은 경우 전송 됩니다.  
  
### <a name="remarks"></a>설명  
 경우 `bDeep` 은 **TRUE**, 메시지는 또한 다른 모든 하위 창에 보내집니다.  
...
### <a name="remarks"></a>설명  
 참조 [SendNotifyMessage](http://msdn.microsoft.com/library/windows/desktop/ms644953) in the Windows SDK입니다.  
  
 창을 호출 스레드에 의해 만들어진 경우 `SendNotifyMessage` 창 프로시저에서 메시지를 처리할 때 까지는 반환 하지 않습니다. 그렇지 않은 경우 그 즉시 반환 됩니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetActiveWindow](http://msdn.microsoft.com/library/windows/desktop/ms646311) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#30](../../atl/codesnippet/cpp/cwindow-class_30.cpp)]  
  
##  <a name="setcapture"></a>  CWindow::SetCapture  
 창에 대 한 모든 후속 마우스 입력을 보냅니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetCapture](http://msdn.microsoft.com/library/windows/desktop/ms646262) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetClipboardViewer](http://msdn.microsoft.com/library/windows/desktop/ms649052) in the Windows SDK입니다.  
  
##  <a name="setdlgctrlid"></a>  CWindow::SetDlgCtrlID  
 창의 식별자 지정된 된 값으로 설정합니다.  
...
### <a name="return-value"></a>반환 값  
 성공 하면 창;의 이전 식별자 그렇지 않으면 0입니다.  
  
##  <a name="setdlgitemint"></a>  CWindow::SetDlgItemInt  
 컨트롤의 텍스트는 정수 값의 문자열 표현으로 변경합니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetDlgItemInt](http://msdn.microsoft.com/library/windows/desktop/ms645518) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetDlgItemText](http://msdn.microsoft.com/library/windows/desktop/ms645521) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetFocus](http://msdn.microsoft.com/library/windows/desktop/ms646312) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#31](../../atl/codesnippet/cpp/cwindow-class_31.cpp)]  
  
##  <a name="setfont"></a>  CWindow::SetFont  
 창의 현재 글꼴을 전송 하 여 변경 된 [WM_SETFONT](http://msdn.microsoft.com/library/windows/desktop/ms632642) 창에 메시지를 합니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `bRedraw`  
 [in] 경우 **TRUE** (기본값) 창을 다시 그려집니다. 그렇지 않은 경우는 없습니다.  
  
##  <a name="sethotkey"></a>  CWindow::SetHotKey  
 바로 가기 키를 전송 하 여 창을 사용 하 여 연결 된 **WM_SETHOTKEY** 메시지입니다.  
...
### <a name="parameters"></a>매개 변수  
 `wVirtualKeyCode`  
 [in] 바로 가기 키의 가상 키 코드입니다. 표준 가상 키 코드의 목록, Winuser.h을 참조 하세요.  
  
 `wModifiers`  
 [in] 바로 가기 키의 한정자입니다. 가능한 값 목록은 참조 **WM_SETHOTKEY** Windows sdk에서입니다.  
  
### <a name="return-value"></a>반환 값  
 가능한 목록에 대 한 반환 값, 참조 [WM_SETHOTKEY](http://msdn.microsoft.com/library/windows/desktop/ms646284) Windows sdk에서입니다.  
...
### <a name="parameters"></a>매개 변수  
 ...
 `bBigIcon`  
 [in] 경우 **TRUE** 메서드 큰 아이콘을 설정 (기본값). 그렇지 않으면 작은 아이콘을 설정 합니다.  
  
### <a name="return-value"></a>반환 값  
 이전 아이콘에 대 한 핸들입니다.  
  
### <a name="remarks"></a>설명  
 `SetIcon` 보냅니다는 [WM_SETICON](http://msdn.microsoft.com/library/windows/desktop/ms632643) 창에 메시지입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetMenu](http://msdn.microsoft.com/library/windows/desktop/ms647995) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetParent](http://msdn.microsoft.com/library/windows/desktop/ms633541) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#32](../../atl/codesnippet/cpp/cwindow-class_32.cpp)]  
  
##  <a name="setredraw"></a>  CWindow::SetRedraw  
 설정 하거나 전송 하 여 다시 그리기 플래그를 해제 한 [WM_SETREDRAW](http://msdn.microsoft.com/library/windows/desktop/dd145219) 창에 메시지입니다.  
...
### <a name="parameters"></a>매개 변수  
 `bRedraw`  
 [in] 다시 그리기 플래그의 상태를 지정합니다. 경우 **TRUE** (기본값)는 다시 그리기 플래그가 설정 되어; 경우 **FALSE**, 플래그가 지워집니다.  
  
### <a name="remarks"></a>설명  
 호출 `SetRedraw` 대 한 변경 내용을 다시 그릴 없도록 변동을 방지할 수 있도록 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetScrollInfo](http://msdn.microsoft.com/library/windows/desktop/bb787595) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetScrollPos](http://msdn.microsoft.com/library/windows/desktop/bb787597) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetScrollRange](http://msdn.microsoft.com/library/windows/desktop/bb787599) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetTimer](http://msdn.microsoft.com/library/windows/desktop/ms644906) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetWindowContextHelpId](http://msdn.microsoft.com/library/windows/desktop/bb762101) in the Windows SDK입니다.  
  
##  <a name="setwindowlong"></a>  CWindow::SetWindowLong  
 별도 창 메모리에 지정된 된 오프셋에는 32 비트 값을 설정합니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetWindowLong](http://msdn.microsoft.com/library/windows/desktop/ms633591) in the Windows SDK입니다.  
  
> [!NOTE]
>  32 비트 및 64 비트 버전의 Windows와 호환 되는 코드를 작성 하려면 사용 하 여 [CWindow::SetWindowLongPtr](#setwindowlongptr)합니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetWindowLongPtr](http://msdn.microsoft.com/library/windows/desktop/ms644898) in the Windows SDK입니다.  
  
 이 함수를 대체는 `CWindow::SetWindowLong` 메서드. 32 비트 및 64 비트 버전의 Windows와 호환 되는 코드를 작성 하려면 사용 하 여 `CWindow::SetWindowLongPtr`합니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetWindowPlacement](http://msdn.microsoft.com/library/windows/desktop/ms633544) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetWindowRgn](http://msdn.microsoft.com/library/windows/desktop/dd145102) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [SetWindowText](http://msdn.microsoft.com/library/windows/desktop/ms633546) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#34](../../atl/codesnippet/cpp/cwindow-class_34.cpp)]  
  
##  <a name="setwindowword"></a>  CWindow::SetWindowWord  
 별도 창 메모리에 지정된 된 오프셋에는 16 비트 값을 설정합니다.  
...
### <a name="remarks"></a>설명  
 참조 [ShowCaret](http://msdn.microsoft.com/library/windows/desktop/ms648406) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#35](../../atl/codesnippet/cpp/cwindow-class_35.cpp)]  
  
##  <a name="showownedpopups"></a>  CWindow::ShowOwnedPopups  
 표시 하거나 창에서 소유 하 고 팝업 창을 숨깁니다.  
...
### <a name="remarks"></a>설명  
 참조 [ShowOwnedPopups](http://msdn.microsoft.com/library/windows/desktop/ms633547) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [ShowScrollBar](http://msdn.microsoft.com/library/windows/desktop/bb787601) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [ShowWindow](http://msdn.microsoft.com/library/windows/desktop/ms633548) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#36](../../atl/codesnippet/cpp/cwindow-class_36.cpp)]  
  
##  <a name="showwindowasync"></a>  CWindow::ShowWindowAsync  
 다른 스레드에서 만든 창 상태 표시를 설정 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [ShowWindowAsync](http://msdn.microsoft.com/library/windows/desktop/ms633549) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [UpdateWindow](http://msdn.microsoft.com/library/windows/desktop/dd145167) in the Windows SDK입니다.  
  
### <a name="example"></a>예제  
 [!code-cpp[NVC_ATL_Windowing#37](../../atl/codesnippet/cpp/cwindow-class_37.cpp)]  
  
##  <a name="validaterect"></a>  CWindow::ValidateRect  
 지정된 된 사각형 내에서 클라이언트 영역의 유효성을 검사 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [ValidateRect](http://msdn.microsoft.com/library/windows/desktop/dd145194) in the Windows SDK입니다.  
  
##  <a name="validatergn"></a>  CWindow::ValidateRgn  
 지정된 된 영역 내에서 클라이언트 영역의 유효성을 검사 합니다.  
...
### <a name="remarks"></a>설명  
 참조 [ValidateRgn](http://msdn.microsoft.com/library/windows/desktop/dd145195) in the Windows SDK입니다.  
...
### <a name="remarks"></a>설명  
 참조 [WinHelp](http://msdn.microsoft.com/library/windows/desktop/bb762267) in the Windows SDK입니다.  
