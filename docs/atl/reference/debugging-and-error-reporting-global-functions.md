...
### <a name="remarks"></a>설명  
 ...
 경우 **_ATL_NO_EXCEPTIONS** 정의 되어 있지 않습니다는 MFC 프로젝트에서이 함수를 throw 하는 [CMemoryException](../../mfc/reference/cmemoryexception-class.md) 또는 [COleException](../../mfc/reference/coleexception-class.md) 에서반환된값에따라`GetLastError`.  
