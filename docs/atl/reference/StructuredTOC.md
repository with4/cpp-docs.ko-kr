...
# <a name="atl-typedefsatl-typedefsmd"></a>[ATL Typedefs](atl-typedefs.md)
...
## <a name="compiler-options-macroscompiler-options-macrosmd"></a>[컴파일러 옵션 매크로](compiler-options-macros.md)
## <a name="composite-control-macroscomposite-control-macrosmd"></a>[복합 컨트롤 매크로](composite-control-macros.md)
...
## <a name="ccomcriticalsection-classccomcriticalsection-classmd"></a>[CComCriticalSection 클래스](ccomcriticalsection-class.md)
...
## <a name="cwintraits-classcwintraits-classmd"></a>[CWinTraits 클래스](cwintraits-class.md)
...
## <a name="atl-text-encoding-functionsatl-text-encoding-functionsmd"></a>[ATL 텍스트 인코딩 함수](atl-text-encoding-functions.md)
## <a name="com-map-global-functionscom-map-global-functionsmd"></a>[COM 맵 전역 함수](com-map-global-functions.md)
## <a name="composite-control-global-functionscomposite-control-global-functionsmd"></a>[복합 컨트롤 전역 함수](composite-control-global-functions.md)
...
## <a name="debugging-and-error-reporting-global-functionsdebugging-and-error-reporting-global-functionsmd"></a>[디버깅 및 오류 보고 전역 함수](debugging-and-error-reporting-global-functions.md)
## <a name="event-handling-global-functionsevent-handling-global-functionsmd"></a>[이벤트 처리 전역 함수](event-handling-global-functions.md)
...
## <a name="atlbasemodule70-structureatl-base-module70-structuremd"></a>[_ATL_BASE_MODULE70 구조체](atl-base-module70-structure.md)
## <a name="atlcommodule70-structureatl-com-module70-structuremd"></a>[_ATL_COM_MODULE70 구조체](atl-com-module70-structure.md)
## <a name="atlfuncinfo-structureatl-func-info-structuremd"></a>[_ATL_FUNC_INFO 구조체](atl-func-info-structure.md)
## <a name="atlmodule70-structureatl-module70-structuremd"></a>[_ATL_MODULE70 구조체](atl-module70-structure.md)
## <a name="atlwinmodule70-structureatl-win-module70-structuremd"></a>[_ATL_WIN_MODULE70 구조체](atl-win-module70-structure.md)
# <a name="atl-archetypesatl-archetypesmd"></a>[ATL 아키타](atl-archetypes.md)
## <a name="worker-archetypeworker-archetypemd"></a>[Worker 원형](worker-archetype.md)
# <a name="atl-wizards-and-dialog-boxesatl-wizards-and-dialog-boxesmd"></a>[ATL 마법사 및 대화 상자](atl-wizards-and-dialog-boxes.md)
...
#### <a name="application-settings-atl-project-wizardapplication-settings-atl-project-wizardmd"></a>[응용 프로그램 설정, ATL 프로젝트 마법사](application-settings-atl-project-wizard.md)
...
### <a name="mfc-support-in-atl-projectsmfc-support-in-atl-projectsmd"></a>[ATL 프로젝트의 MFC 지원](mfc-support-in-atl-projects.md)
### <a name="com-10-support-in-atl-projectscom-plus-1-0-support-in-atl-projectsmd"></a>[ATL 프로젝트의 COM+ 1.0 지원](com-plus-1-0-support-in-atl-projects.md)
...
### <a name="specifying-compiler-optimization-for-an-atl-projectspecifying-compiler-optimization-for-an-atl-projectmd"></a>[ATL 프로젝트에 대해 컴파일러 최적화 지정](specifying-compiler-optimization-for-an-atl-project.md)
### <a name="adding-a-new-interface-in-an-atl-projectadding-a-new-interface-in-an-atl-projectmd"></a>[ATL 프로젝트에 새 인터페이스 추가](adding-a-new-interface-in-an-atl-project.md)
### <a name="making-an-atl-object-noncreatablemaking-an-atl-object-noncreatablemd"></a>[ATL 개체를 Noncreatable로 설정](making-an-atl-object-noncreatable.md)
## <a name="adding-an-atl-simple-objectadding-an-atl-simple-objectmd"></a>[ATL 단순 개체 추가](adding-an-atl-simple-object.md)
### <a name="atl-simple-object-wizardatl-simple-object-wizardmd"></a>[ATL 단순 개체 마법사](atl-simple-object-wizard.md)
#### <a name="options-atl-simple-object-wizardoptions-atl-simple-object-wizardmd"></a>[옵션, ATL 단순 개체 마법사](options-atl-simple-object-wizard.md)
## <a name="adding-an-atl-property-pageadding-an-atl-property-pagemd"></a>[ATL 속성 페이지 추가](adding-an-atl-property-page.md)
### <a name="atl-property-page-wizardatl-property-page-wizardmd"></a>[ATL 속성 페이지 마법사](atl-property-page-wizard.md)
#### <a name="options-atl-property-page-wizardoptions-atl-property-page-wizardmd"></a>[옵션, ATL 속성 페이지 마법사](options-atl-property-page-wizard.md)
...
## <a name="adding-an-atl-ole-db-provideradding-an-atl-ole-db-providermd"></a>[ATL OLE DB 공급자 추가](adding-an-atl-ole-db-provider.md)
...
## <a name="adding-an-atl-dialog-boxadding-an-atl-dialog-boxmd"></a>[ATL 대화 상자 추가](adding-an-atl-dialog-box.md)
### <a name="atl-dialog-wizardatl-dialog-wizardmd"></a>[ATL 대화 상자 마법사](atl-dialog-wizard.md)
...
#### <a name="options-atl-control-wizardoptions-atl-control-wizardmd"></a>[옵션, ATL 컨트롤 마법사](options-atl-control-wizard.md)
#### <a name="interfaces-atl-control-wizardinterfaces-atl-control-wizardmd"></a>[ATL 컨트롤 마법사, 인터페이스](interfaces-atl-control-wizard.md)
#### <a name="appearance-atl-control-wizardappearance-atl-control-wizardmd"></a>[모양, ATL 컨트롤 마법사](appearance-atl-control-wizard.md)
#### <a name="stock-properties-atl-control-wizardstock-properties-atl-control-wizardmd"></a>[스톡 속성, ATL 컨트롤 마법사](stock-properties-atl-control-wizard.md)
## <a name="adding-an-atl-com-10-componentadding-an-atl-com-plus-1-0-componentmd"></a>[ATL COM+ 1.0 구성 요소 추가](adding-an-atl-com-plus-1-0-component.md)
...
## <a name="adding-an-atl-active-server-page-componentadding-an-atl-active-server-page-componentmd"></a>[ATL Active Server Page 구성 요소 추가](adding-an-atl-active-server-page-component.md)
### <a name="atl-active-server-page-component-wizardatl-active-server-page-component-wizardmd"></a>[ATL Active Server Page 구성 요소 마법사](atl-active-server-page-component-wizard.md)
### <a name="options-atl-active-server-page-component-wizardoptions-atl-active-server-page-component-wizardmd"></a>[옵션, ATL Active Server Page 구성 요소 마법사](options-atl-active-server-page-component-wizard.md)
### <a name="asp-atl-active-server-page-component-wizardasp-atl-active-server-page-component-wizardmd"></a>[ASP, ATL Active Server Page 구성 요소 마법사](asp-atl-active-server-page-component-wizard.md)
