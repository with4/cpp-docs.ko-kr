...
#### <a name="parameters"></a>매개 변수  
 ...
 두 단계로 분리 인터페이스를 구현 하는 ATL-는 `CComTearOffObjectBase` 메서드는 참조 횟수를 처리 하 고 `QueryInterface`, 동안 `CComTearOffObject` 구현 [IUnknown](http://msdn.microsoft.com/library/windows/desktop/ms680509)합니다.  
...
|[CComTearOffObject::QueryInterface](#queryinterface)|분리 클래스 또는 소유자 클래스 중 하나에서 요청된 된 인터페이스에 대 한 포인터를 반환합니다.|  
