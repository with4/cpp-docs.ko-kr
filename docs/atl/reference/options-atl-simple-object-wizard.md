...
|옵션|설명|  
|------------|-----------------|  
|**Single**|개체가 기본 COM 스레드에서만에서 항상 실행 되도록 지정 합니다. 참조 [단일 스레드 아파트](http://msdn.microsoft.com/library/windows/desktop/ms680112) 하 고 [InprocServer32](http://msdn.microsoft.com/library/windows/desktop/ms682390) 자세한 내용은 합니다.|  
