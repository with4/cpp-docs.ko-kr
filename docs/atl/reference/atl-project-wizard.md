---
title: "ATL 프로젝트 마법사 | Microsoft 문서"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
액티브 템플릿 라이브러리 (ATL)은 작고 빠른 COM 개체 작성을 단순화 하는 템플릿 기반 c + + 클래스의 집합. ATL 프로젝트 마법사는 COM 개체를 포함 하는 구조와 프로젝트를 만듭니다.  
  
## <a name="overview"></a>개요  
 이 마법사 페이지에서는 현재 [ATL 프로젝트에 대 한 응용 프로그램 설정을](../../atl/reference/application-settings-atl-project-wizard.md) 만들어집니다. 기본적으로 프로젝트에는 다음 설정이 있습니다.  
  
-   동적 연결 라이브러리 서버에는 DLL 및 in-process 서버 임을 지정 합니다.  
  
-   프로젝트 특성을 사용 하는 특성 사용된 하도록 지정 합니다.  
  
 이러한 기본값을 변경 하려면 클릭 **응용 프로그램 설정** ATL 프로젝트 마법사의 해당 페이지에서 마법사 및 구성 변경의 왼쪽된 열에 있습니다.  
  
 기본 프로젝트 설정에 대 한 내용은 문자 집합 선택을 비롯 한 기본값, 링크 및 참조 [기본 ATL 프로젝트 구성](../../atl/reference/default-atl-project-configurations.md)합니다.  
...
-   [ATL 프로젝트에 COM + 1.0 구성 요소를 추가 합니다.](../../atl/reference/adding-an-atl-com-plus-1-0-component.md)  
 ...
 또한 ATL 프로젝트를 만들고 다음이 작업을 고려 합니다.  
...
-   [ATL 프로젝트에 대 한 컴파일러 최적화](../../atl/reference/specifying-compiler-optimization-for-an-atl-project.md)  
 ...
 프로젝트 속성을 지정할 수 있습니다 (예를 들어 [CRT에 정적으로 링크 것인지](../../atl/programming-with-atl-and-c-run-time-code.md))에 [프로젝트 속성](../../ide/general-property-page-project.md) 페이지에서 설정할 수 있습니다 [빌드 구성](/visualstudio/ide/understanding-build-configurations) ATL 프로젝트에 대 한 합니다. 참조 [프로젝트 응용 프로그램 빌드를 사용 하 여](http://msdn.microsoft.com/en-us/3339fa90-bac2-4b95-8361-662a2e0e7dfe) 에 대 한 자세한 내용은 합니다.  
