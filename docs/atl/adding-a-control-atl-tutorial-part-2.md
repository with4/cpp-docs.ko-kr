...
1.  **빌드** 메뉴의 **빌드 다각형**을 클릭합니다.  
     ...
     컨트롤 빌드를 완료한 후에 **솔루션 탐색기**에서 PolyCtl.htm을 마우스 오른쪽 단추로 클릭하여 **브라우저에서 보기**를 선택합니다. 컨트롤을 포함하는 HTML 웹 페이지가 표시됩니다. "PolyCtl 개체에 대한 ATL 8.0 테스트 페이지" 제목 페이지와 **PolyCtl** 텍스트가 표시되어야 합니다. 보고 있는 것이 만들어진 컨트롤입니다. 컨트롤입니다.  
