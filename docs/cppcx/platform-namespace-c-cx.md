---
title: "Platform 네임스페이스(C++/CX) | Microsoft Docs"
ms.custom: ""
ms.date: "12/30/2016"
...
## 멤버  
 Platform 네임스페이스는 IUnknown 인터페이스에서 상속되지만 추가 멤버가 없습니다.  
...
|[Platform::FailureException 클래스](../cppcx/platform-failureexception-class.md)|작업이 실패하면 throw됩니다. 이 지시문은 E\_FAIL HRESULT에 해당합니다.|  
...
## 참고 항목  
 ...
 [Platform::Runtime::CompilerServices 네임스페이스](../cppcx/platform-runtime-compilerservices-namespace.md)   
 [Platform::Runtime::InteropServices 네임스페이스](../cppcx/platform-runtime-interopservices-namespace.md)   
