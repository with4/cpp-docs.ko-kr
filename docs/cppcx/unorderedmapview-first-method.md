---
title: "UnorderedMapView::First 메서드 | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
## 설명  
 First\(\)에서 반환된 반복기를 보유하는 편리한 방법은 [auto](~/cpp/auto-cpp.md) 형식 추론 키워드로 선언된 변수에 반환 값을 할당하는 것입니다. 예를 들어, `auto x = myMapView->First();`을 입력합니다.  
