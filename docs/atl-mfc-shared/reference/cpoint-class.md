...
|이름|설명|  
|----------|-----------------|  
|[CPoint::CPoint](#cpoint__cpoint)|`CPoint`를 생성합니다.|  
  
### <a name="public-methods"></a>Public 메서드  
  
|이름|설명|  
|----------|-----------------|  
|[CPoint::Offset](#cpoint__offset)|값을 추가 하는 **x** 및 **y** 의 멤버는 `CPoint`합니다.|  
  
### <a name="public-operators"></a>Public 연산자  
  
|이름|설명|  
|----------|-----------------|  
|[CPoint::operator-](#cpoint__operator_-)|차이 반환 된 `CPoint` 및 크기, 또는 점, 또는 두 점 또는 음수 크기에 따라 오프셋 사이의 크기 차이의 부정입니다.|  
|[CPoint::operator! =](#cpoint__operator__neq)|두 점 사이의 다른 지 확인 합니다.|  
|[CPoint::operator +](#cpoint__operator__add)|합을 반환 하는 `CPoint` 크기, 지점, 또는 `CRect` 크기 만큼 오프셋 합니다.|  
|[CPoint::operator + =](#cpoint__operator__add_eq)|오프셋 `CPoint` 크기 또는 포인트를 추가 합니다.|  
|[-= CPoint::operator](CPoint::operator%20-=.xml)|오프셋 `CPoint` 크기 또는 포인트를 빼는 방식으로 합니다.|  
|[CPoint::operator = =](#cpoint__operator__eq_eq)|두 점 사이의 같은지 확인 합니다.|  
  
## <a name="remarks"></a>설명  
 조작 하는 멤버 함수에도 `CPoint` 및 [지점](../../mfc/reference/point-structure1.md) 구조입니다.  
  
 A `CPoint` 개체 일 수 아무 곳에 나 사용 되는 `POINT` 구조체를 사용 합니다. "크기" 상호 작용 하는이 클래스의 연산자를 수락 하거나 [CSize](../../atl-mfc-shared/reference/csize-class.md) 개체 또는 [크기](http://msdn.microsoft.com/library/windows/desktop/dd145106) 구조를 두는 동일 하 게 사용 합니다.  
...
### <a name="remarks"></a>설명  
 ...
 두 경우 모두, 추가 추가 하 여 수행 됩니다는 **x** (또는 **cx**)는 오른쪽 피연산자의 멤버는 **x** 의 멤버는 `CPoint` 및 추가 **y** (또는 **cy**) 멤버에는 오른쪽 피연산자의는 **y** 의 멤버는 `CPoint`합니다.  
...
## <a name="see-also"></a>참고 항목  
 [MFC 샘플 MDI](../../top/visual-cpp-samples.md)   
