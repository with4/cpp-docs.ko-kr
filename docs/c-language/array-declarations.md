...
```  
 ...
 배열의 개별 요소를 참조하려면 [후위 연산자](../c-language/postfix-operators.md)에 설명된 것처럼 첨자 식을 사용하십시오.  
 ...
 **Microsoft 전용**  
 ...
 배열의 최대 크기를 보유하는 데 필요한 정수의 형식은 **size\_t**의 크기입니다.  헤더 파일 STDDEF.H에 정의된 **size\_t**는 0x00000000~0x7CFFFFFF 범위의 `unsigned int`입니다.  
