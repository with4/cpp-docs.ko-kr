...
- [AMD64 명령 집합 참조 설명서](https://developer.amd.com/resources/developer-guides-manuals/)  

- [Intel 64 및 ia-32 아키텍처 소프트웨어 개발자 설명서](https://software.intel.com/en-us/documentation)  

- [Intel 고급 벡터 확장 (AVX)](https://software.intel.com/en-us/articles/introduction-to-intel-advanced-vector-extensions)  
