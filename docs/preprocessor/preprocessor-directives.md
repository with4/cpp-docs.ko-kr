...
숫자 기호 (**#**) 해야 합니다; 지시문이 포함 된 줄에서 첫 번째 공백이 아닌 문자 수 공백 문자는 숫자 기호와 지시문의 첫 문자 사이 나타날 수 있습니다. 일부 지시문에는 인수 또는 값이 포함됩니다. 인수 또는 값 지시문의 일부인) (제외 지시문 다음에 오는 모든 텍스트 한 줄 주석 구분 기호 뒤에 야 (**//**)로 묶인 주석 구분 기호 또는 ( __/ \*\*/__).   전처리기 지시문을 포함 하는 줄은 백슬래시가 줄 끝 표식 바로 앞 계속할 수 있습니다 (**\\**).
