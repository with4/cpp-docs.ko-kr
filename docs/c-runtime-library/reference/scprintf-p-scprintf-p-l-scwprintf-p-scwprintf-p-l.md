...
문자열이 지정된 형식 지정 코드를 사용하여 인쇄되거나 파일 또는 버퍼로 보내진 경우 생성될 문자 수를 반환합니다. 반환된 값은 종료 null 문자를 포함하지 않습니다. **_scwprintf_p** 와이드 문자에 대해 동일한 기능을 수행 합니다.

차이 **_scprintf_p** 및 **_scprintf** 은 **_scprintf_p** 위치 매개 변수를 지원은 순서를 지정할 수 있는 인수 형식 문자열에 사용 됩니다. 자세한 내용은 [printf_p 위치 매개 변수](../../c-runtime-library/printf-p-positional-parameters.md)를 참조하세요.
