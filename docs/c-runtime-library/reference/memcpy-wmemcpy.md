...
버퍼 간에 바이트를 복사합니다.  이러한 기능의 더 안전한 버전을 사용할 수 있습니다. [memcpy\_s, wmemcpy\_s](../../c-runtime-library/reference/memcpy-s-wmemcpy-s.md)를 참조하세요.  
...
## 예제  
 [memmove](../../c-runtime-library/reference/memmove-wmemmove.md)를 사용하는 방법에 대한 샘플은 `memcpy` 를 참조하세요.  
