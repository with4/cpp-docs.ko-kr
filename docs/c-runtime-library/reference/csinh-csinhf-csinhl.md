---
title: csinh, csinhf, csinhl | Microsoft 문서
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp
...
C + +는 오버 로딩을 허용 하기 때문에 오버 로드를 호출할 수 있습니다 **csinh** 사용 하 고 반환 **_Fcomplex** 및 **_Lcomplex** 값입니다. C 프로그램에서 **csinh** 항상 사용 하 고 반환 된 **_Dcomplex** 값입니다.
