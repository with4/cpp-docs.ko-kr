...
이 POSIX 함수는 사용되지 않습니다. 대신 ISO C++와 호환되는 [_lsearch](../../c-runtime-library/reference/lsearch.md) 또는 보안이 강화된 [_lsearch_s](../../c-runtime-library/reference/lsearch-s.md)를 사용하세요.