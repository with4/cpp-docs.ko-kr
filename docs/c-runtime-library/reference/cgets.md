...
이 POSIX 함수는 사용되지 않습니다.  ISO c \+ \+ 규칙을 [\_cgets](../../c-runtime-library/cgets-cgetws.md) 또는 보안과 연관된 [\_cgets\_s](../../c-runtime-library/reference/cgets-s-cgetws-s.md) 대신에 사용합니다.  
