...
이 POSIX 함수는 사용되지 않습니다.  ISO c \+ \+ 규칙 [\_putenv](../../c-runtime-library/reference/putenv-wputenv.md) 을 사용합니다 또는 보안향상 [\_putenv\_s](../../c-runtime-library/reference/putenv-s-wputenv-s.md) 을 대신 사용합니다.  
