...
|Name|설명|  
|----------|--------|  
|[double\_4::double\_4 생성자](../Topic/double_4::double_4%20Constructor.md)|오버로드됨.  기본 생성자는, 모든 요소를 0으로 초기화 합니다.|  
  
### Public 메서드  
  
|Name|설명|  
|----------|--------|  
|double\_4::get\_w 메서드||  
|double\_4::get\_wx 메서드||  
|double\_4::get\_wxy 메서드||  
|double\_4::get\_wxyz 메서드||  
|double\_4::get\_wxz 메서드||  
|double\_4::get\_wxzy 메서드||  
|double\_4::get\_wy 메서드||  
|double\_4::get\_wyx 메서드||  
|double\_4::get\_wyxz 메서드||  
|double\_4::get\_wyz 메서드||  
|double\_4::get\_wyzx 메서드||  
|double\_4::get\_wz 메서드||  
|double\_4::get\_wzx 메서드||  
|double\_4::get\_wzxy 메서드||  
|double\_4::get\_wzy 메서드||  
|double\_4::get\_wzyx 메서드||  
|double\_4::get\_x 메서드||  
|double\_4::get\_xw 메서드||  
|double\_4::get\_xwy 메서드||  
|double\_4::get\_xwyz 메서드||  
|double\_4::get\_xwz 메서드||  
|double\_4::get\_xwzy 메서드||  
|double\_4::get\_xy 메서드||  
|double\_4::get\_xyw 메서드||  
|double\_4::get\_xywz 메서드||  
|double\_4::get\_xyz 메서드||  
|double\_4::get\_xyzw 메서드||  
|double\_4::get\_xz 메서드||  
|double\_4::get\_xzw 메서드||  
|double\_4::get\_xzwy 메서드||  
|double\_4::get\_xzy 메서드||  
|double\_4::get\_xzyw 메서드||  
|double\_4::get\_y 메서드||  
|double\_4::get\_yw 메서드||  
|double\_4::get\_ywx 메서드||  
|double\_4::get\_ywxz 메서드||  
|double\_4::get\_ywz 메서드||  
|double\_4::get\_ywzx 메서드||  
|double\_4::get\_yx 메서드||  
|double\_4::get\_yxw 메서드||  
|double\_4::get\_yxwz 메서드||  
|double\_4::get\_yxz 메서드||  
|double\_4::get\_yxzw 메서드||  
|double\_4::get\_yz 메서드||  
|double\_4::get\_yzw 메서드||  
|double\_4::get\_yzwx 메서드||  
|double\_4::get\_yzx 메서드||  
|double\_4::get\_yzxw 메서드||  
|double\_4::get\_z 메서드||  
|double\_4::get\_zw 메서드||  
|double\_4::get\_zwx 메서드||  
|double\_4::get\_zwxy 메서드||  
|double\_4::get\_zwy 메서드||  
|double\_4::get\_zwyx 메서드||  
|double\_4::get\_zx 메서드||  
|double\_4::get\_zxw 메서드||  
|double\_4::get\_zxwy 메서드||  
|double\_4::get\_zxy 메서드||  
|double\_4::get\_zxyw 메서드||  
|double\_4::get\_zy 메서드||  
|double\_4::get\_zyw 메서드||  
|double\_4::get\_zywx 메서드||  
|double\_4::get\_zyx 메서드||  
|double\_4::get\_zyxw 메서드||  
|double\_4::ref\_a 메서드||  
|double\_4::ref\_b 메서드||  
|double\_4::ref\_g 메서드||  
|double\_4::ref\_r 메서드||  
|double\_4::ref\_w 메서드||  
|double\_4::ref\_x 메서드||  
|double\_4::ref\_y 메서드||  
|double\_4::ref\_z 메서드||  
|double\_4::set\_w 메서드||  
|double\_4::set\_wx 메서드||  
|double\_4::set\_wxy 메서드||  
|double\_4::set\_wxyz 메서드||  
|double\_4::set\_wxz 메서드||  
|double\_4::set\_wxzy 메서드||  
|double\_4::set\_wy 메서드||  
|double\_4::set\_wyx 메서드||  
|double\_4::set\_wyxz 메서드||  
|double\_4::set\_wyz 메서드||  
|double\_4::set\_wyzx 메서드||  
|double\_4::set\_wz 메서드||  
|double\_4::set\_wzx 메서드||  
|double\_4::set\_wzxy 메서드||  
|double\_4::set\_wzy 메서드||  
|double\_4::set\_wzyx 메서드||  
|double\_4::set\_x 메서드||  
|double\_4::set\_xw 메서드||  
|double\_4::set\_xwy 메서드||  
|double\_4::set\_xwyz 메서드||  
|double\_4::set\_xwz 메서드||  
|double\_4::set\_xwzy 메서드||  
|double\_4::set\_xy 메서드||  
|double\_4::set\_xyw 메서드||  
|double\_4::set\_xywz 메서드||  
|double\_4::set\_xyz 메서드||  
|double\_4::set\_xyzw 메서드||  
|double\_4::set\_xz 메서드||  
|double\_4::set\_xzw 메서드||  
|double\_4::set\_xzwy 메서드||  
|double\_4::set\_xzy 메서드||  
|double\_4::set\_xzyw 메서드||  
|double\_4::set\_y 메서드||  
|double\_4::set\_yw 메서드||  
|double\_4::set\_ywx 메서드||  
|double\_4::set\_ywxz 메서드||  
|double\_4::set\_ywz 메서드||  
|double\_4::set\_ywzx 메서드||  
|double\_4::set\_yx 메서드||  
|double\_4::set\_yxw 메서드||  
|double\_4::set\_yxwz 메서드||  
|double\_4::set\_yxz 메서드||  
|double\_4::set\_yxzw 메서드||  
|double\_4::set\_yz 메서드||  
|double\_4::set\_yzw 메서드||  
|double\_4::set\_yzwx 메서드||  
|double\_4::set\_yzx 메서드||  
|double\_4::set\_yzxw 메서드||  
|double\_4::set\_z 메서드||  
|double\_4::set\_zw 메서드||  
|double\_4::set\_zwx 메서드||  
|double\_4::set\_zwxy 메서드||  
|double\_4::set\_zwy 메서드||  
|double\_4::set\_zwyx 메서드||  
|double\_4::set\_zx 메서드||  
|double\_4::set\_zxw 메서드||  
|double\_4::set\_zxwy 메서드||  
|double\_4::set\_zxy 메서드||  
|double\_4::set\_zxyw 메서드||  
|double\_4::set\_zy 메서드||  
|double\_4::set\_zyw 메서드||  
|double\_4::set\_zywx 메서드||  
|double\_4::set\_zyx 메서드||  
|double\_4::set\_zyxw 메서드||  
  
### Public 연산자  
  
|Name|설명|  
|----------|--------|  
|double\_4::operator\- 연산자||  
|double\_4::operator\-\- 연산자||  
|double\_4::operator\*\= 연산자||  
|double\_4::operator\/\= 연산자||  
|double\_4::operator\+\+ 연산자||  
...
|Name|설명|  
|----------|--------|  
|[double\_4::size 상수](../Topic/double_4::size%20Constant.md)||  
...
|double\_4::a 데이터 멤버||  
|double\_4::ab 데이터 멤버||  
|double\_4::abg 데이터 멤버||  
|double\_4::abgr 데이터 멤버||  
|double\_4::abr 데이터 멤버||  
|double\_4::abrg 데이터 멤버||  
|double\_4::ag 데이터 멤버||  
|double\_4::agb 데이터 멤버||  
|double\_4::agbr 데이터 멤버||  
|double\_4::agr 데이터 멤버||  
|double\_4::agrb 데이터 멤버||  
|double\_4::ar 데이터 멤버||  
|double\_4::arb 데이터 멤버||  
|double\_4::arbg 데이터 멤버||  
|double\_4::arg 데이터 멤버||  
|double\_4::argb 데이터 멤버||  
|double\_4::b 데이터 멤버||  
|double\_4::ba 데이터 멤버||  
|double\_4::bag 데이터 멤버||  
|double\_4::bagr 데이터 멤버||  
|double\_4::bar 데이터 멤버||  
|double\_4::barg 데이터 멤버||  
|double\_4::bg 데이터 멤버||  
|double\_4::bga 데이터 멤버||  
|double\_4::bgar 데이터 멤버||  
|double\_4::bgr 데이터 멤버||  
|double\_4::bgra 데이터 멤버||  
|double\_4::br 데이터 멤버||  
|double\_4::bra 데이터 멤버||  
|double\_4::brag 데이터 멤버||  
|double\_4::brg 데이터 멤버||  
|double\_4::brga 데이터 멤버||  
|double\_4::g 데이터 멤버||  
|double\_4::ga 데이터 멤버||  
|double\_4::gab 데이터 멤버||  
|double\_4::gabr 데이터 멤버||  
|double\_4::gar 데이터 멤버||  
|double\_4::garb 데이터 멤버||  
|double\_4::gb 데이터 멤버||  
|double\_4::gba 데이터 멤버||  
|double\_4::gbar 데이터 멤버||  
|double\_4::gbr 데이터 멤버||  
|double\_4::gbra 데이터 멤버||  
|double\_4::gr 데이터 멤버||  
|double\_4::gra 데이터 멤버||  
|double\_4::grab 데이터 멤버||  
|double\_4::grb 데이터 멤버||  
|double\_4::grba 데이터 멤버||  
|double\_4::r 데이터 멤버||  
|double\_4::ra 데이터 멤버||  
|double\_4::rab 데이터 멤버||  
|double\_4::rabg 데이터 멤버||  
|double\_4::rag 데이터 멤버||  
|double\_4::ragb 데이터 멤버||  
|double\_4::rb 데이터 멤버||  
|double\_4::rba 데이터 멤버||  
|double\_4::rbag 데이터 멤버||  
|double\_4::rbg 데이터 멤버||  
|double\_4::rbga 데이터 멤버||  
|double\_4::rg 데이터 멤버||  
|double\_4::rga 데이터 멤버||  
|double\_4::rgab 데이터 멤버||  
|double\_4::rgb 데이터 멤버||  
|double\_4::rgba 데이터 멤버||  
|double\_4::w 데이터 멤버||  
|double\_4::wx 데이터 멤버||  
|double\_4::wxy 데이터 멤버||  
|double\_4::wxyz 데이터 멤버||  
|double\_4::wxz 데이터 멤버||  
|double\_4::wxzy 데이터 멤버||  
|double\_4::wy 데이터 멤버||  
|double\_4::wyx 데이터 멤버||  
|double\_4::wyxz 데이터 멤버||  
|double\_4::wyz 데이터 멤버||  
|double\_4::wyzx 데이터 멤버||  
|double\_4::wz 데이터 멤버||  
|double\_4::wzx 데이터 멤버||  
|double\_4::wzxy 데이터 멤버||  
|double\_4::wzy 데이터 멤버||  
|double\_4::wzyx 데이터 멤버||  
|double\_4::x 데이터 멤버||  
|double\_4::xw 데이터 멤버||  
|double\_4::xwy 데이터 멤버||  
|double\_4::xwyz 데이터 멤버||  
|double\_4::xwz 데이터 멤버||  
|double\_4::xwzy 데이터 멤버||  
|double\_4::xy 데이터 멤버||  
|double\_4::xyw 데이터 멤버||  
|double\_4::xywz 데이터 멤버||  
|double\_4::xyz 데이터 멤버||  
|double\_4::xyzw 데이터 멤버||  
|double\_4::xz 데이터 멤버||  
|double\_4::xzw 데이터 멤버||  
|double\_4::xzwy 데이터 멤버||  
|double\_4::xzy 데이터 멤버||  
|double\_4::xzyw 데이터 멤버||  
|double\_4::y 데이터 멤버||  
|double\_4::yw 데이터 멤버||  
|double\_4::ywx 데이터 멤버||  
|double\_4::ywxz 데이터 멤버||  
|double\_4::ywz 데이터 멤버||  
|double\_4::ywzx 데이터 멤버||  
|double\_4::yx 데이터 멤버||  
|double\_4::yxw 데이터 멤버||  
|double\_4::yxwz 데이터 멤버||  
|double\_4::yxz 데이터 멤버||  
|double\_4::yxzw 데이터 멤버||  
|double\_4::yz 데이터 멤버||  
|double\_4::yzw 데이터 멤버||  
|double\_4::yzwx 데이터 멤버||  
|double\_4::yzx 데이터 멤버||  
|double\_4::yzxw 데이터 멤버||  
|double\_4::z 데이터 멤버||  
|double\_4::zw 데이터 멤버||  
|double\_4::zwx 데이터 멤버||  
|double\_4::zwxy 데이터 멤버||  
|double\_4::zwy 데이터 멤버||  
|double\_4::zwyx 데이터 멤버||  
|double\_4::zx 데이터 멤버||  
|double\_4::zxw 데이터 멤버||  
|double\_4::zxwy 데이터 멤버||  
|double\_4::zxy 데이터 멤버||  
|double\_4::zxyw 데이터 멤버||  
|double\_4::zy 데이터 멤버||  
|double\_4::zyw 데이터 멤버||  
|double\_4::zywx 데이터 멤버||  
|double\_4::zyx 데이터 멤버||  
|double\_4::zyxw 데이터 멤버||  
