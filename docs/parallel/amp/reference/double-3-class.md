...
|Name|설명|  
|----------|--------|  
|[double\_3::double\_3 생성자](../Topic/double_3::double_3%20Constructor.md)|오버로드됨.  기본 생성자는, 모든 요소를 0으로 초기화 합니다.|  
  
### Public 메서드  
  
|Name|설명|  
|----------|--------|  
|double\_3::get\_x 메서드||  
|double\_3::get\_xy 메서드||  
|double\_3::get\_xyz 메서드||  
|double\_3::get\_xz 메서드||  
|double\_3::get\_xzy 메서드||  
|double\_3::get\_y 메서드||  
|double\_3::get\_yx 메서드||  
|double\_3::get\_yxz 메서드||  
|double\_3::get\_yz 메서드||  
|double\_3::get\_yzx 메서드||  
|double\_3::get\_z 메서드||  
|double\_3::get\_zx 메서드||  
|double\_3::get\_zxy 메서드||  
|double\_3::get\_zy 메서드||  
|double\_3::get\_zyx 메서드||  
|double\_3::ref\_b 메서드||  
|double\_3::ref\_g 메서드||  
|double\_3::ref\_r 메서드||  
|double\_3::ref\_x 메서드||  
|double\_3::ref\_y 메서드||  
|double\_3::ref\_z 메서드||  
|double\_3::set\_x 메서드||  
|double\_3::set\_xy 메서드||  
|double\_3::set\_xyz 메서드||  
|double\_3::set\_xz 메서드||  
|double\_3::set\_xzy 메서드||  
|double\_3::set\_y 메서드||  
|double\_3::set\_yx 메서드||  
|double\_3::set\_yxz 메서드||  
|double\_3::set\_yz 메서드||  
|double\_3::set\_yzx 메서드||  
|double\_3::set\_z 메서드||  
|double\_3::set\_zx 메서드||  
|double\_3::set\_zxy 메서드||  
|double\_3::set\_zy 메서드||  
|double\_3::set\_zyx 메서드||  
  
### Public 연산자  
  
|Name|설명|  
|----------|--------|  
|double\_3::operator\- 연산자||  
|double\_3::operator\-\- 연산자||  
|double\_3::operator\*\= 연산자||  
|double\_3::operator\/\= 연산자||  
|double\_3::operator\+\+ 연산자||  
...
|Name|설명|  
|----------|--------|  
|[double\_3::size 상수](../Topic/double_3::size%20Constant.md)||  
...
|double\_3::b 데이터 멤버||  
|double\_3::bg 데이터 멤버||  
|double\_3::bgr 데이터 멤버||  
|double\_3::br 데이터 멤버||  
|double\_3::brg 데이터 멤버||  
|double\_3::g 데이터 멤버||  
|double\_3::gb 데이터 멤버||  
|double\_3::gbr 데이터 멤버||  
|double\_3::gr 데이터 멤버||  
|double\_3::grb 데이터 멤버||  
|double\_3::r 데이터 멤버||  
|double\_3::rb 데이터 멤버||  
|double\_3::rbg 데이터 멤버||  
|double\_3::rg 데이터 멤버||  
|double\_3::rgb 데이터 멤버||  
|double\_3::x 데이터 멤버||  
|double\_3::xy 데이터 멤버||  
|double\_3::xyz 데이터 멤버||  
|double\_3::xz 데이터 멤버||  
|double\_3::xzy 데이터 멤버||  
|double\_3::y 데이터 멤버||  
|double\_3::yx 데이터 멤버||  
|double\_3::yxz 데이터 멤버||  
|double\_3::yz 데이터 멤버||  
|double\_3::yzx 데이터 멤버||  
|double\_3::z 데이터 멤버||  
|double\_3::zx 데이터 멤버||  
|double\_3::zxy 데이터 멤버||  
|double\_3::zy 데이터 멤버||  
|double\_3::zyx 데이터 멤버||  
