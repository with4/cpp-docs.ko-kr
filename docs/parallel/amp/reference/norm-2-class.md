...
|Name|설명|  
|----------|--------|  
|[norm\_2::norm\_2 생성자](../Topic/norm_2::norm_2%20Constructor.md)|오버로드됨.  기본 생성자는, 모든 요소를 0으로 초기화 합니다.|  
...
|Name|설명|  
|----------|--------|  
|[norm\_2::size 상수](../Topic/norm_2::size%20Constant.md)||  
