---
title: "short_vector_traits 구조체 | Microsoft 문서"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
##  <a name="a-namectora--shortvectortraitsshortvectortraits-constructor"></a><a name="ctor"></a>short_vector_traits:: short_vector_traits 생성자  
  
```  
short_vector_traits();
```  
  
##  <a name="a-namesizea--shortvectortraitssize-constant"></a><a name="size"></a>short_vector_traits:: size 상수  
