...
|Name|설명|  
|----------|--------|  
|[int\_3::int\_3 생성자](../Topic/int_3::int_3%20Constructor.md)|오버로드됨.  기본 생성자는, 모든 요소를 0으로 초기화 합니다.|  
...
|Name|설명|  
|----------|--------|  
|[int\_3::size 상수](../Topic/int_3::size%20Constant.md)||  
