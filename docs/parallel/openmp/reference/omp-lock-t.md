...
잠금, 잠금을 사용할 수 있는지 여부 또는 잠금을 소유 하는 스레드가 상태를 저장 하는 형식입니다.  
  
 다음 함수 사용  **omp\_lock\_t**:  
...
## 예제  
 참조 하십시오 [omp\_init\_lock](../../../parallel/openmp/reference/omp-init-lock.md) 를 사용 하는 예에 대 한  **omp\_lock\_t**.  
