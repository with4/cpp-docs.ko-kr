...
|이름|설명|  
|----------|-----------------|  
|[concurrent_unordered_map](#ctor)|오버로드됨. 동시 순서가 지정 되지 않은 맵을 생성합니다.|  
  
### <a name="public-methods"></a>Public 메서드  
  
|이름|설명|  
|----------|-----------------|  
|[at](#at)|오버로드됨. 요소를 찾습니다는 `concurrent_unordered_map` 지정 된 키 값을 가진... 이 메서드는 동시성이 보장 합니다.|  
|[hash_function](#hash_function)|저장된 해시 함수 개체를 가져옵니다.|  
|[insert](#insert)|오버로드됨. 요소를 추가 하는 `concurrent_unordered_map` 개체입니다.|  
|[key_eq](#key_eq)|저장 된 같음 비교 함수 개체를 가져옵니다.|  
|[swap](#swap)|두 개의의 내용을 바꿉니다 `concurrent_unordered_map` 개체입니다. 이 메서드는 동시성이 보장 되지 않습니다.|  
|[unsafe_erase](#unsafe_erase)|오버로드됨. 요소를 제거는 `concurrent_unordered_map` 지정 된 위치에 있습니다. 이 메서드는 동시성이 보장 되지 않습니다.|  
...
|[operator=](#operator_eq)|오버로드됨. 다른 할당 `concurrent_unordered_map` 여기에 개체입니다. 이 메서드는 동시성이 보장 되지 않습니다.|  
