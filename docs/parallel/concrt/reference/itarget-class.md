...
|이름|설명|  
|----------|-----------------|  
|[전파](#propagate)|파생된 클래스에서 재정의 되 면 비동기적으로 메시지를 소스 블록에서이 대상 블록 전달 합니다.|  
|[보내기](#send)|파생된 클래스에서 재정의 되 면 대상 블록에 동기적으로 메시지를 전달 합니다.|  
...
|이름|설명|  
|----------|-----------------|  
|[link_source](#link_source)|파생된 클래스에서 재정의 되 면이 지정 된 소스 블록을 연결 `ITarget` 블록입니다.|  
