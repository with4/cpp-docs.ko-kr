...
- [Intel 아키텍처 명령 집합 확장 프로그래밍 참조](http://go.microsoft.com/fwlink/p/?LinkId=506627)
...
|[_InterlockedAddLargeStatistic](../intrinsics/interlockedaddlargestatistic.md)||intrin.h|긴 _InterlockedAddLargeStatistic (\__int64 volatile *, long)|
