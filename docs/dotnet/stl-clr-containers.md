...
## 컨테이너 요소에 대한 요구 사항  
 All elements inserted into STL containers must obey certain guidelines.  자세한 내용은 [STL\/CLR 컨테이너 요소에 대한 요구 사항](../dotnet/requirements-for-stl-clr-container-elements.md)을 참조하십시오.  
...
### Handles to Reference Types  
 You can insert a handle to a reference type into an STL\/CLR container.  A handle in C\+\+ that targets the CLR is analogous to a pointer in native C\+\+.  자세한 내용은 [개체 연산자에 대한 핸들\(^\)](../windows/handle-to-object-operator-hat-cpp-component-extensions.md)을 참조하십시오.  
...
### Unboxed Value Types  
 ...
 A value type element can be one of the standard value types, such as an `int`, or it can be a user\-defined value type, such as a `value class`.  자세한 내용은 [Classes and Structs](../windows/classes-and-structs-cpp-component-extensions.md)을 참조하십시오.  
...
```  
 ...
 If you attempt to insert a handle to a value type into a container, [컴파일러 오류 C3225](../error-messages/compiler-errors-2/compiler-error-c3225.md) is generated.  
