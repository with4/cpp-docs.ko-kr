...
|[hash_multimap::difference_type(STL/CLR)](#difference_type)|두 요소 사이의 거리 (서명 된 가능)의 형식입니다.|  
...
|[hash_multimap::generic_reverse_iterator(STL/CLR)](#generic_reverse_iterator)|컨테이너에 대 한 제네릭 인터페이스에 대 한 반대 반복기의 형식입니다.|  
|[hash_multimap::generic_value(STL/CLR)](#generic_value)|컨테이너에 대 한 제네릭 인터페이스에 대 한 요소의 형식입니다.|  
|[hash_multimap::hasher(STL/CLR)](#hasher)|키에 대 한 해시 하는 대리자입니다.|  
|[hash_multimap::iterator(STL/CLR)](#iterator)|제어되는 시퀀스에 대한 반복기의 형식입니다.|  
|[hash_multimap::key_compare(STL/CLR)](#key_compare)|두 키에 대 한 순서 지정 하는 대리자입니다.|  
...
|[hash_multimap::value_compare(STL/CLR)](#value_compare)|두 요소 값에 대 한 순서 지정 하는 대리자입니다.|  
|[hash_multimap::value_type(STL/CLR)](#value_type)|요소의 형식입니다.|  
  
|멤버 함수|설명|  
|---------------------|-----------------|  
|[hash_multimap::begin(STL/CLR)](#begin)|제어되는 시퀀스의 시작을 지정합니다.|  
|[hash_multimap::bucket_count(STL/CLR)](#bucket_count)|버킷 수를 계산합니다.|  
|[hash_multimap::clear(STL/CLR)](#clear)|모든 요소를 제거합니다.|  
|[hash_multimap::count(STL/CLR)](#count)|지정된 된 키와 일치 하는 요소 수를 계산 합니다.|  
...
|[hash_multimap::hash_delegate(STL/CLR)](#hash_delegate)|키에 대 한 해시 대리자를 복사합니다.|  
|[hash_multimap::hash_multimap(STL/CLR)](#hash_multimap)|컨테이너 개체를 만듭니다.|  
|[hash_multimap::insert(STL/CLR)](#insert)|요소를 추가합니다.|  
|[hash_multimap::key_comp(STL/CLR)](#key_comp)|두 키에 대 한 순서 지정 대리자를 복사합니다.|  
...
|[hash_multimap::make_value(STL/CLR)](#make_value)|값 개체를 만듭니다.|  
...
|[hash_multimap::to_array(STL/CLR)](#to_array)|제어 되는 새 배열에 복사합니다.|  
...
### <a name="remarks"></a>설명  
 멤버 함수는 빈 제어되는 시퀀스에 대해 true를 반환합니다. 동일 [hash_multimap:: size (STL/CLR)](../dotnet/hash-multimap-size-stl-clr.md)`() == 0`합니다. Hash_multimap 비어 있는지 여부를 테스트 하려면 사용 합니다.  
...
### <a name="remarks"></a>설명  
 가 가리키는 제어 된 시퀀스의 요소를 제거 하는 첫 번째 멤버 함수 `where`를 제거 하는 요소 뒤에 남은 첫 번째 요소를 지정 하는 반복기를 반환 하 고 또는 [hash_multimap:: end (STL/CLR)](../dotnet/hash-multimap-end-stl-clr.md) `()` 이러한 요소가 없을 경우. 단일 요소를 제거 하려면 사용 합니다.  
...
### <a name="remarks"></a>설명  
 멤버 함수는 반환 `(float)` [hash_multimap:: size (STL/CLR)](../dotnet/hash-multimap-size-stl-clr.md) `() /` [hash_multimap:: bucket_count (STL/CLR)](../dotnet/hash-multimap-bucket-count-stl-clr.md)`()`합니다. 평균 버킷 크기를 확인 하려면 사용 합니다.  
...
### <a name="remarks"></a>설명  
 멤버 함수는 첫 번째 요소를 결정 `X` 동일한 버킷으로 해시 제어 된 시퀀스의 `key` 과 순서가 및 `key`합니다. 이러한 요소가 있는 경우 반환 [hash_multimap:: end (STL/CLR)](../dotnet/hash-multimap-end-stl-clr.md)`()`; 그렇지 않으면 지정 하는 반복기를 반환 `X`합니다. 지정된 된 키와 일치 하는 제어 된 시퀀스의 요소 시퀀스의 시작 부분을 현재 찾을 사용 합니다.  
...
### <a name="remarks"></a>설명  
 멤버 함수는 제어되는 시퀀스의 길이를 반환합니다. 제어 되는 시퀀스의 현재 요소 수를 확인 하려면 사용 합니다. 모든 경우에 중요 한 여부 시퀀스 크기가 0이 아닌 참조 [hash_multimap:: empty (STL/CLR)](../dotnet/hash-multimap-empty-stl-clr.md)`()`합니다.  
