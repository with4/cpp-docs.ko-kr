...
## 설명  
 ...
 Both member functions return an iterator that designates the first element remaining beyond any elements removed, or [list::end](../dotnet/list-end-stl-clr.md)`()` if no such element exists.  
