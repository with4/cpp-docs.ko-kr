...
## 설명  
 The member function returns true for an empty controlled sequence.  It is equivalent to [priority\_queue::size](../dotnet/priority-queue-size-stl-clr.md)`() == 0`.  You use it to test whether the priority\_queue is empty.  
