...
### 설명  
 ...
 For more information on the manifest tool and side\-by\-side assemblies, see [C\/C\+\+ 격리된 응용 프로그램 및 side\-by\-side 어셈블리 빌드](../build/building-c-cpp-isolated-applications-and-side-by-side-assemblies.md).  
