...
3.  모든 관리 되지 않는 형식을 제거 합니다.  
    ...
    1.  해당 되는 관리 되지 않는 형식에서 구조에 대 한 참조로 대체는 [시스템](https://msdn.microsoft.com/en-us/library/system.appdomainmanager.appdomainmanager.aspx) 네임 스페이스입니다. 일반적인 관리 되는 유형이 다음 표에 나와 있습니다.  
