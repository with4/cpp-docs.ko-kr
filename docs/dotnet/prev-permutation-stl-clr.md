...
## 설명  
 This function behaves the same as the STL function `prev_permutation`.  자세한 내용은 [prev\_permutation](../Topic/prev_permutation.md)을 참조하십시오.  
