...
- /Clr에서 이동할 때: /clr 컴파일에 순수 제거는 [/ENTRY](../../build/reference/entry-entry-point-symbol.md) 링커 줄에서 옵션입니다. CRT 초기화 있으며 정적 이니셜라이저 응용 프로그램 시작 시 실행 되도록 허용 합니다. **/clr: pure** 컴파일러 옵션은 Visual Studio 2015에서 사용 되지 않으며 Visual Studio 2017에서 지원 되지 않습니다.
