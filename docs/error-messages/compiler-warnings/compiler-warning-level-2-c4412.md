...
ms.locfileid: "34704015"
---
# <a name="compiler-warning-level-2-c4412"></a>컴파일러 경고(수준 2) C4412

> '*함수*': 함수 시그니처에 형식 '*형식*'; C + + 개체는 순수 코드 간에 전달 하는 안전 하지 않은 혼합형 / 네이티브는입니다.

## <a name="remarks"></a>설명

**/clr: pure** 컴파일러 옵션은 Visual Studio 2015에서 사용 되지 않으며 Visual Studio 2017에서 지원 되지 않습니다. 순수 하는 코드를 있는 경우 C#로 포팅하는 것이 좋습니다.
