...
'var': \/fp:strict 또는 \#pragma fenv\_access를 지정하면 부동 소수점 환산\(reduction\) 변수로 인해 일관성 없는 결과가 발생할 수 있습니다.  
  
 합계가 다른 순서로 계산되므로 OpenMP 부동 소수점 환산\(reduction\)과 함께 [\/fp:strict](../../build/reference/fp-specify-floating-point-behavior.md) 또는 [fenv\_access](../../preprocessor/fenv-access.md)를 사용하면 안 됩니다. 따라서 결과가 \/openmp를 사용하지 않을 경우의 결과와 다를 수 있습니다.  
