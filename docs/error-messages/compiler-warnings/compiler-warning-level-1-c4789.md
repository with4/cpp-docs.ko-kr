...
-   [memcpy](../../c-runtime-library/reference/memcpy-wmemcpy.md), [wmemcpy](../../c-runtime-library/reference/memcpy-wmemcpy.md)  
 ...
 이렇게 하면 Visual C\+\+에서 특정 코드 블록에 대해 경고를 생성하지 않습니다.  `#pragma(push)`는 `#pragma warning(disable: 4789)`에서 변경하기 전까지 기존 상태를 유지합니다.  `#pragma(pop)`는 푸시된 상태를 복원하고 `#pragma warning(disable:4789)`의 효과를 제거합니다.  C\+\+ 전처리기 지시문 `#pragma`에 대한 자세한 내용은 [경고](../../preprocessor/warning.md) 및 [Pragma 지시문 및 \_\_Pragma 키워드](../../preprocessor/pragma-directives-and-the-pragma-keyword.md)를 참조하세요.  
