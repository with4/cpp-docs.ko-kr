...
|컴파일러 경고 (수준 1) C4006|#undef에 식별자가 필요|  
...
|컴파일러 경고 (수준 1) C4112|#줄에는 1에서 'line_count' 사이의 정수가 있어야합니다.|  
...
|컴파일러 경고 (수준 1) C4182|#포함 중첩 수준은 'nest_count' 했습니다. 무한 재귀가 발생할 수 있습니다|  
...
|컴파일러 경고 (수준 1) C4186|#'attribute' import 특성 'argument_count' 인수가; 필요 무시|  
|컴파일러 경고 (수준 1) C4187|#import 특성 'attribute1' 및 'attribute2' 호환 되지 않습니다. 모두 무시|  
