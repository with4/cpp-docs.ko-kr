...
|Error|메시지|
|-----------|-------------|
|컴파일러 오류 C2000|알 수 없는 오류 하십시오 Visual c + + 도움말 메뉴에서 [기술 지원] 명령을 선택 하거나 기술 지원 도움말 파일에 대 한 자세한 내용은|
|[컴파일러 오류 C2001](compiler-error-c2001.md)|상수에 줄 바꿈|
|[컴파일러 오류 C2002](compiler-error-c2002.md)|잘못 된 와이드 문자 상수|
|[컴파일러 오류 C2003](compiler-error-c2003.md)|예상된 ' 정의 id'|
|[컴파일러 오류 C2004](compiler-error-c2004.md)|'defined(id)'가 필요합니다.|
|[컴파일러 오류 C2005](compiler-error-c2005.md)|#line에 줄 번호가 있어야 하는데 '*토큰*'|
...
|컴파일러 오류 C2016|C 구조체 또는 공용 구조체에 대 한 이어야 구성원을 하나 이상|
