...
---
# <a name="compiler-errors-c2000-through-c2099"></a>컴파일러 오류 C2000 c 2099 통해
...
|오류|메시지|  
|-----------|-------------|  
|컴파일러 오류 C2000|알 수 없는 오류 하거나 참조 하세요. Visual c + + 도움말 메뉴에서 [기술 지원] 명령을 선택 합니다. 자세한 내용은 기술 지원 도움말 파일|  
|[컴파일러 오류 C2001](compiler-error-c2001.md)|상수에 줄 바꿈 문자가 있습니다.|  
|[컴파일러 오류 C2002](compiler-error-c2002.md)|와이드 문자 상수가 잘못되었습니다.|  
|[컴파일러 오류 C2003](compiler-error-c2003.md)|'defined id'가 필요합니다.|  
|[컴파일러 오류 C2004](compiler-error-c2004.md)|'defined(id)'가 필요합니다.|  
|[컴파일러 오류 C2005](compiler-error-c2005.md)|#줄 번호가 있어야 하는데 한 줄 '*토큰*'|  
|[컴파일러 오류 C2006](compiler-error-c2006.md)|'*지시문*':에서 파일 이름이 필요 합니다. '*토큰*'|  
|[컴파일러 오류 C2007](compiler-error-c2007.md)|#구문 정의|  
|[컴파일러 오류 C2008](compiler-error-c2008.md)|'*문자*': 매크로 정의|  
|[컴파일러 오류 C2009](compiler-error-c2009.md)|매크로 정식의 재사용 '*식별자*'|  
|[컴파일러 오류 C2010](compiler-error-c2010.md)|'*문자*': 매크로 정식 매개 변수 목록에|  
...
|[컴파일러 오류 C2014](compiler-error-c2014.md)|전처리기 명령은 공백 아닌 문자로 시작해야 합니다.|  
|[컴파일러 오류 C2015](compiler-error-c2015.md)|상수에 문자가 너무 많습니다.|  
|컴파일러 오류 C2016|C를 사용하려면 구조체 또는 공용 구조체에 멤버가 하나 이상 있어야 합니다.|  
|[컴파일러 오류 C2017](compiler-error-c2017.md)|이스케이프 시퀀스가 잘못되었습니다.|  
|[컴파일러 오류 C2018](compiler-error-c2018.md)|알 수 없는 문자 ' 0 x*값*'|  
|[컴파일러 오류 C2019](compiler-error-c2019.md)|전처리기 지시문이 예상 '*문자*'|  
|[컴파일러 오류 C2020](compiler-error-c2020.md)|'*멤버*': '*클래스*' 멤버 재정의|  
|[컴파일러 오류 C2021](compiler-error-c2021.md)|하지 지 수 값이 필요한 데 '*문자*'|  
|[컴파일러 오류 C2022](compiler-error-c2022.md)|'*번호*': 문자에 대해 너무 큰|  
|컴파일러 오류 C2023|'*식별자*': 맞춤 (*번호 1*) 이전 선언과 다릅니다 (*number2*)|  
|컴파일러 오류 C2024|'alignas' 특성에 변수, 데이터 멤버 및 태그 형식에만 적용|  
|컴파일러 오류 C2025|잘못 되었거나 손상 된 이진 모듈 인터페이스 파일: '*filename*'|  
|[컴파일러 오류 C2026](compiler-error-c2026.md)|문자열이 너무 길어 뒤에 오는 문자가 잘립니다.|  
...
|[컴파일러 오류 C2034](compiler-error-c2034.md)|'*식별자*': 비트 수에 비해 너무 작음을 비트 필드의 형식|  
...
|[컴파일러 오류 C2055](compiler-error-c2055.md)|형식 목록이 아니라 정식 매개 변수 목록이 있어야 합니다.|  
|[컴파일러 오류 C2056](compiler-error-c2056.md)|식이 잘못되었습니다.|  
...
|[컴파일러 오류 C2060](compiler-error-c2060.md)|구문 오류: 파일의 끝입니다.|  
...
|[컴파일러 오류 C2066](compiler-error-c2066.md)|함수 형식으로 잘못 캐스팅했습니다.|  
...
|[컴파일러 오류 C2097](compiler-error-c2097.md)|초기화가 잘못되었습니다.|  
