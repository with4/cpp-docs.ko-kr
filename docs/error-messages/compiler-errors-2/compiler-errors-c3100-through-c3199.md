...
|컴파일러 오류 C3123|WinRT 제네릭 인터페이스 제약 조건을 가질 수 없습니다.|
...
|[컴파일러 오류 C3131](compiler-error-c3131.md)|프로젝트에 'name' 속성으로는 'module' 특성이 있어야 합니다.|
...
|[컴파일러 오류 C3140](compiler-error-c3140.md)|같은 컴파일 단위에서 여러 개의 'module' 특성을 가질 수 없습니다.|
...
|[컴파일러 오류 C3161](compiler-error-c3161.md)|'*인터페이스*': 중첩 클래스, 구조체 또는 인터페이스의 인터페이스 올바르지 않습니다.; 중첩 인터페이스 클래스 또는 구조체에서 올바르지 않습니다.|
...
|[컴파일러 오류 C3174](compiler-error-c3174.md)|모듈 특성이 지정 되지 않았습니다.|
...
|[컴파일러 오류 C3185](compiler-error-c3185.md)|'typeid': 관리 되 는/WinRT 형식에 사용 되는 '*형식*'를 사용 하 여 '*연산자*' 대신|
...
|[컴파일러 오류 C3192](compiler-error-c3192.md)|구문 오류: ' ^' 접두사 연산자가 아닙니다 (아닌지 ' *'?)|
