...
ms.locfileid: "33328853"
---
# <a name="web-references-property-page"></a>웹 참조 속성 페이지
**웹 참조** 속성 페이지는 XML Web services 프록시 클래스가 생성되는 방법을 지정합니다. 프로젝트에 웹 참조를 추가하는 경우 XML Web services 프록시 클래스가 생성됩니다. 자세한 내용은 [웹 참조 추가](http://msdn.microsoft.com/en-us/bdf05776-c591-40af-bfd7-e1e2aa1e87b5)를 참조하세요.  
