...
## <a name="remarks"></a>설명  
 ...
 /TSAWARE 옵션은 Windows 및 콘솔 응용 프로그램에 대 한 Windows 2000 이상에서는 기본적으로 활성화 됩니다. 참조 [/SUBSYSTEM](../../build/reference/subsystem-specify-subsystem.md) 및 [/VERSION](../../build/reference/version-version-information.md) 정보에 대 한 합니다.  
