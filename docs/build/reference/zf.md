...
때문에 **/Zf** 필요 옵션 PDF 생성에만 적용 됩니다는 [/Zi](z7-zi-zi-debug-information-format.md) 또는 [/ZI](z7-zi-zi-debug-information-format.md) 옵션입니다.

**/Zf** 옵션에는 Visual Studio 2017 15.1, 버전부터 사용할 수 및 기본적으로 해제 되어 있습니다.
