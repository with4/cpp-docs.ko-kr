...
**/Zc:throwingNew** 옵션이 기본적으로 해제 되 고 영향을 받지 않습니다는 [관대 한 /-](permissive-standards-conformance.md) 옵션입니다.
