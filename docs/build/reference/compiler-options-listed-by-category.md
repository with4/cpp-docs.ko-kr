...
이 문서에는 컴파일러 옵션의 범주별 목록이 포함되어 있습니다. 사전순으로 나열된 목록을 보려면 [컴파일러 옵션 사전순 목록](../../build/reference/compiler-options-listed-alphabetically.md)을 참조하세요.  
...
|[\/Yd](../../build/reference/yd-place-debug-information-in-object-file.md)|모든 개체 파일에 완전한 디버깅 정보를 저장합니다.|  
...
|[\/Tc](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md) [\/TC](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|C 소스 파일을 지정합니다.|  
|[\/Tp](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md) [\/TP](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|C\+\+ 소스 파일을 지정합니다.|  
...
|옵션|용도|  
|--------|--------|  
|[\/clr:noAssembly](../../build/reference/clr-common-language-runtime-compilation.md)|더 이상 사용되지 않습니다. 대신 [\/LN\(MSIL 모듈 만들기\)](../../build/reference/ln-create-msil-module.md)를 사용하세요.|  
