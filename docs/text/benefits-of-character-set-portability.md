...
-   이식 가능한 코딩은 기본 코드에 유연 합니다. 나중에 것을 유니코드 또는 MBCS 쉽게 이동할 수 있습니다.  
  
-   유니코드를 사용 하면 Windows 2000에 대 한 응용 프로그램을 더 효율적입니다. Windows 2000에서 유니코드를 사용 하므로 운영 체제에서 송수신 유니코드가 아닌 문자열 변환 과정을 거쳐야는 오버 헤드를 초래 합니다.  
  
-   MBCS를 사용 하면 국제 시장을 겨냥 Windows 2000, Windows 95 또는 Windows 98 이외의 Win32 플랫폼에서 지 원하는 데 있습니다.  
